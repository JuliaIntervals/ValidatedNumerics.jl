...
facts("minimal_pos_dec_test") do
    ...
    @fact +Decorated(Interval(1.0, 2.0), com) --> Decorated(Interval(1.0, 2.0), com)
    @fact decoration(+Decorated(Interval(1.0, 2.0), com)) --> decoration(Decorated(Interval(1.0, 2.0), com))
end
...
facts("minimal_neg_dec_test") do
    ...
    @fact -(Decorated(entireinterval(Float64), def)) --> Decorated(entireinterval(Float64), def)
    @fact decoration(-(Decorated(entireinterval(Float64), def))) --> decoration(Decorated(entireinterval(Float64), def))
    @fact -(Decorated(Interval(1.0, 2.0), com)) --> Decorated(Interval(-2.0, -1.0), com)
    @fact decoration(-(Decorated(Interval(1.0, 2.0), com))) --> decoration(Decorated(Interval(-2.0, -1.0), com))
end
...
facts("minimal_add_dec_test") do
    @fact Decorated(Interval(1.0, 2.0), com) + Decorated(Interval(5.0, 7.0), com) --> Decorated(Interval(6.0, 9.0), com)
    @fact decoration(Decorated(Interval(1.0, 2.0), com) + Decorated(Interval(5.0, 7.0), com)) --> decoration(Decorated(Interval(6.0, 9.0), com))
    @fact Decorated(Interval(1.0, 2.0), com) + Decorated(Interval(5.0, 7.0), def) --> Decorated(Interval(6.0, 9.0), def)
    @fact decoration(Decorated(Interval(1.0, 2.0), com) + Decorated(Interval(5.0, 7.0), def)) --> decoration(Decorated(Interval(6.0, 9.0), def))
    @fact Decorated(Interval(1.0, 2.0), com) + Decorated(Interval(5.0, 0x1.fffffffffffffp1023), com) --> Decorated(Interval(6.0, Inf), dac)
    @fact decoration(Decorated(Interval(1.0, 2.0), com) + Decorated(Interval(5.0, 0x1.fffffffffffffp1023), com)) --> decoration(Decorated(Interval(6.0, Inf), dac))
    @fact Decorated(Interval(-0x1.fffffffffffffp1023, 2.0), com) + Decorated(Interval(-0.1, 5.0), com) --> Decorated(Interval(-Inf, 7.0), dac)
    @fact decoration(Decorated(Interval(-0x1.fffffffffffffp1023, 2.0), com) + Decorated(Interval(-0.1, 5.0), com)) --> decoration(Decorated(Interval(-Inf, 7.0), dac))
    @fact Decorated(Interval(1.0, 2.0), trv) + Decorated(∅, trv) --> Decorated(∅, trv)
    @fact decoration(Decorated(Interval(1.0, 2.0), trv) + Decorated(∅, trv)) --> decoration(Decorated(∅, trv))
end
...
facts("minimal_sub_dec_test") do
    @fact Decorated(Interval(1.0, 2.0), com) - Decorated(Interval(5.0, 7.0), com) --> Decorated(Interval(-6.0, -3.0), com)
    @fact decoration(Decorated(Interval(1.0, 2.0), com) - Decorated(Interval(5.0, 7.0), com)) --> decoration(Decorated(Interval(-6.0, -3.0), com))
    @fact Decorated(Interval(1.0, 2.0), com) - Decorated(Interval(5.0, 7.0), def) --> Decorated(Interval(-6.0, -3.0), def)
    @fact decoration(Decorated(Interval(1.0, 2.0), com) - Decorated(Interval(5.0, 7.0), def)) --> decoration(Decorated(Interval(-6.0, -3.0), def))
    @fact Decorated(Interval(-1.0, 2.0), com) - Decorated(Interval(5.0, 0x1.fffffffffffffp1023), com) --> Decorated(Interval(-Inf, -3.0), dac)
    @fact decoration(Decorated(Interval(-1.0, 2.0), com) - Decorated(Interval(5.0, 0x1.fffffffffffffp1023), com)) --> decoration(Decorated(Interval(-Inf, -3.0), dac))
    @fact Decorated(Interval(-0x1.fffffffffffffp1023, 2.0), com) - Decorated(Interval(-1.0, 5.0), com) --> Decorated(Interval(-Inf, 3.0), dac)
    @fact decoration(Decorated(Interval(-0x1.fffffffffffffp1023, 2.0), com) - Decorated(Interval(-1.0, 5.0), com)) --> decoration(Decorated(Interval(-Inf, 3.0), dac))
    @fact Decorated(Interval(1.0, 2.0), trv) - Decorated(∅, trv) --> Decorated(∅, trv)
    @fact decoration(Decorated(Interval(1.0, 2.0), trv) - Decorated(∅, trv)) --> decoration(Decorated(∅, trv))
end
...
facts("minimal_mul_dec_test") do
    @fact Decorated(Interval(1.0, 2.0), com) * Decorated(Interval(5.0, 7.0), com) --> Decorated(Interval(5.0, 14.0), com)
    @fact decoration(Decorated(Interval(1.0, 2.0), com) * Decorated(Interval(5.0, 7.0), com)) --> decoration(Decorated(Interval(5.0, 14.0), com))
    @fact Decorated(Interval(1.0, 2.0), com) * Decorated(Interval(5.0, 7.0), def) --> Decorated(Interval(5.0, 14.0), def)
    @fact decoration(Decorated(Interval(1.0, 2.0), com) * Decorated(Interval(5.0, 7.0), def)) --> decoration(Decorated(Interval(5.0, 14.0), def))
    @fact Decorated(Interval(1.0, 2.0), com) * Decorated(Interval(5.0, 0x1.fffffffffffffp1023), com) --> Decorated(Interval(5.0, Inf), dac)
    @fact decoration(Decorated(Interval(1.0, 2.0), com) * Decorated(Interval(5.0, 0x1.fffffffffffffp1023), com)) --> decoration(Decorated(Interval(5.0, Inf), dac))
    @fact Decorated(Interval(-0x1.fffffffffffffp1023, 2.0), com) * Decorated(Interval(-1.0, 5.0), com) --> Decorated(Interval(-Inf, 0x1.fffffffffffffp1023), dac)
    @fact decoration(Decorated(Interval(-0x1.fffffffffffffp1023, 2.0), com) * Decorated(Interval(-1.0, 5.0), com)) --> decoration(Decorated(Interval(-Inf, 0x1.fffffffffffffp1023), dac))
    @fact Decorated(Interval(1.0, 2.0), trv) * Decorated(∅, trv) --> Decorated(∅, trv)
    @fact decoration(Decorated(Interval(1.0, 2.0), trv) * Decorated(∅, trv)) --> decoration(Decorated(∅, trv))
end
...
facts("minimal_div_dec_test") do
    @fact Decorated(Interval(-2.0, -1.0), com) / Decorated(Interval(-10.0, -3.0), com) --> Decorated(Interval(0x1.9999999999999p-4, 0x1.5555555555556p-1), com)
    @fact decoration(Decorated(Interval(-2.0, -1.0), com) / Decorated(Interval(-10.0, -3.0), com)) --> decoration(Decorated(Interval(0x1.9999999999999p-4, 0x1.5555555555556p-1), com))
    @fact Decorated(Interval(-200.0, -1.0), com) / Decorated(Interval(0x0.0000000000001p-1022, 10.0), com) --> Decorated(Interval(-Inf, -0x1.9999999999999p-4), dac)
    @fact decoration(Decorated(Interval(-200.0, -1.0), com) / Decorated(Interval(0x0.0000000000001p-1022, 10.0), com)) --> decoration(Decorated(Interval(-Inf, -0x1.9999999999999p-4), dac))
    @fact Decorated(Interval(-2.0, -1.0), com) / Decorated(Interval(0.0, 10.0), com) --> Decorated(Interval(-Inf, -0x1.9999999999999p-4), trv)
    @fact decoration(Decorated(Interval(-2.0, -1.0), com) / Decorated(Interval(0.0, 10.0), com)) --> decoration(Decorated(Interval(-Inf, -0x1.9999999999999p-4), trv))
    @fact Decorated(Interval(1.0, 3.0), def) / Decorated(Interval(-Inf, -10.0), dac) --> Decorated(Interval(-0x1.3333333333334p-2, 0.0), def)
    @fact decoration(Decorated(Interval(1.0, 3.0), def) / Decorated(Interval(-Inf, -10.0), dac)) --> decoration(Decorated(Interval(-0x1.3333333333334p-2, 0.0), def))
    @fact Decorated(Interval(1.0, 2.0), trv) / Decorated(∅, trv) --> Decorated(∅, trv)
    @fact decoration(Decorated(Interval(1.0, 2.0), trv) / Decorated(∅, trv)) --> decoration(Decorated(∅, trv))
end
...
facts("minimal_recip_dec_test") do
    @fact inv(Decorated(Interval(10.0, 50.0), com)) --> Decorated(Interval(0x1.47ae147ae147ap-6, 0x1.999999999999ap-4), com)
    @fact decoration(inv(Decorated(Interval(10.0, 50.0), com))) --> decoration(Decorated(Interval(0x1.47ae147ae147ap-6, 0x1.999999999999ap-4), com))
    @fact (Decorated(Interval(10.0, 50.0), com))^(-1) --> Decorated(Interval(0x1.47ae147ae147ap-6, 0x1.999999999999ap-4), com)
    @fact decoration((Decorated(Interval(10.0, 50.0), com))^(-1)) --> decoration(Decorated(Interval(0x1.47ae147ae147ap-6, 0x1.999999999999ap-4), com))
    @fact (Decorated(Interval(10.0, 50.0), com))^(-1//1) --> Decorated(Interval(0x1.47ae147ae147ap-6, 0x1.999999999999ap-4), com)
    @fact decoration((Decorated(Interval(10.0, 50.0), com))^(-1//1)) --> decoration(Decorated(Interval(0x1.47ae147ae147ap-6, 0x1.999999999999ap-4), com))
    @fact (Decorated(Interval(10.0, 50.0), com))^(-1.0) --> Decorated(Interval(0x1.47ae147ae147ap-6, 0x1.999999999999ap-4), com)
    @fact decoration((Decorated(Interval(10.0, 50.0), com))^(-1.0)) --> decoration(Decorated(Interval(0x1.47ae147ae147ap-6, 0x1.999999999999ap-4), com))
    @fact 1 /(Decorated(Interval(10.0, 50.0), com)) --> Decorated(Interval(0x1.47ae147ae147ap-6, 0x1.999999999999ap-4), com)
    @fact decoration(1 /(Decorated(Interval(10.0, 50.0), com))) --> decoration(Decorated(Interval(0x1.47ae147ae147ap-6, 0x1.999999999999ap-4), com))
    @fact inv(Decorated(Interval(-Inf, -10.0), dac)) --> Decorated(Interval(-0x1.999999999999ap-4, 0.0), dac)
    @fact decoration(inv(Decorated(Interval(-Inf, -10.0), dac))) --> decoration(Decorated(Interval(-0x1.999999999999ap-4, 0.0), dac))
    @fact (Decorated(Interval(-Inf, -10.0), dac))^(-1) --> Decorated(Interval(-0x1.999999999999ap-4, 0.0), dac)
    @fact decoration((Decorated(Interval(-Inf, -10.0), dac))^(-1)) --> decoration(Decorated(Interval(-0x1.999999999999ap-4, 0.0), dac))
    @fact (Decorated(Interval(-Inf, -10.0), dac))^(-1//1) --> Decorated(Interval(-0x1.999999999999ap-4, 0.0), dac)
    @fact decoration((Decorated(Interval(-Inf, -10.0), dac))^(-1//1)) --> decoration(Decorated(Interval(-0x1.999999999999ap-4, 0.0), dac))
    @fact (Decorated(Interval(-Inf, -10.0), dac))^(-1.0) --> Decorated(Interval(-0x1.999999999999ap-4, 0.0), dac)
    @fact decoration((Decorated(Interval(-Inf, -10.0), dac))^(-1.0)) --> decoration(Decorated(Interval(-0x1.999999999999ap-4, 0.0), dac))
    @fact 1 /(Decorated(Interval(-Inf, -10.0), dac)) --> Decorated(Interval(-0x1.999999999999ap-4, 0.0), dac)
    @fact decoration(1 /(Decorated(Interval(-Inf, -10.0), dac))) --> decoration(Decorated(Interval(-0x1.999999999999ap-4, 0.0), dac))
    @fact inv(Decorated(Interval(-0x1.fffffffffffffp1023, -0x0.0000000000001p-1022), def)) --> Decorated(Interval(-Inf, -0x0.4p-1022), def)
    @fact decoration(inv(Decorated(Interval(-0x1.fffffffffffffp1023, -0x0.0000000000001p-1022), def))) --> decoration(Decorated(Interval(-Inf, -0x0.4p-1022), def))
    @fact (Decorated(Interval(-0x1.fffffffffffffp1023, -0x0.0000000000001p-1022), def))^(-1) --> Decorated(Interval(-Inf, -0x0.4p-1022), def)
    @fact decoration((Decorated(Interval(-0x1.fffffffffffffp1023, -0x0.0000000000001p-1022), def))^(-1)) --> decoration(Decorated(Interval(-Inf, -0x0.4p-1022), def))
    @fact (Decorated(Interval(-0x1.fffffffffffffp1023, -0x0.0000000000001p-1022), def))^(-1//1) --> Decorated(Interval(-Inf, -0x0.4p-1022), def)
    @fact decoration((Decorated(Interval(-0x1.fffffffffffffp1023, -0x0.0000000000001p-1022), def))^(-1//1)) --> decoration(Decorated(Interval(-Inf, -0x0.4p-1022), def))
    @fact (Decorated(Interval(-0x1.fffffffffffffp1023, -0x0.0000000000001p-1022), def))^(-1.0) --> Decorated(Interval(-Inf, -0x0.4p-1022), def)
    @fact decoration((Decorated(Interval(-0x1.fffffffffffffp1023, -0x0.0000000000001p-1022), def))^(-1.0)) --> decoration(Decorated(Interval(-Inf, -0x0.4p-1022), def))
    @fact 1 /(Decorated(Interval(-0x1.fffffffffffffp1023, -0x0.0000000000001p-1022), def)) --> Decorated(Interval(-Inf, -0x0.4p-1022), def)
    @fact decoration(1 /(Decorated(Interval(-0x1.fffffffffffffp1023, -0x0.0000000000001p-1022), def))) --> decoration(Decorated(Interval(-Inf, -0x0.4p-1022), def))
    @fact inv(Decorated(Interval(0.0, 0.0), com)) --> Decorated(∅, trv)
    @fact decoration(inv(Decorated(Interval(0.0, 0.0), com))) --> decoration(Decorated(∅, trv))
    @fact (Decorated(Interval(0.0, 0.0), com))^(-1) --> Decorated(∅, trv)
    @fact decoration((Decorated(Interval(0.0, 0.0), com))^(-1)) --> decoration(Decorated(∅, trv))
    @fact (Decorated(Interval(0.0, 0.0), com))^(-1//1) --> Decorated(∅, trv)
    @fact decoration((Decorated(Interval(0.0, 0.0), com))^(-1//1)) --> decoration(Decorated(∅, trv))
    @fact (Decorated(Interval(0.0, 0.0), com))^(-1.0) --> Decorated(∅, trv)
    @fact decoration((Decorated(Interval(0.0, 0.0), com))^(-1.0)) --> decoration(Decorated(∅, trv))
    @fact 1 /(Decorated(Interval(0.0, 0.0), com)) --> Decorated(∅, trv)
    @fact decoration(1 /(Decorated(Interval(0.0, 0.0), com))) --> decoration(Decorated(∅, trv))
    @fact inv(Decorated(Interval(-10.0, 0.0), com)) --> Decorated(Interval(-Inf, -0x1.9999999999999p-4), trv)
    @fact decoration(inv(Decorated(Interval(-10.0, 0.0), com))) --> decoration(Decorated(Interval(-Inf, -0x1.9999999999999p-4), trv))
    @fact (Decorated(Interval(-10.0, 0.0), com))^(-1) --> Decorated(Interval(-Inf, -0x1.9999999999999p-4), trv)
    @fact decoration((Decorated(Interval(-10.0, 0.0), com))^(-1)) --> decoration(Decorated(Interval(-Inf, -0x1.9999999999999p-4), trv))
    @fact (Decorated(Interval(-10.0, 0.0), com))^(-1//1) --> Decorated(Interval(-Inf, -0x1.9999999999999p-4), trv)
    @fact decoration((Decorated(Interval(-10.0, 0.0), com))^(-1//1)) --> decoration(Decorated(Interval(-Inf, -0x1.9999999999999p-4), trv))
    @fact (Decorated(Interval(-10.0, 0.0), com))^(-1.0) --> Decorated(Interval(-Inf, -0x1.9999999999999p-4), trv)
    @fact decoration((Decorated(Interval(-10.0, 0.0), com))^(-1.0)) --> decoration(Decorated(Interval(-Inf, -0x1.9999999999999p-4), trv))
    @fact 1 /(Decorated(Interval(-10.0, 0.0), com)) --> Decorated(Interval(-Inf, -0x1.9999999999999p-4), trv)
    @fact decoration(1 /(Decorated(Interval(-10.0, 0.0), com))) --> decoration(Decorated(Interval(-Inf, -0x1.9999999999999p-4), trv))
    @fact inv(Decorated(Interval(-10.0, Inf), dac)) --> Decorated(entireinterval(Float64), trv)
    @fact decoration(inv(Decorated(Interval(-10.0, Inf), dac))) --> decoration(Decorated(entireinterval(Float64), trv))
    @fact (Decorated(Interval(-10.0, Inf), dac))^(-1) --> Decorated(entireinterval(Float64), trv)
    @fact decoration((Decorated(Interval(-10.0, Inf), dac))^(-1)) --> decoration(Decorated(entireinterval(Float64), trv))
    @fact (Decorated(Interval(-10.0, Inf), dac))^(-1//1) --> Decorated(entireinterval(Float64), trv)
    @fact decoration((Decorated(Interval(-10.0, Inf), dac))^(-1//1)) --> decoration(Decorated(entireinterval(Float64), trv))
    @fact (Decorated(Interval(-10.0, Inf), dac))^(-1.0) --> Decorated(entireinterval(Float64), trv)
    @fact decoration((Decorated(Interval(-10.0, Inf), dac))^(-1.0)) --> decoration(Decorated(entireinterval(Float64), trv))
    @fact 1 /(Decorated(Interval(-10.0, Inf), dac)) --> Decorated(entireinterval(Float64), trv)
    @fact decoration(1 /(Decorated(Interval(-10.0, Inf), dac))) --> decoration(Decorated(entireinterval(Float64), trv))
    @fact inv(Decorated(Interval(-0.0, Inf), dac)) --> Decorated(Interval(0.0, Inf), trv)
    @fact decoration(inv(Decorated(Interval(-0.0, Inf), dac))) --> decoration(Decorated(Interval(0.0, Inf), trv))
    @fact (Decorated(Interval(-0.0, Inf), dac))^(-1) --> Decorated(Interval(0.0, Inf), trv)
    @fact decoration((Decorated(Interval(-0.0, Inf), dac))^(-1)) --> decoration(Decorated(Interval(0.0, Inf), trv))
    @fact (Decorated(Interval(-0.0, Inf), dac))^(-1//1) --> Decorated(Interval(0.0, Inf), trv)
    @fact decoration((Decorated(Interval(-0.0, Inf), dac))^(-1//1)) --> decoration(Decorated(Interval(0.0, Inf), trv))
    @fact (Decorated(Interval(-0.0, Inf), dac))^(-1.0) --> Decorated(Interval(0.0, Inf), trv)
    @fact decoration((Decorated(Interval(-0.0, Inf), dac))^(-1.0)) --> decoration(Decorated(Interval(0.0, Inf), trv))
    @fact 1 /(Decorated(Interval(-0.0, Inf), dac)) --> Decorated(Interval(0.0, Inf), trv)
    @fact decoration(1 /(Decorated(Interval(-0.0, Inf), dac))) --> decoration(Decorated(Interval(0.0, Inf), trv))
...
facts("minimal_sqr_dec_test") do
    @fact Decorated(Interval(-0x1.fffffffffffffp1023, -0x0.0000000000001p-1022), com) ^2 --> Decorated(Interval(0.0, Inf), dac)
    @fact decoration(Decorated(Interval(-0x1.fffffffffffffp1023, -0x0.0000000000001p-1022), com) ^2) --> decoration(Decorated(Interval(0.0, Inf), dac))
    @fact Decorated(Interval(-0x1.fffffffffffffp1023, -0x0.0000000000001p-1022), com) ^(2//1) --> Decorated(Interval(0.0, Inf), dac)
    @fact decoration(Decorated(Interval(-0x1.fffffffffffffp1023, -0x0.0000000000001p-1022), com) ^(2//1)) --> decoration(Decorated(Interval(0.0, Inf), dac))
    @fact Decorated(Interval(-0x1.fffffffffffffp1023, -0x0.0000000000001p-1022), com) ^(2.0) --> Decorated(Interval(0.0, Inf), dac)
    @fact decoration(Decorated(Interval(-0x1.fffffffffffffp1023, -0x0.0000000000001p-1022), com) ^(2.0)) --> decoration(Decorated(Interval(0.0, Inf), dac))
    @fact Decorated(Interval(-1.0, 1.0), def) ^2 --> Decorated(Interval(0.0, 1.0), def)
    @fact decoration(Decorated(Interval(-1.0, 1.0), def) ^2) --> decoration(Decorated(Interval(0.0, 1.0), def))
    @fact Decorated(Interval(-1.0, 1.0), def) ^(2//1) --> Decorated(Interval(0.0, 1.0), def)
    @fact decoration(Decorated(Interval(-1.0, 1.0), def) ^(2//1)) --> decoration(Decorated(Interval(0.0, 1.0), def))
    @fact Decorated(Interval(-1.0, 1.0), def) ^(2.0) --> Decorated(Interval(0.0, 1.0), def)
    @fact decoration(Decorated(Interval(-1.0, 1.0), def) ^(2.0)) --> decoration(Decorated(Interval(0.0, 1.0), def))
    @fact Decorated(Interval(-5.0, 3.0), com) ^2 --> Decorated(Interval(0.0, 25.0), com)
    @fact decoration(Decorated(Interval(-5.0, 3.0), com) ^2) --> decoration(Decorated(Interval(0.0, 25.0), com))
    @fact Decorated(Interval(-5.0, 3.0), com) ^(2//1) --> Decorated(Interval(0.0, 25.0), com)
    @fact decoration(Decorated(Interval(-5.0, 3.0), com) ^(2//1)) --> decoration(Decorated(Interval(0.0, 25.0), com))
    @fact Decorated(Interval(-5.0, 3.0), com) ^(2.0) --> Decorated(Interval(0.0, 25.0), com)
    @fact decoration(Decorated(Interval(-5.0, 3.0), com) ^(2.0)) --> decoration(Decorated(Interval(0.0, 25.0), com))
    @fact Decorated(Interval(0x1.999999999999ap-4, 0x1.999999999999ap-4), com) ^2 --> Decorated(Interval(0x1.47ae147ae147bp-7, 0x1.47ae147ae147cp-7), com)
    @fact decoration(Decorated(Interval(0x1.999999999999ap-4, 0x1.999999999999ap-4), com) ^2) --> decoration(Decorated(Interval(0x1.47ae147ae147bp-7, 0x1.47ae147ae147cp-7), com))
    @fact Decorated(Interval(0x1.999999999999ap-4, 0x1.999999999999ap-4), com) ^(2//1) --> Decorated(Interval(0x1.47ae147ae147bp-7, 0x1.47ae147ae147cp-7), com)
    @fact decoration(Decorated(Interval(0x1.999999999999ap-4, 0x1.999999999999ap-4), com) ^(2//1)) --> decoration(Decorated(Interval(0x1.47ae147ae147bp-7, 0x1.47ae147ae147cp-7), com))
    @fact Decorated(Interval(0x1.999999999999ap-4, 0x1.999999999999ap-4), com) ^(2.0) --> Decorated(Interval(0x1.47ae147ae147bp-7, 0x1.47ae147ae147cp-7), com)
    @fact decoration(Decorated(Interval(0x1.999999999999ap-4, 0x1.999999999999ap-4), com) ^(2.0)) --> decoration(Decorated(Interval(0x1.47ae147ae147bp-7, 0x1.47ae147ae147cp-7), com))
end
...
facts("minimal_sqrt_dec_test") do
    @fact sqrt(Decorated(Interval(1.0, 4.0), com)) --> Decorated(Interval(1.0, 2.0), com)
    @fact decoration(sqrt(Decorated(Interval(1.0, 4.0), com))) --> decoration(Decorated(Interval(1.0, 2.0), com))
    @fact (Decorated(Interval(1.0, 4.0), com))^(1/2) --> Decorated(Interval(1.0, 2.0), com)
    @fact decoration((Decorated(Interval(1.0, 4.0), com))^(1/2)) --> decoration(Decorated(Interval(1.0, 2.0), com))
    @fact (Decorated(Interval(1.0, 4.0), com))^(0.5) --> Decorated(Interval(1.0, 2.0), com)
    @fact decoration((Decorated(Interval(1.0, 4.0), com))^(0.5)) --> decoration(Decorated(Interval(1.0, 2.0), com))
    @fact (Decorated(Interval(1.0, 4.0), com))^(1//2) --> Decorated(Interval(1.0, 2.0), com)
    @fact decoration((Decorated(Interval(1.0, 4.0), com))^(1//2)) --> decoration(Decorated(Interval(1.0, 2.0), com))
    @fact sqrt(Decorated(Interval(-5.0, 25.0), com)) --> Decorated(Interval(0.0, 5.0), trv)
    @fact decoration(sqrt(Decorated(Interval(-5.0, 25.0), com))) --> decoration(Decorated(Interval(0.0, 5.0), trv))
    @fact (Decorated(Interval(-5.0, 25.0), com))^(1/2) --> Decorated(Interval(0.0, 5.0), trv)
    @fact decoration((Decorated(Interval(-5.0, 25.0), com))^(1/2)) --> decoration(Decorated(Interval(0.0, 5.0), trv))
    @fact (Decorated(Interval(-5.0, 25.0), com))^(0.5) --> Decorated(Interval(0.0, 5.0), trv)
    @fact decoration((Decorated(Interval(-5.0, 25.0), com))^(0.5)) --> decoration(Decorated(Interval(0.0, 5.0), trv))
    @fact (Decorated(Interval(-5.0, 25.0), com))^(1//2) --> Decorated(Interval(0.0, 5.0), trv)
    @fact decoration((Decorated(Interval(-5.0, 25.0), com))^(1//2)) --> decoration(Decorated(Interval(0.0, 5.0), trv))
    @fact sqrt(Decorated(Interval(0.0, 25.0), def)) --> Decorated(Interval(0.0, 5.0), def)
    @fact decoration(sqrt(Decorated(Interval(0.0, 25.0), def))) --> decoration(Decorated(Interval(0.0, 5.0), def))
    @fact (Decorated(Interval(0.0, 25.0), def))^(1/2) --> Decorated(Interval(0.0, 5.0), def)
    @fact decoration((Decorated(Interval(0.0, 25.0), def))^(1/2)) --> decoration(Decorated(Interval(0.0, 5.0), def))
    @fact (Decorated(Interval(0.0, 25.0), def))^(0.5) --> Decorated(Interval(0.0, 5.0), def)
    @fact decoration((Decorated(Interval(0.0, 25.0), def))^(0.5)) --> decoration(Decorated(Interval(0.0, 5.0), def))
    @fact (Decorated(Interval(0.0, 25.0), def))^(1//2) --> Decorated(Interval(0.0, 5.0), def)
    @fact decoration((Decorated(Interval(0.0, 25.0), def))^(1//2)) --> decoration(Decorated(Interval(0.0, 5.0), def))
    @fact sqrt(Decorated(Interval(-5.0, Inf), dac)) --> Decorated(Interval(0.0, Inf), trv)
    @fact decoration(sqrt(Decorated(Interval(-5.0, Inf), dac))) --> decoration(Decorated(Interval(0.0, Inf), trv))
    @fact (Decorated(Interval(-5.0, Inf), dac))^(1/2) --> Decorated(Interval(0.0, Inf), trv)
    @fact decoration((Decorated(Interval(-5.0, Inf), dac))^(1/2)) --> decoration(Decorated(Interval(0.0, Inf), trv))
    @fact (Decorated(Interval(-5.0, Inf), dac))^(0.5) --> Decorated(Interval(0.0, Inf), trv)
    @fact decoration((Decorated(Interval(-5.0, Inf), dac))^(0.5)) --> decoration(Decorated(Interval(0.0, Inf), trv))
    @fact (Decorated(Interval(-5.0, Inf), dac))^(1//2) --> Decorated(Interval(0.0, Inf), trv)
    @fact decoration((Decorated(Interval(-5.0, Inf), dac))^(1//2)) --> decoration(Decorated(Interval(0.0, Inf), trv))
end
...
facts("minimal_fma_dec_test") do
    @fact fma(Decorated(Interval(-0.5, -0.1), com), Decorated(Interval(-Inf, 3.0), dac), Decorated(Interval(-0.1, 0.1), com)) --> Decorated(Interval(-0x1.999999999999ap+0, Inf), dac)
    @fact decoration(fma(Decorated(Interval(-0.5, -0.1), com), Decorated(Interval(-Inf, 3.0), dac), Decorated(Interval(-0.1, 0.1), com))) --> decoration(Decorated(Interval(-0x1.999999999999ap+0, Inf), dac))
    @fact fma(Decorated(Interval(1.0, 2.0), com), Decorated(Interval(1.0, 0x1.fffffffffffffp1023), com), Decorated(Interval(0.0, 1.0), com)) --> Decorated(Interval(1.0, Inf), dac)
    @fact decoration(fma(Decorated(Interval(1.0, 2.0), com), Decorated(Interval(1.0, 0x1.fffffffffffffp1023), com), Decorated(Interval(0.0, 1.0), com))) --> decoration(Decorated(Interval(1.0, Inf), dac))
    @fact fma(Decorated(Interval(1.0, 2.0), com), Decorated(Interval(1.0, 2.0), com), Decorated(Interval(2.0, 5.0), com)) --> Decorated(Interval(3.0, 9.0), com)
    @fact decoration(fma(Decorated(Interval(1.0, 2.0), com), Decorated(Interval(1.0, 2.0), com), Decorated(Interval(2.0, 5.0), com))) --> decoration(Decorated(Interval(3.0, 9.0), com))
end
...
facts("minimal_pown_dec_test") do
    @fact Decorated(Interval(-5.0, 10.0), com) ^ 0 --> Decorated(Interval(1.0, 1.0), com)
    @fact decoration(Decorated(Interval(-5.0, 10.0), com) ^ 0) --> decoration(Decorated(Interval(1.0, 1.0), com))
    @fact Decorated(Interval(-Inf, 15.0), dac) ^ 0 --> Decorated(Interval(1.0, 1.0), dac)
    @fact decoration(Decorated(Interval(-Inf, 15.0), dac) ^ 0) --> decoration(Decorated(Interval(1.0, 1.0), dac))
    @fact Decorated(Interval(-3.0, 5.0), def) ^ 2 --> Decorated(Interval(0.0, 25.0), def)
    @fact decoration(Decorated(Interval(-3.0, 5.0), def) ^ 2) --> decoration(Decorated(Interval(0.0, 25.0), def))
    @fact Decorated(Interval(-0x1.fffffffffffffp1023, 2.0), com) ^ 2 --> Decorated(Interval(0.0, Inf), dac)
    @fact decoration(Decorated(Interval(-0x1.fffffffffffffp1023, 2.0), com) ^ 2) --> decoration(Decorated(Interval(0.0, Inf), dac))
    @fact Decorated(Interval(-3.0, 5.0), dac) ^ 3 --> Decorated(Interval(-27.0, 125.0), dac)
    @fact decoration(Decorated(Interval(-3.0, 5.0), dac) ^ 3) --> decoration(Decorated(Interval(-27.0, 125.0), dac))
    @fact Decorated(Interval(-0x1.fffffffffffffp1023, 2.0), com) ^ 3 --> Decorated(Interval(-Inf, 8.0), dac)
    @fact decoration(Decorated(Interval(-0x1.fffffffffffffp1023, 2.0), com) ^ 3) --> decoration(Decorated(Interval(-Inf, 8.0), dac))
    @fact Decorated(Interval(3.0, 5.0), com) ^ -2 --> Decorated(Interval(0x1.47ae147ae147ap-5, 0x1.c71c71c71c71dp-4), com)
    @fact decoration(Decorated(Interval(3.0, 5.0), com) ^ -2) --> decoration(Decorated(Interval(0x1.47ae147ae147ap-5, 0x1.c71c71c71c71dp-4), com))
    @fact Decorated(Interval(-5.0, -3.0), def) ^ -2 --> Decorated(Interval(0x1.47ae147ae147ap-5, 0x1.c71c71c71c71dp-4), def)
    @fact decoration(Decorated(Interval(-5.0, -3.0), def) ^ -2) --> decoration(Decorated(Interval(0x1.47ae147ae147ap-5, 0x1.c71c71c71c71dp-4), def))
    @fact Decorated(Interval(-5.0, 3.0), com) ^ -2 --> Decorated(Interval(0x1.47ae147ae147ap-5, Inf), trv)
    @fact decoration(Decorated(Interval(-5.0, 3.0), com) ^ -2) --> decoration(Decorated(Interval(0x1.47ae147ae147ap-5, Inf), trv))
    @fact Decorated(Interval(3.0, 5.0), dac) ^ -3 --> Decorated(Interval(0x1.0624dd2f1a9fbp-7, 0x1.2f684bda12f69p-5), dac)
    @fact decoration(Decorated(Interval(3.0, 5.0), dac) ^ -3) --> decoration(Decorated(Interval(0x1.0624dd2f1a9fbp-7, 0x1.2f684bda12f69p-5), dac))
    @fact Decorated(Interval(-3.0, 5.0), com) ^ -3 --> Decorated(entireinterval(Float64), trv)
    @fact decoration(Decorated(Interval(-3.0, 5.0), com) ^ -3) --> decoration(Decorated(entireinterval(Float64), trv))
end
...
facts("minimal_pow_dec_test") do
    @fact Decorated(Interval(0.1, 0.5), com) ^ Decorated(Interval(0.0, 1.0), com) --> Decorated(Interval(0x1.999999999999ap-4, 1.0), com)
    @fact decoration(Decorated(Interval(0.1, 0.5), com) ^ Decorated(Interval(0.0, 1.0), com)) --> decoration(Decorated(Interval(0x1.999999999999ap-4, 1.0), com))
    @fact Decorated(Interval(0.1, 0.5), com) ^ Decorated(Interval(0.1, 0.1), def) --> Decorated(Interval(0x1.96b230bcdc434p-1, 0x1.ddb680117ab13p-1), def)
    @fact decoration(Decorated(Interval(0.1, 0.5), com) ^ Decorated(Interval(0.1, 0.1), def)) --> decoration(Decorated(Interval(0x1.96b230bcdc434p-1, 0x1.ddb680117ab13p-1), def))
    @fact Decorated(Interval(0.1, 0.5), trv) ^ Decorated(Interval(-2.5, 2.5), dac) --> Decorated(Interval(0x1.9e7c6e43390b7p-9, 0x1.3c3a4edfa9758p+8), trv)
    @fact decoration(Decorated(Interval(0.1, 0.5), trv) ^ Decorated(Interval(-2.5, 2.5), dac)) --> decoration(Decorated(Interval(0x1.9e7c6e43390b7p-9, 0x1.3c3a4edfa9758p+8), trv))
    @fact Decorated(Interval(0.1, 0.5), com) ^ Decorated(Interval(-2.5, Inf), dac) --> Decorated(Interval(0.0, 0x1.3c3a4edfa9758p+8), dac)
    @fact decoration(Decorated(Interval(0.1, 0.5), com) ^ Decorated(Interval(-2.5, Inf), dac)) --> decoration(Decorated(Interval(0.0, 0x1.3c3a4edfa9758p+8), dac))
    @fact Decorated(Interval(0.1, 0.5), trv) ^ Decorated(Interval(-Inf, 0.1), dac) --> Decorated(Interval(0x1.96b230bcdc434p-1, Inf), trv)
    @fact decoration(Decorated(Interval(0.1, 0.5), trv) ^ Decorated(Interval(-Inf, 0.1), dac)) --> decoration(Decorated(Interval(0x1.96b230bcdc434p-1, Inf), trv))
    @fact Decorated(Interval(0.1, 1.0), com) ^ Decorated(Interval(0.0, 2.5), com) --> Decorated(Interval(0x1.9e7c6e43390b7p-9, 1.0), com)
    @fact decoration(Decorated(Interval(0.1, 1.0), com) ^ Decorated(Interval(0.0, 2.5), com)) --> decoration(Decorated(Interval(0x1.9e7c6e43390b7p-9, 1.0), com))
    @fact Decorated(Interval(0.1, 1.0), def) ^ Decorated(Interval(1.0, 1.0), dac) --> Decorated(Interval(0x1.999999999999ap-4, 1.0), def)
    @fact decoration(Decorated(Interval(0.1, 1.0), def) ^ Decorated(Interval(1.0, 1.0), dac)) --> decoration(Decorated(Interval(0x1.999999999999ap-4, 1.0), def))
    @fact Decorated(Interval(0.1, 1.0), trv) ^ Decorated(Interval(-2.5, 1.0), def) --> Decorated(Interval(0x1.999999999999ap-4, 0x1.3c3a4edfa9758p+8), trv)
    @fact decoration(Decorated(Interval(0.1, 1.0), trv) ^ Decorated(Interval(-2.5, 1.0), def)) --> decoration(Decorated(Interval(0x1.999999999999ap-4, 0x1.3c3a4edfa9758p+8), trv))
    @fact Decorated(Interval(0.5, 1.5), dac) ^ Decorated(Interval(0.1, 0.1), com) --> Decorated(Interval(0x1.ddb680117ab12p-1, 0x1.0a97dce72a0cbp+0), dac)
    @fact decoration(Decorated(Interval(0.5, 1.5), dac) ^ Decorated(Interval(0.1, 0.1), com)) --> decoration(Decorated(Interval(0x1.ddb680117ab12p-1, 0x1.0a97dce72a0cbp+0), dac))
    @fact Decorated(Interval(0.5, 1.5), def) ^ Decorated(Interval(-2.5, 0.1), trv) --> Decorated(Interval(0x1.7398bf1d1ee6fp-2, 0x1.6a09e667f3bcdp+2), trv)
    @fact decoration(Decorated(Interval(0.5, 1.5), def) ^ Decorated(Interval(-2.5, 0.1), trv)) --> decoration(Decorated(Interval(0x1.7398bf1d1ee6fp-2, 0x1.6a09e667f3bcdp+2), trv))
    @fact Decorated(Interval(0.5, 1.5), com) ^ Decorated(Interval(-2.5, -2.5), com) --> Decorated(Interval(0x1.7398bf1d1ee6fp-2, 0x1.6a09e667f3bcdp+2), com)
    @fact decoration(Decorated(Interval(0.5, 1.5), com) ^ Decorated(Interval(-2.5, -2.5), com)) --> decoration(Decorated(Interval(0x1.7398bf1d1ee6fp-2, 0x1.6a09e667f3bcdp+2), com))
    @fact Decorated(Interval(0.5, Inf), dac) ^ Decorated(Interval(0.1, 0.1), com) --> Decorated(Interval(0x1.ddb680117ab12p-1, Inf), dac)
    @fact decoration(Decorated(Interval(0.5, Inf), dac) ^ Decorated(Interval(0.1, 0.1), com)) --> decoration(Decorated(Interval(0x1.ddb680117ab12p-1, Inf), dac))
    @fact Decorated(Interval(0.5, Inf), def) ^ Decorated(Interval(-2.5, -0.0), com) --> Decorated(Interval(0.0, 0x1.6a09e667f3bcdp+2), def)
    @fact decoration(Decorated(Interval(0.5, Inf), def) ^ Decorated(Interval(-2.5, -0.0), com)) --> decoration(Decorated(Interval(0.0, 0x1.6a09e667f3bcdp+2), def))
    @fact Decorated(Interval(1.0, 1.5), com) ^ Decorated(Interval(-0.1, 0.1), def) --> Decorated(Interval(0x1.eba7c9e4d31e9p-1, 0x1.0a97dce72a0cbp+0), def)
    @fact decoration(Decorated(Interval(1.0, 1.5), com) ^ Decorated(Interval(-0.1, 0.1), def)) --> decoration(Decorated(Interval(0x1.eba7c9e4d31e9p-1, 0x1.0a97dce72a0cbp+0), def))
    @fact Decorated(Interval(1.0, 1.5), trv) ^ Decorated(Interval(-0.1, -0.1), com) --> Decorated(Interval(0x1.eba7c9e4d31e9p-1, 1.0), trv)
    @fact decoration(Decorated(Interval(1.0, 1.5), trv) ^ Decorated(Interval(-0.1, -0.1), com)) --> decoration(Decorated(Interval(0x1.eba7c9e4d31e9p-1, 1.0), trv))
    @fact Decorated(Interval(1.0, Inf), dac) ^ Decorated(Interval(1.0, 1.0), dac) --> Decorated(Interval(1.0, Inf), dac)
    @fact decoration(Decorated(Interval(1.0, Inf), dac) ^ Decorated(Interval(1.0, 1.0), dac)) --> decoration(Decorated(Interval(1.0, Inf), dac))
    @fact Decorated(Interval(1.0, Inf), def) ^ Decorated(Interval(-1.0, -0.0), dac) --> Decorated(Interval(0x0p+0, 1.0), def)
    @fact decoration(Decorated(Interval(1.0, Inf), def) ^ Decorated(Interval(-1.0, -0.0), dac)) --> decoration(Decorated(Interval(0x0p+0, 1.0), def))
    @fact Decorated(Interval(1.1, 1.5), def) ^ Decorated(Interval(1.0, 2.5), com) --> Decorated(Interval(0x1.199999999999ap+0, 0x1.60b9fd68a4555p+1), def)
    @fact decoration(Decorated(Interval(1.1, 1.5), def) ^ Decorated(Interval(1.0, 2.5), com)) --> decoration(Decorated(Interval(0x1.199999999999ap+0, 0x1.60b9fd68a4555p+1), def))
    @fact Decorated(Interval(1.1, 1.5), com) ^ Decorated(Interval(-0.1, -0.1), com) --> Decorated(Interval(0x1.eba7c9e4d31e9p-1, 0x1.fb24af5281928p-1), com)
    @fact decoration(Decorated(Interval(1.1, 1.5), com) ^ Decorated(Interval(-0.1, -0.1), com)) --> decoration(Decorated(Interval(0x1.eba7c9e4d31e9p-1, 0x1.fb24af5281928p-1), com))
    @fact Decorated(Interval(1.1, Inf), dac) ^ Decorated(Interval(0.1, Inf), dac) --> Decorated(Interval(0x1.02739c65d58bfp+0, Inf), dac)
    @fact decoration(Decorated(Interval(1.1, Inf), dac) ^ Decorated(Interval(0.1, Inf), dac)) --> decoration(Decorated(Interval(0x1.02739c65d58bfp+0, Inf), dac))
    @fact Decorated(Interval(1.1, Inf), def) ^ Decorated(Interval(-2.5, Inf), dac) --> Decorated(Interval(0x0p+0, Inf), def)
    @fact decoration(Decorated(Interval(1.1, Inf), def) ^ Decorated(Interval(-2.5, Inf), dac)) --> decoration(Decorated(Interval(0x0p+0, Inf), def))
    @fact Decorated(Interval(1.1, Inf), trv) ^ Decorated(Interval(-Inf, -1.0), def) --> Decorated(Interval(0x0p+0, 0x1.d1745d1745d17p-1), trv)
    @fact decoration(Decorated(Interval(1.1, Inf), trv) ^ Decorated(Interval(-Inf, -1.0), def)) --> decoration(Decorated(Interval(0x0p+0, 0x1.d1745d1745d17p-1), trv))
    @fact Decorated(Interval(0.0, 0.5), com) ^ Decorated(Interval(0.1, 0.1), com) --> Decorated(Interval(0.0, 0x1.ddb680117ab13p-1), com)
    @fact decoration(Decorated(Interval(0.0, 0.5), com) ^ Decorated(Interval(0.1, 0.1), com)) --> decoration(Decorated(Interval(0.0, 0x1.ddb680117ab13p-1), com))
    @fact Decorated(Interval(0.0, 0.5), com) ^ Decorated(Interval(2.5, Inf), dac) --> Decorated(Interval(0.0, 0x1.6a09e667f3bcdp-3), dac)
    @fact decoration(Decorated(Interval(0.0, 0.5), com) ^ Decorated(Interval(2.5, Inf), dac)) --> decoration(Decorated(Interval(0.0, 0x1.6a09e667f3bcdp-3), dac))
    @fact Decorated(Interval(0.0, 0.5), com) ^ Decorated(Interval(-Inf, -2.5), dac) --> Decorated(Interval(0x1.6a09e667f3bccp+2, Inf), trv)
    @fact decoration(Decorated(Interval(0.0, 0.5), com) ^ Decorated(Interval(-Inf, -2.5), dac)) --> decoration(Decorated(Interval(0x1.6a09e667f3bccp+2, Inf), trv))
    @fact Decorated(Interval(0.0, 1.0), com) ^ Decorated(Interval(0.0, 0.0), com) --> Decorated(Interval(1.0, 1.0), trv)
    @fact decoration(Decorated(Interval(0.0, 1.0), com) ^ Decorated(Interval(0.0, 0.0), com)) --> decoration(Decorated(Interval(1.0, 1.0), trv))
    @fact Decorated(Interval(0.0, 1.0), def) ^ Decorated(Interval(0.0, 2.5), dac) --> Decorated(Interval(0.0, 1.0), trv)
    @fact decoration(Decorated(Interval(0.0, 1.0), def) ^ Decorated(Interval(0.0, 2.5), dac)) --> decoration(Decorated(Interval(0.0, 1.0), trv))
    @fact Decorated(Interval(0.0, 1.0), dac) ^ Decorated(Interval(1.0, 2.5), com) --> Decorated(Interval(0.0, 1.0), dac)
    @fact decoration(Decorated(Interval(0.0, 1.0), dac) ^ Decorated(Interval(1.0, 2.5), com)) --> decoration(Decorated(Interval(0.0, 1.0), dac))
    @fact Decorated(Interval(0.0, 1.0), com) ^ Decorated(Interval(-2.5, 0.1), dac) --> Decorated(Interval(0.0, Inf), trv)
    @fact decoration(Decorated(Interval(0.0, 1.0), com) ^ Decorated(Interval(-2.5, 0.1), dac)) --> decoration(Decorated(Interval(0.0, Inf), trv))
    @fact Decorated(Interval(0.0, 1.0), def) ^ Decorated(entireinterval(Float64), def) --> Decorated(Interval(0.0, Inf), trv)
    @fact decoration(Decorated(Interval(0.0, 1.0), def) ^ Decorated(entireinterval(Float64), def)) --> decoration(Decorated(Interval(0.0, Inf), trv))
    @fact Decorated(Interval(0.0, 1.0), dac) ^ Decorated(Interval(-0.1, 0.0), com) --> Decorated(Interval(1.0, Inf), trv)
    @fact decoration(Decorated(Interval(0.0, 1.0), dac) ^ Decorated(Interval(-0.1, 0.0), com)) --> decoration(Decorated(Interval(1.0, Inf), trv))
    @fact Decorated(Interval(0.0, 1.0), com) ^ Decorated(Interval(-Inf, 0.0), dac) --> Decorated(Interval(1.0, Inf), trv)
    @fact decoration(Decorated(Interval(0.0, 1.0), com) ^ Decorated(Interval(-Inf, 0.0), dac)) --> decoration(Decorated(Interval(1.0, Inf), trv))
    @fact Decorated(Interval(0.0, 1.0), def) ^ Decorated(Interval(-Inf, -2.5), dac) --> Decorated(Interval(1.0, Inf), trv)
    @fact decoration(Decorated(Interval(0.0, 1.0), def) ^ Decorated(Interval(-Inf, -2.5), dac)) --> decoration(Decorated(Interval(1.0, Inf), trv))
    @fact Decorated(Interval(0.0, 1.5), com) ^ Decorated(Interval(0.0, 2.5), com) --> Decorated(Interval(0.0, 0x1.60b9fd68a4555p+1), trv)
    @fact decoration(Decorated(Interval(0.0, 1.5), com) ^ Decorated(Interval(0.0, 2.5), com)) --> decoration(Decorated(Interval(0.0, 0x1.60b9fd68a4555p+1), trv))
    @fact Decorated(Interval(0.0, 1.5), def) ^ Decorated(Interval(2.5, 2.5), dac) --> Decorated(Interval(0.0, 0x1.60b9fd68a4555p+1), def)
    @fact decoration(Decorated(Interval(0.0, 1.5), def) ^ Decorated(Interval(2.5, 2.5), dac)) --> decoration(Decorated(Interval(0.0, 0x1.60b9fd68a4555p+1), def))
    @fact Decorated(Interval(0.0, 1.5), dac) ^ Decorated(Interval(-1.0, 0.0), com) --> Decorated(Interval(0x1.5555555555555p-1, Inf), trv)
    @fact decoration(Decorated(Interval(0.0, 1.5), dac) ^ Decorated(Interval(-1.0, 0.0), com)) --> decoration(Decorated(Interval(0x1.5555555555555p-1, Inf), trv))
    @fact Decorated(Interval(0.0, 1.5), com) ^ Decorated(Interval(-2.5, -2.5), def) --> Decorated(Interval(0x1.7398bf1d1ee6fp-2, Inf), trv)
    @fact decoration(Decorated(Interval(0.0, 1.5), com) ^ Decorated(Interval(-2.5, -2.5), def)) --> decoration(Decorated(Interval(0x1.7398bf1d1ee6fp-2, Inf), trv))
    @fact Decorated(Interval(0.0, Inf), dac) ^ Decorated(Interval(0.1, 0.1), com) --> Decorated(Interval(0.0, Inf), dac)
    @fact decoration(Decorated(Interval(0.0, Inf), dac) ^ Decorated(Interval(0.1, 0.1), com)) --> decoration(Decorated(Interval(0.0, Inf), dac))
    @fact Decorated(Interval(0.0, Inf), def) ^ Decorated(Interval(-1.0, 1.0), dac) --> Decorated(Interval(0.0, Inf), trv)
    @fact decoration(Decorated(Interval(0.0, Inf), def) ^ Decorated(Interval(-1.0, 1.0), dac)) --> decoration(Decorated(Interval(0.0, Inf), trv))
    @fact Decorated(Interval(0.0, Inf), trv) ^ Decorated(Interval(-Inf, -1.0), def) --> Decorated(Interval(0.0, Inf), trv)
    @fact decoration(Decorated(Interval(0.0, Inf), trv) ^ Decorated(Interval(-Inf, -1.0), def)) --> decoration(Decorated(Interval(0.0, Inf), trv))
    @fact Decorated(Interval(0.0, Inf), dac) ^ Decorated(Interval(-2.5, -2.5), dac) --> Decorated(Interval(0.0, Inf), trv)
    @fact decoration(Decorated(Interval(0.0, Inf), dac) ^ Decorated(Interval(-2.5, -2.5), dac)) --> decoration(Decorated(Interval(0.0, Inf), trv))
    @fact Decorated(Interval(-0.0, 0.5), com) ^ Decorated(Interval(0.0, Inf), dac) --> Decorated(Interval(0.0, 1.0), trv)
    @fact decoration(Decorated(Interval(-0.0, 0.5), com) ^ Decorated(Interval(0.0, Inf), dac)) --> decoration(Decorated(Interval(0.0, 1.0), trv))
    @fact Decorated(Interval(-0.0, 0.5), def) ^ Decorated(Interval(0.1, Inf), def) --> Decorated(Interval(0.0, 0x1.ddb680117ab13p-1), def)
    @fact decoration(Decorated(Interval(-0.0, 0.5), def) ^ Decorated(Interval(0.1, Inf), def)) --> decoration(Decorated(Interval(0.0, 0x1.ddb680117ab13p-1), def))
    @fact Decorated(Interval(-0.0, 0.5), dac) ^ Decorated(Interval(2.5, 2.5), com) --> Decorated(Interval(0.0, 0x1.6a09e667f3bcdp-3), dac)
    @fact decoration(Decorated(Interval(-0.0, 0.5), dac) ^ Decorated(Interval(2.5, 2.5), com)) --> decoration(Decorated(Interval(0.0, 0x1.6a09e667f3bcdp-3), dac))
    @fact Decorated(Interval(-0.0, 0.5), trv) ^ Decorated(Interval(-2.5, -0.0), dac) --> Decorated(Interval(1.0, Inf), trv)
    @fact decoration(Decorated(Interval(-0.0, 0.5), trv) ^ Decorated(Interval(-2.5, -0.0), dac)) --> decoration(Decorated(Interval(1.0, Inf), trv))
    @fact Decorated(Interval(-0.0, 0.5), com) ^ Decorated(Interval(-Inf, -0.1), def) --> Decorated(Interval(0x1.125fbee250664p+0, Inf), trv)
    @fact decoration(Decorated(Interval(-0.0, 0.5), com) ^ Decorated(Interval(-Inf, -0.1), def)) --> decoration(Decorated(Interval(0x1.125fbee250664p+0, Inf), trv))
    @fact Decorated(Interval(-0.0, 0.5), def) ^ Decorated(Interval(-Inf, -2.5), dac) --> Decorated(Interval(0x1.6a09e667f3bccp+2, Inf), trv)
    @fact decoration(Decorated(Interval(-0.0, 0.5), def) ^ Decorated(Interval(-Inf, -2.5), dac)) --> decoration(Decorated(Interval(0x1.6a09e667f3bccp+2, Inf), trv))
    @fact Decorated(Interval(-0.0, 1.0), com) ^ Decorated(Interval(2.5, 2.5), dac) --> Decorated(Interval(0.0, 1.0), dac)
    @fact decoration(Decorated(Interval(-0.0, 1.0), com) ^ Decorated(Interval(2.5, 2.5), dac)) --> decoration(Decorated(Interval(0.0, 1.0), dac))
    @fact Decorated(Interval(-0.0, 1.0), dac) ^ Decorated(Interval(-1.0, Inf), def) --> Decorated(Interval(0.0, Inf), trv)
    @fact decoration(Decorated(Interval(-0.0, 1.0), dac) ^ Decorated(Interval(-1.0, Inf), def)) --> decoration(Decorated(Interval(0.0, Inf), trv))
    @fact Decorated(Interval(-0.0, 1.0), com) ^ Decorated(entireinterval(Float64), def) --> Decorated(Interval(0.0, Inf), trv)
    @fact decoration(Decorated(Interval(-0.0, 1.0), com) ^ Decorated(entireinterval(Float64), def)) --> decoration(Decorated(Interval(0.0, Inf), trv))
    @fact Decorated(Interval(-0.0, 1.0), def) ^ Decorated(Interval(-2.5, -2.5), com) --> Decorated(Interval(1.0, Inf), trv)
    @fact decoration(Decorated(Interval(-0.0, 1.0), def) ^ Decorated(Interval(-2.5, -2.5), com)) --> decoration(Decorated(Interval(1.0, Inf), trv))
    @fact Decorated(Interval(-0.0, 1.0), dac) ^ Decorated(Interval(-Inf, -2.5), def) --> Decorated(Interval(1.0, Inf), trv)
    @fact decoration(Decorated(Interval(-0.0, 1.0), dac) ^ Decorated(Interval(-Inf, -2.5), def)) --> decoration(Decorated(Interval(1.0, Inf), trv))
    @fact Decorated(Interval(-0.0, 1.5), com) ^ Decorated(Interval(0.1, 2.5), dac) --> Decorated(Interval(0.0, 0x1.60b9fd68a4555p+1), dac)
    @fact decoration(Decorated(Interval(-0.0, 1.5), com) ^ Decorated(Interval(0.1, 2.5), dac)) --> decoration(Decorated(Interval(0.0, 0x1.60b9fd68a4555p+1), dac))
    @fact Decorated(Interval(-0.0, 1.5), def) ^ Decorated(Interval(-1.0, 0.0), trv) --> Decorated(Interval(0x1.5555555555555p-1, Inf), trv)
    @fact decoration(Decorated(Interval(-0.0, 1.5), def) ^ Decorated(Interval(-1.0, 0.0), trv)) --> decoration(Decorated(Interval(0x1.5555555555555p-1, Inf), trv))
    @fact Decorated(Interval(-0.0, 1.5), dac) ^ Decorated(Interval(-2.5, -0.1), def) --> Decorated(Interval(0x1.7398bf1d1ee6fp-2, Inf), trv)
    @fact decoration(Decorated(Interval(-0.0, 1.5), dac) ^ Decorated(Interval(-2.5, -0.1), def)) --> decoration(Decorated(Interval(0x1.7398bf1d1ee6fp-2, Inf), trv))
    @fact Decorated(Interval(-0.0, 1.5), com) ^ Decorated(Interval(-2.5, -2.5), com) --> Decorated(Interval(0x1.7398bf1d1ee6fp-2, Inf), trv)
    @fact decoration(Decorated(Interval(-0.0, 1.5), com) ^ Decorated(Interval(-2.5, -2.5), com)) --> decoration(Decorated(Interval(0x1.7398bf1d1ee6fp-2, Inf), trv))
    @fact Decorated(Interval(-0.0, 1.5), def) ^ Decorated(Interval(-Inf, -2.5), dac) --> Decorated(Interval(0.0, Inf), trv)
    @fact decoration(Decorated(Interval(-0.0, 1.5), def) ^ Decorated(Interval(-Inf, -2.5), dac)) --> decoration(Decorated(Interval(0.0, Inf), trv))
    @fact Decorated(Interval(-0.0, Inf), dac) ^ Decorated(Interval(-0.1, Inf), dac) --> Decorated(Interval(0.0, Inf), trv)
    @fact decoration(Decorated(Interval(-0.0, Inf), dac) ^ Decorated(Interval(-0.1, Inf), dac)) --> decoration(Decorated(Interval(0.0, Inf), trv))
    @fact Decorated(Interval(-0.0, Inf), def) ^ Decorated(Interval(-2.5, -0.0), com) --> Decorated(Interval(0.0, Inf), trv)
    @fact decoration(Decorated(Interval(-0.0, Inf), def) ^ Decorated(Interval(-2.5, -0.0), com)) --> decoration(Decorated(Interval(0.0, Inf), trv))
    @fact Decorated(Interval(-0.0, Inf), trv) ^ Decorated(Interval(-Inf, 0.0), def) --> Decorated(Interval(0.0, Inf), trv)
    @fact decoration(Decorated(Interval(-0.0, Inf), trv) ^ Decorated(Interval(-Inf, 0.0), def)) --> decoration(Decorated(Interval(0.0, Inf), trv))
    @fact Decorated(Interval(-0.0, Inf), dac) ^ Decorated(Interval(-Inf, -0.0), trv) --> Decorated(Interval(0.0, Inf), trv)
    @fact decoration(Decorated(Interval(-0.0, Inf), dac) ^ Decorated(Interval(-Inf, -0.0), trv)) --> decoration(Decorated(Interval(0.0, Inf), trv))
    @fact Decorated(Interval(-0.0, Inf), def) ^ Decorated(Interval(-Inf, -1.0), def) --> Decorated(Interval(0.0, Inf), trv)
    @fact decoration(Decorated(Interval(-0.0, Inf), def) ^ Decorated(Interval(-Inf, -1.0), def)) --> decoration(Decorated(Interval(0.0, Inf), trv))
    @fact Decorated(Interval(-0.1, 0.5), def) ^ Decorated(Interval(0.1, Inf), dac) --> Decorated(Interval(0.0, 0x1.ddb680117ab13p-1), trv)
    @fact decoration(Decorated(Interval(-0.1, 0.5), def) ^ Decorated(Interval(0.1, Inf), dac)) --> decoration(Decorated(Interval(0.0, 0x1.ddb680117ab13p-1), trv))
    @fact Decorated(Interval(-0.1, 0.5), com) ^ Decorated(Interval(-0.1, -0.1), com) --> Decorated(Interval(0x1.125fbee250664p+0, Inf), trv)
    @fact decoration(Decorated(Interval(-0.1, 0.5), com) ^ Decorated(Interval(-0.1, -0.1), com)) --> decoration(Decorated(Interval(0x1.125fbee250664p+0, Inf), trv))
    @fact Decorated(Interval(-0.1, 0.5), dac) ^ Decorated(Interval(-Inf, -2.5), def) --> Decorated(Interval(0x1.6a09e667f3bccp+2, Inf), trv)
    @fact decoration(Decorated(Interval(-0.1, 0.5), dac) ^ Decorated(Interval(-Inf, -2.5), def)) --> decoration(Decorated(Interval(0x1.6a09e667f3bccp+2, Inf), trv))
    @fact Decorated(Interval(-0.1, 1.0), com) ^ Decorated(Interval(0.0, 0.0), com) --> Decorated(Interval(1.0, 1.0), trv)
    @fact decoration(Decorated(Interval(-0.1, 1.0), com) ^ Decorated(Interval(0.0, 0.0), com)) --> decoration(Decorated(Interval(1.0, 1.0), trv))
    @fact Decorated(Interval(-0.1, 1.0), dac) ^ Decorated(Interval(-Inf, 2.5), dac) --> Decorated(Interval(0.0, Inf), trv)
    @fact decoration(Decorated(Interval(-0.1, 1.0), dac) ^ Decorated(Interval(-Inf, 2.5), dac)) --> decoration(Decorated(Interval(0.0, Inf), trv))
    @fact Decorated(Interval(-0.1, 1.0), def) ^ Decorated(Interval(-Inf, -1.0), def) --> Decorated(Interval(1.0, Inf), trv)
    @fact decoration(Decorated(Interval(-0.1, 1.0), def) ^ Decorated(Interval(-Inf, -1.0), def)) --> decoration(Decorated(Interval(1.0, Inf), trv))
    @fact Decorated(Interval(-0.1, 1.0), com) ^ Decorated(Interval(-2.5, -2.5), com) --> Decorated(Interval(1.0, Inf), trv)
    @fact decoration(Decorated(Interval(-0.1, 1.0), com) ^ Decorated(Interval(-2.5, -2.5), com)) --> decoration(Decorated(Interval(1.0, Inf), trv))
    @fact Decorated(Interval(-0.1, 1.0), trv) ^ Decorated(Interval(-Inf, -2.5), trv) --> Decorated(Interval(1.0, Inf), trv)
    @fact decoration(Decorated(Interval(-0.1, 1.0), trv) ^ Decorated(Interval(-Inf, -2.5), trv)) --> decoration(Decorated(Interval(1.0, Inf), trv))
    @fact Decorated(Interval(-0.1, 1.5), trv) ^ Decorated(Interval(0.0, 2.5), com) --> Decorated(Interval(0.0, 0x1.60b9fd68a4555p+1), trv)
    @fact decoration(Decorated(Interval(-0.1, 1.5), trv) ^ Decorated(Interval(0.0, 2.5), com)) --> decoration(Decorated(Interval(0.0, 0x1.60b9fd68a4555p+1), trv))
    @fact Decorated(Interval(-0.1, 1.5), com) ^ Decorated(Interval(2.5, 2.5), dac) --> Decorated(Interval(0.0, 0x1.60b9fd68a4555p+1), trv)
    @fact decoration(Decorated(Interval(-0.1, 1.5), com) ^ Decorated(Interval(2.5, 2.5), dac)) --> decoration(Decorated(Interval(0.0, 0x1.60b9fd68a4555p+1), trv))
    @fact Decorated(Interval(-0.1, 1.5), dac) ^ Decorated(Interval(-1.0, 0.0), trv) --> Decorated(Interval(0x1.5555555555555p-1, Inf), trv)
    @fact decoration(Decorated(Interval(-0.1, 1.5), dac) ^ Decorated(Interval(-1.0, 0.0), trv)) --> decoration(Decorated(Interval(0x1.5555555555555p-1, Inf), trv))
    @fact Decorated(Interval(-0.1, 1.5), com) ^ Decorated(Interval(-0.1, -0.1), com) --> Decorated(Interval(0x1.eba7c9e4d31e9p-1, Inf), trv)
    @fact decoration(Decorated(Interval(-0.1, 1.5), com) ^ Decorated(Interval(-0.1, -0.1), com)) --> decoration(Decorated(Interval(0x1.eba7c9e4d31e9p-1, Inf), trv))
    @fact Decorated(Interval(-0.1, 1.5), def) ^ Decorated(Interval(-2.5, -2.5), def) --> Decorated(Interval(0x1.7398bf1d1ee6fp-2, Inf), trv)
    @fact decoration(Decorated(Interval(-0.1, 1.5), def) ^ Decorated(Interval(-2.5, -2.5), def)) --> decoration(Decorated(Interval(0x1.7398bf1d1ee6fp-2, Inf), trv))
    @fact Decorated(Interval(-0.1, Inf), dac) ^ Decorated(Interval(-0.1, 2.5), com) --> Decorated(Interval(0.0, Inf), trv)
    @fact decoration(Decorated(Interval(-0.1, Inf), dac) ^ Decorated(Interval(-0.1, 2.5), com)) --> decoration(Decorated(Interval(0.0, Inf), trv))
    @fact Decorated(Interval(-0.1, Inf), def) ^ Decorated(Interval(-2.5, 0.0), def) --> Decorated(Interval(0.0, Inf), trv)
    @fact decoration(Decorated(Interval(-0.1, Inf), def) ^ Decorated(Interval(-2.5, 0.0), def)) --> decoration(Decorated(Interval(0.0, Inf), trv))
    @fact Decorated(Interval(-0.1, Inf), dac) ^ Decorated(Interval(-2.5, -2.5), trv) --> Decorated(Interval(0.0, Inf), trv)
    @fact decoration(Decorated(Interval(-0.1, Inf), dac) ^ Decorated(Interval(-2.5, -2.5), trv)) --> decoration(Decorated(Interval(0.0, Inf), trv))
    @fact Decorated(Interval(0.0, 0.0), com) ^ Decorated(Interval(1.0, Inf), dac) --> Decorated(Interval(0.0, 0.0), dac)
    @fact decoration(Decorated(Interval(0.0, 0.0), com) ^ Decorated(Interval(1.0, Inf), dac)) --> decoration(Decorated(Interval(0.0, 0.0), dac))
    @fact Decorated(Interval(0.0, 0.0), com) ^ Decorated(Interval(-2.5, 0.1), com) --> Decorated(Interval(0.0, 0.0), trv)
    @fact decoration(Decorated(Interval(0.0, 0.0), com) ^ Decorated(Interval(-2.5, 0.1), com)) --> decoration(Decorated(Interval(0.0, 0.0), trv))
    @fact Decorated(Interval(0.0, 0.0), dac) ^ Decorated(Interval(-1.0, 0.0), def) --> Decorated(∅, trv)
    @fact decoration(Decorated(Interval(0.0, 0.0), dac) ^ Decorated(Interval(-1.0, 0.0), def)) --> decoration(Decorated(∅, trv))
    @fact Decorated(Interval(-1.0, -0.1), com) ^ Decorated(Interval(-0.1, 1.0), def) --> Decorated(∅, trv)
    @fact decoration(Decorated(Interval(-1.0, -0.1), com) ^ Decorated(Interval(-0.1, 1.0), def)) --> decoration(Decorated(∅, trv))
    @fact Decorated(Interval(-1.0, -0.1), dac) ^ Decorated(Interval(-0.1, 2.5), com) --> Decorated(∅, trv)
    @fact decoration(Decorated(Interval(-1.0, -0.1), dac) ^ Decorated(Interval(-0.1, 2.5), com)) --> decoration(Decorated(∅, trv))
    @fact Decorated(Interval(-1.0, -0.1), def) ^ Decorated(Interval(-0.1, Inf), trv) --> Decorated(∅, trv)
    @fact decoration(Decorated(Interval(-1.0, -0.1), def) ^ Decorated(Interval(-0.1, Inf), trv)) --> decoration(Decorated(∅, trv))
end
...
facts("minimal_exp_dec_test") do
    @fact exp(Decorated(Interval(0x1.62e42fefa39fp+9, 0x1.62e42fefa39fp+9), com)) --> Decorated(Interval(0x1.fffffffffffffp+1023, Inf), dac)
    @fact decoration(exp(Decorated(Interval(0x1.62e42fefa39fp+9, 0x1.62e42fefa39fp+9), com))) --> decoration(Decorated(Interval(0x1.fffffffffffffp+1023, Inf), dac))
    @fact exp(Decorated(Interval(0.0, 0x1.62e42fefa39ep+9), def)) --> Decorated(Interval(1.0, 0x1.fffffffffc32bp+1023), def)
    @fact decoration(exp(Decorated(Interval(0.0, 0x1.62e42fefa39ep+9), def))) --> decoration(Decorated(Interval(1.0, 0x1.fffffffffc32bp+1023), def))
end
...
facts("minimal_exp2_dec_test") do
    @fact exp2(Decorated(Interval(1024.0, 1024.0), com)) --> Decorated(Interval(0x1.fffffffffffffp+1023, Inf), dac)
    @fact decoration(exp2(Decorated(Interval(1024.0, 1024.0), com))) --> decoration(Decorated(Interval(0x1.fffffffffffffp+1023, Inf), dac))
    @fact exp2(Decorated(Interval(0x1.87f42b972949cp-1, 0x1.8b55484710029p+6), def)) --> Decorated(Interval(0x1.b333333333332p+0, 0x1.c81fd88228b4fp+98), def)
    @fact decoration(exp2(Decorated(Interval(0x1.87f42b972949cp-1, 0x1.8b55484710029p+6), def))) --> decoration(Decorated(Interval(0x1.b333333333332p+0, 0x1.c81fd88228b4fp+98), def))
end
...
facts("minimal_exp10_dec_test") do
    @fact exp10(Decorated(Interval(0x1.34413509f79ffp+8, 0x1.34413509f79ffp+8), com)) --> Decorated(Interval(0x1.fffffffffffffp+1023, Inf), dac)
    @fact decoration(exp10(Decorated(Interval(0x1.34413509f79ffp+8, 0x1.34413509f79ffp+8), com))) --> decoration(Decorated(Interval(0x1.fffffffffffffp+1023, Inf), dac))
    @fact exp10(Decorated(Interval(0x1.87f42b972949cp-1, 0x1.8b55484710029p+6), def)) --> Decorated(Interval(0x1.75014b7296807p+2, 0x1.3eec1d47dfb2bp+328), def)
    @fact decoration(exp10(Decorated(Interval(0x1.87f42b972949cp-1, 0x1.8b55484710029p+6), def))) --> decoration(Decorated(Interval(0x1.75014b7296807p+2, 0x1.3eec1d47dfb2bp+328), def))
end
...
facts("minimal_log_dec_test") do
    @fact log(Decorated(Interval(0x0.0000000000001p-1022, 0x1.fffffffffffffp1023), com)) --> Decorated(Interval(-0x1.74385446d71c4p9, 0x1.62e42fefa39fp+9), com)
    @fact decoration(log(Decorated(Interval(0x0.0000000000001p-1022, 0x1.fffffffffffffp1023), com))) --> decoration(Decorated(Interval(-0x1.74385446d71c4p9, 0x1.62e42fefa39fp+9), com))
    @fact log(Decorated(Interval(0.0, 1.0), com)) --> Decorated(Interval(-Inf, 0.0), trv)
    @fact decoration(log(Decorated(Interval(0.0, 1.0), com))) --> decoration(Decorated(Interval(-Inf, 0.0), trv))
    @fact log(Decorated(Interval(0x1.5bf0a8b14576ap+1, 0x1.5bf0a8b14576ap+1), def)) --> Decorated(Interval(0x1p+0, 0x1.0000000000001p+0), def)
    @fact decoration(log(Decorated(Interval(0x1.5bf0a8b14576ap+1, 0x1.5bf0a8b14576ap+1), def))) --> decoration(Decorated(Interval(0x1p+0, 0x1.0000000000001p+0), def))
end
...
facts("minimal_log2_dec_test") do
    @fact log2(Decorated(Interval(0x0.0000000000001p-1022, 0x1.fffffffffffffp1023), com)) --> Decorated(Interval(-1074.0, 1024.0), com)
    @fact decoration(log2(Decorated(Interval(0x0.0000000000001p-1022, 0x1.fffffffffffffp1023), com))) --> decoration(Decorated(Interval(-1074.0, 1024.0), com))
    @fact log2(Decorated(Interval(0x0.0000000000001p-1022, Inf), dac)) --> Decorated(Interval(-1074.0, Inf), dac)
    @fact decoration(log2(Decorated(Interval(0x0.0000000000001p-1022, Inf), dac))) --> decoration(Decorated(Interval(-1074.0, Inf), dac))
    @fact log2(Decorated(Interval(2.0, 32.0), def)) --> Decorated(Interval(1.0, 5.0), def)
    @fact decoration(log2(Decorated(Interval(2.0, 32.0), def))) --> decoration(Decorated(Interval(1.0, 5.0), def))
    @fact log2(Decorated(Interval(0.0, 0x1.fffffffffffffp1023), com)) --> Decorated(Interval(-Inf, 1024.0), trv)
    @fact decoration(log2(Decorated(Interval(0.0, 0x1.fffffffffffffp1023), com))) --> decoration(Decorated(Interval(-Inf, 1024.0), trv))
end
...
facts("minimal_log10_dec_test") do
    @fact log10(Decorated(Interval(0x0.0000000000001p-1022, 0x1.fffffffffffffp1023), com)) --> Decorated(Interval(-0x1.434e6420f4374p+8, 0x1.34413509f79ffp+8), com)
    @fact decoration(log10(Decorated(Interval(0x0.0000000000001p-1022, 0x1.fffffffffffffp1023), com))) --> decoration(Decorated(Interval(-0x1.434e6420f4374p+8, 0x1.34413509f79ffp+8), com))
    @fact log10(Decorated(Interval(0.0, 0x1.fffffffffffffp1023), dac)) --> Decorated(Interval(-Inf, 0x1.34413509f79ffp+8), trv)
    @fact decoration(log10(Decorated(Interval(0.0, 0x1.fffffffffffffp1023), dac))) --> decoration(Decorated(Interval(-Inf, 0x1.34413509f79ffp+8), trv))
end
...
facts("minimal_sin_dec_test") do
    @fact sin(Decorated(Interval(-0x1.921fb54442d18p+1, -0x1.921fb54442d18p+0), def)) --> Decorated(Interval(-0x1p+0, -0x1.1a62633145c06p-53), def)
    @fact decoration(sin(Decorated(Interval(-0x1.921fb54442d18p+1, -0x1.921fb54442d18p+0), def))) --> decoration(Decorated(Interval(-0x1p+0, -0x1.1a62633145c06p-53), def))
    @fact sin(Decorated(Interval(-Inf, -0.0), trv)) --> Decorated(Interval(-1.0, 1.0), trv)
    @fact decoration(sin(Decorated(Interval(-Inf, -0.0), trv))) --> decoration(Decorated(Interval(-1.0, 1.0), trv))
    @fact sin(Decorated(entireinterval(Float64), def)) --> Decorated(Interval(-1.0, 1.0), def)
    @fact decoration(sin(Decorated(entireinterval(Float64), def))) --> decoration(Decorated(Interval(-1.0, 1.0), def))
end
...
facts("minimal_cos_dec_test") do
    @fact cos(Decorated(Interval(-0x1.921fb54442d18p+0, -0x1.921fb54442d18p+0), trv)) --> Decorated(Interval(0x1.1a62633145c06p-54, 0x1.1a62633145c07p-54), trv)
    @fact decoration(cos(Decorated(Interval(-0x1.921fb54442d18p+0, -0x1.921fb54442d18p+0), trv))) --> decoration(Decorated(Interval(0x1.1a62633145c06p-54, 0x1.1a62633145c07p-54), trv))
    @fact cos(Decorated(Interval(-Inf, -0.0), def)) --> Decorated(Interval(-1.0, 1.0), def)
    @fact decoration(cos(Decorated(Interval(-Inf, -0.0), def))) --> decoration(Decorated(Interval(-1.0, 1.0), def))
    @fact cos(Decorated(entireinterval(Float64), def)) --> Decorated(Interval(-1.0, 1.0), def)
    @fact decoration(cos(Decorated(entireinterval(Float64), def))) --> decoration(Decorated(Interval(-1.0, 1.0), def))
end
...
facts("minimal_tan_dec_test") do
    ...
    @fact tan(Decorated(Interval(0.0, Inf), dac)) --> Decorated(entireinterval(Float64), trv)
    @fact decoration(tan(Decorated(Interval(0.0, Inf), dac))) --> decoration(Decorated(entireinterval(Float64), trv))
    @fact tan(Decorated(Interval(-0.0, Inf), def)) --> Decorated(entireinterval(Float64), trv)
    @fact decoration(tan(Decorated(Interval(-0.0, Inf), def))) --> decoration(Decorated(entireinterval(Float64), trv))
    @fact tan(Decorated(Interval(-Inf, 0.0), trv)) --> Decorated(entireinterval(Float64), trv)
    @fact decoration(tan(Decorated(Interval(-Inf, 0.0), trv))) --> decoration(Decorated(entireinterval(Float64), trv))
    @fact tan(Decorated(Interval(-Inf, -0.0), dac)) --> Decorated(entireinterval(Float64), trv)
    @fact decoration(tan(Decorated(Interval(-Inf, -0.0), dac))) --> decoration(Decorated(entireinterval(Float64), trv))
    ...
    @fact tan(Decorated(Interval(0.0, 0.0), com)) --> Decorated(Interval(0.0, 0.0), com)
    @fact decoration(tan(Decorated(Interval(0.0, 0.0), com))) --> decoration(Decorated(Interval(0.0, 0.0), com))
    @fact tan(Decorated(Interval(-0.0, -0.0), def)) --> Decorated(Interval(0.0, 0.0), def)
    @fact decoration(tan(Decorated(Interval(-0.0, -0.0), def))) --> decoration(Decorated(Interval(0.0, 0.0), def))
    @fact tan(Decorated(Interval(0x1.921fb54442d18p+0, 0x1.921fb54442d18p+0), com)) --> Decorated(Interval(0x1.d02967c31cdb4p+53, 0x1.d02967c31cdb5p+53), com)
    @fact decoration(tan(Decorated(Interval(0x1.921fb54442d18p+0, 0x1.921fb54442d18p+0), com))) --> decoration(Decorated(Interval(0x1.d02967c31cdb4p+53, 0x1.d02967c31cdb5p+53), com))
    @fact tan(Decorated(Interval(0x1.921fb54442d19p+0, 0x1.921fb54442d19p+0), def)) --> Decorated(Interval(-0x1.617a15494767bp+52, -0x1.617a15494767ap+52), def)
    @fact decoration(tan(Decorated(Interval(0x1.921fb54442d19p+0, 0x1.921fb54442d19p+0), def))) --> decoration(Decorated(Interval(-0x1.617a15494767bp+52, -0x1.617a15494767ap+52), def))
    @fact tan(Decorated(Interval(0x1.921fb54442d18p+0, 0x1.921fb54442d19p+0), dac)) --> Decorated(entireinterval(Float64), trv)
    @fact decoration(tan(Decorated(Interval(0x1.921fb54442d18p+0, 0x1.921fb54442d19p+0), dac))) --> decoration(Decorated(entireinterval(Float64), trv))
    @fact tan(Decorated(Interval(0x1.921fb54442d18p+1, 0x1.921fb54442d18p+1), trv)) --> Decorated(Interval(-0x1.1a62633145c07p-53, -0x1.1a62633145c06p-53), trv)
    @fact decoration(tan(Decorated(Interval(0x1.921fb54442d18p+1, 0x1.921fb54442d18p+1), trv))) --> decoration(Decorated(Interval(-0x1.1a62633145c07p-53, -0x1.1a62633145c06p-53), trv))
    @fact tan(Decorated(Interval(0x1.921fb54442d19p+1, 0x1.921fb54442d19p+1), com)) --> Decorated(Interval(0x1.72cece675d1fcp-52, 0x1.72cece675d1fdp-52), com)
    @fact decoration(tan(Decorated(Interval(0x1.921fb54442d19p+1, 0x1.921fb54442d19p+1), com))) --> decoration(Decorated(Interval(0x1.72cece675d1fcp-52, 0x1.72cece675d1fdp-52), com))
    @fact tan(Decorated(Interval(0.0, 0x1.921fb54442d18p+0), dac)) --> Decorated(Interval(0.0, 0x1.d02967c31cdb5p+53), dac)
    @fact decoration(tan(Decorated(Interval(0.0, 0x1.921fb54442d18p+0), dac))) --> decoration(Decorated(Interval(0.0, 0x1.d02967c31cdb5p+53), dac))
    @fact tan(Decorated(Interval(-0.0, 0x1.921fb54442d18p+0), com)) --> Decorated(Interval(0.0, 0x1.d02967c31cdb5p+53), com)
    @fact decoration(tan(Decorated(Interval(-0.0, 0x1.921fb54442d18p+0), com))) --> decoration(Decorated(Interval(0.0, 0x1.d02967c31cdb5p+53), com))
    @fact tan(Decorated(Interval(0.0, 0x1.921fb54442d19p+0), trv)) --> Decorated(entireinterval(Float64), trv)
    @fact decoration(tan(Decorated(Interval(0.0, 0x1.921fb54442d19p+0), trv))) --> decoration(Decorated(entireinterval(Float64), trv))
    @fact tan(Decorated(Interval(-0.0, 0x1.921fb54442d19p+0), def)) --> Decorated(entireinterval(Float64), trv)
    @fact decoration(tan(Decorated(Interval(-0.0, 0x1.921fb54442d19p+0), def))) --> decoration(Decorated(entireinterval(Float64), trv))
    @fact tan(Decorated(Interval(0.0, 0x1.921fb54442d18p+1), dac)) --> Decorated(entireinterval(Float64), trv)
    @fact decoration(tan(Decorated(Interval(0.0, 0x1.921fb54442d18p+1), dac))) --> decoration(Decorated(entireinterval(Float64), trv))
    @fact tan(Decorated(Interval(-0.0, 0x1.921fb54442d18p+1), com)) --> Decorated(entireinterval(Float64), trv)
    @fact decoration(tan(Decorated(Interval(-0.0, 0x1.921fb54442d18p+1), com))) --> decoration(Decorated(entireinterval(Float64), trv))
    @fact tan(Decorated(Interval(0.0, 0x1.921fb54442d19p+1), trv)) --> Decorated(entireinterval(Float64), trv)
    @fact decoration(tan(Decorated(Interval(0.0, 0x1.921fb54442d19p+1), trv))) --> decoration(Decorated(entireinterval(Float64), trv))
    @fact tan(Decorated(Interval(-0.0, 0x1.921fb54442d19p+1), def)) --> Decorated(entireinterval(Float64), trv)
    @fact decoration(tan(Decorated(Interval(-0.0, 0x1.921fb54442d19p+1), def))) --> decoration(Decorated(entireinterval(Float64), trv))
    @fact tan(Decorated(Interval(0x1p-51, 0x1.921fb54442d18p+1), dac)) --> Decorated(entireinterval(Float64), trv)
    @fact decoration(tan(Decorated(Interval(0x1p-51, 0x1.921fb54442d18p+1), dac))) --> decoration(Decorated(entireinterval(Float64), trv))
    @fact tan(Decorated(Interval(0x1p-51, 0x1.921fb54442d19p+1), com)) --> Decorated(entireinterval(Float64), trv)
    @fact decoration(tan(Decorated(Interval(0x1p-51, 0x1.921fb54442d19p+1), com))) --> decoration(Decorated(entireinterval(Float64), trv))
    @fact tan(Decorated(Interval(0x1p-52, 0x1.921fb54442d18p+1), trv)) --> Decorated(entireinterval(Float64), trv)
    @fact decoration(tan(Decorated(Interval(0x1p-52, 0x1.921fb54442d18p+1), trv))) --> decoration(Decorated(entireinterval(Float64), trv))
    @fact tan(Decorated(Interval(0x1p-52, 0x1.921fb54442d19p+1), def)) --> Decorated(entireinterval(Float64), trv)
    @fact decoration(tan(Decorated(Interval(0x1p-52, 0x1.921fb54442d19p+1), def))) --> decoration(Decorated(entireinterval(Float64), trv))
    @fact tan(Decorated(Interval(-0x1.921fb54442d18p+0, 0x1.921fb54442d18p+0), com)) --> Decorated(Interval(-0x1.d02967c31cdb5p+53, 0x1.d02967c31cdb5p+53), com)
    @fact decoration(tan(Decorated(Interval(-0x1.921fb54442d18p+0, 0x1.921fb54442d18p+0), com))) --> decoration(Decorated(Interval(-0x1.d02967c31cdb5p+53, 0x1.d02967c31cdb5p+53), com))
    @fact tan(Decorated(Interval(-0x1.921fb54442d18p+0, 0x1.921fb54442d19p+0), trv)) --> Decorated(entireinterval(Float64), trv)
    @fact decoration(tan(Decorated(Interval(-0x1.921fb54442d18p+0, 0x1.921fb54442d19p+0), trv))) --> decoration(Decorated(entireinterval(Float64), trv))
    @fact tan(Decorated(Interval(-0x1.921fb54442d19p+0, 0x1.921fb54442d18p+0), def)) --> Decorated(entireinterval(Float64), trv)
    @fact decoration(tan(Decorated(Interval(-0x1.921fb54442d19p+0, 0x1.921fb54442d18p+0), def))) --> decoration(Decorated(entireinterval(Float64), trv))
    @fact tan(Decorated(Interval(-0x1.921fb54442d19p+0, 0x1.921fb54442d19p+0), dac)) --> Decorated(entireinterval(Float64), trv)
    @fact decoration(tan(Decorated(Interval(-0x1.921fb54442d19p+0, 0x1.921fb54442d19p+0), dac))) --> decoration(Decorated(entireinterval(Float64), trv))
    @fact tan(Decorated(Interval(-0x1.555475a31a4bep-2, 0x1.999999999999ap-4), com)) --> Decorated(Interval(-0x1.628f4fd931fefp-2, 0x1.9af8877430b81p-4), com)
    @fact decoration(tan(Decorated(Interval(-0x1.555475a31a4bep-2, 0x1.999999999999ap-4), com))) --> decoration(Decorated(Interval(-0x1.628f4fd931fefp-2, 0x1.9af8877430b81p-4), com))
    @fact tan(Decorated(Interval(0x1.4e18e147ae148p+12, 0x1.4e2028f5c28f6p+12), dac)) --> Decorated(Interval(-0x1.d6d67b035b6b4p+2, -0x1.7e42b0760e3f3p+0), dac)
    @fact decoration(tan(Decorated(Interval(0x1.4e18e147ae148p+12, 0x1.4e2028f5c28f6p+12), dac))) --> decoration(Decorated(Interval(-0x1.d6d67b035b6b4p+2, -0x1.7e42b0760e3f3p+0), dac))
    @fact tan(Decorated(Interval(0x1.4e18e147ae148p+12, 0x1.546028f5c28f6p+12), def)) --> Decorated(entireinterval(Float64), trv)
    @fact decoration(tan(Decorated(Interval(0x1.4e18e147ae148p+12, 0x1.546028f5c28f6p+12), def))) --> decoration(Decorated(entireinterval(Float64), trv))
    @fact tan(Decorated(Interval(0x1.fae147ae147aep-1, 0x1.028f5c28f5c29p+0), trv)) --> Decorated(Interval(0x1.860fadcc59064p+0, 0x1.979ad0628469dp+0), trv)
    @fact decoration(tan(Decorated(Interval(0x1.fae147ae147aep-1, 0x1.028f5c28f5c29p+0), trv))) --> decoration(Decorated(Interval(0x1.860fadcc59064p+0, 0x1.979ad0628469dp+0), trv))
end
...
facts("minimal_asin_dec_test") do
    @fact asin(Decorated(Interval(0.0, Inf), dac)) --> Decorated(Interval(0.0, 0x1.921fb54442d19p+0), trv)
    @fact decoration(asin(Decorated(Interval(0.0, Inf), dac))) --> decoration(Decorated(Interval(0.0, 0x1.921fb54442d19p+0), trv))
    @fact asin(Decorated(Interval(-Inf, 0.0), def)) --> Decorated(Interval(-0x1.921fb54442d19p+0, 0.0), trv)
    @fact decoration(asin(Decorated(Interval(-Inf, 0.0), def))) --> decoration(Decorated(Interval(-0x1.921fb54442d19p+0, 0.0), trv))
    @fact asin(Decorated(Interval(-1.0, 1.0), com)) --> Decorated(Interval(-0x1.921fb54442d19p+0, 0x1.921fb54442d19p+0), com)
    @fact decoration(asin(Decorated(Interval(-1.0, 1.0), com))) --> decoration(Decorated(Interval(-0x1.921fb54442d19p+0, 0x1.921fb54442d19p+0), com))
    @fact asin(Decorated(entireinterval(Float64), def)) --> Decorated(Interval(-0x1.921fb54442d19p+0, 0x1.921fb54442d19p+0), trv)
    @fact decoration(asin(Decorated(entireinterval(Float64), def))) --> decoration(Decorated(Interval(-0x1.921fb54442d19p+0, 0x1.921fb54442d19p+0), trv))
    @fact asin(Decorated(Interval(-0x1.51eb851eb851fp-2, 0x1.fffffffffffffp-1), def)) --> Decorated(Interval(-0x1.585ff6e341c3fp-2, 0x1.921fb50442d19p+0), def)
    @fact decoration(asin(Decorated(Interval(-0x1.51eb851eb851fp-2, 0x1.fffffffffffffp-1), def))) --> decoration(Decorated(Interval(-0x1.585ff6e341c3fp-2, 0x1.921fb50442d19p+0), def))
end
...
facts("minimal_acos_dec_test") do
    @fact acos(Decorated(Interval(0.0, Inf), dac)) --> Decorated(Interval(0.0, 0x1.921fb54442d19p+0), trv)
    @fact decoration(acos(Decorated(Interval(0.0, Inf), dac))) --> decoration(Decorated(Interval(0.0, 0x1.921fb54442d19p+0), trv))
    @fact acos(Decorated(Interval(-Inf, 0.0), def)) --> Decorated(Interval(0x1.921fb54442d18p+0, 0x1.921fb54442d19p+1), trv)
    @fact decoration(acos(Decorated(Interval(-Inf, 0.0), def))) --> decoration(Decorated(Interval(0x1.921fb54442d18p+0, 0x1.921fb54442d19p+1), trv))
    @fact acos(Decorated(Interval(-1.0, 1.0), com)) --> Decorated(Interval(0.0, 0x1.921fb54442d19p+1), com)
    @fact decoration(acos(Decorated(Interval(-1.0, 1.0), com))) --> decoration(Decorated(Interval(0.0, 0x1.921fb54442d19p+1), com))
    @fact acos(Decorated(entireinterval(Float64), def)) --> Decorated(Interval(0.0, 0x1.921fb54442d19p+1), trv)
    @fact decoration(acos(Decorated(entireinterval(Float64), def))) --> decoration(Decorated(Interval(0.0, 0x1.921fb54442d19p+1), trv))
    @fact acos(Decorated(Interval(-0x1.51eb851eb851fp-2, 0x1.fffffffffffffp-1), def)) --> Decorated(Interval(0x1p-26, 0x1.e837b2fd13428p+0), def)
    @fact decoration(acos(Decorated(Interval(-0x1.51eb851eb851fp-2, 0x1.fffffffffffffp-1), def))) --> decoration(Decorated(Interval(0x1p-26, 0x1.e837b2fd13428p+0), def))
end
...
facts("minimal_atan_dec_test") do
    @fact atan(Decorated(Interval(0.0, Inf), dac)) --> Decorated(Interval(0.0, 0x1.921fb54442d19p+0), dac)
    @fact decoration(atan(Decorated(Interval(0.0, Inf), dac))) --> decoration(Decorated(Interval(0.0, 0x1.921fb54442d19p+0), dac))
    @fact atan(Decorated(Interval(-Inf, 0.0), def)) --> Decorated(Interval(-0x1.921fb54442d19p+0, 0.0), def)
    @fact decoration(atan(Decorated(Interval(-Inf, 0.0), def))) --> decoration(Decorated(Interval(-0x1.921fb54442d19p+0, 0.0), def))
    @fact atan(Decorated(entireinterval(Float64), def)) --> Decorated(Interval(-0x1.921fb54442d19p+0, 0x1.921fb54442d19p+0), def)
    @fact decoration(atan(Decorated(entireinterval(Float64), def))) --> decoration(Decorated(Interval(-0x1.921fb54442d19p+0, 0x1.921fb54442d19p+0), def))
    @fact atan(Decorated(Interval(1.0, 0x1.4c2463567c5acp+25), trv)) --> Decorated(Interval(0x1.921fb54442d18p-1, 0x1.921fb4e19abd7p+0), trv)
    @fact decoration(atan(Decorated(Interval(1.0, 0x1.4c2463567c5acp+25), trv))) --> decoration(Decorated(Interval(0x1.921fb54442d18p-1, 0x1.921fb4e19abd7p+0), trv))
    @fact atan(Decorated(Interval(-0x1.fd219490eaac1p+38, -0x1.1af1c9d74f06dp+9), com)) --> Decorated(Interval(-0x1.921fb54440cebp+0, -0x1.91abe5c1e4c6dp+0), com)
    @fact decoration(atan(Decorated(Interval(-0x1.fd219490eaac1p+38, -0x1.1af1c9d74f06dp+9), com))) --> decoration(Decorated(Interval(-0x1.921fb54440cebp+0, -0x1.91abe5c1e4c6dp+0), com))
end
...
facts("minimal_atan2_dec_test") do
    ...
    @fact atan2(Decorated(∅, trv), Decorated(Interval(0.0, 0.0), com)) --> Decorated(∅, trv)
    @fact decoration(atan2(Decorated(∅, trv), Decorated(Interval(0.0, 0.0), com))) --> decoration(Decorated(∅, trv))
    @fact atan2(Decorated(∅, trv), Decorated(Interval(-0.0, 0.0), dac)) --> Decorated(∅, trv)
    @fact decoration(atan2(Decorated(∅, trv), Decorated(Interval(-0.0, 0.0), dac))) --> decoration(Decorated(∅, trv))
    @fact atan2(Decorated(∅, trv), Decorated(Interval(0.0, -0.0), def)) --> Decorated(∅, trv)
    @fact decoration(atan2(Decorated(∅, trv), Decorated(Interval(0.0, -0.0), def))) --> decoration(Decorated(∅, trv))
    @fact atan2(Decorated(∅, trv), Decorated(Interval(-0.0, -0.0), trv)) --> Decorated(∅, trv)
    @fact decoration(atan2(Decorated(∅, trv), Decorated(Interval(-0.0, -0.0), trv))) --> decoration(Decorated(∅, trv))
    @fact atan2(Decorated(∅, trv), Decorated(Interval(-2.0, -0.1), com)) --> Decorated(∅, trv)
    @fact decoration(atan2(Decorated(∅, trv), Decorated(Interval(-2.0, -0.1), com))) --> decoration(Decorated(∅, trv))
    @fact atan2(Decorated(∅, trv), Decorated(Interval(-2.0, 0.0), dac)) --> Decorated(∅, trv)
    @fact decoration(atan2(Decorated(∅, trv), Decorated(Interval(-2.0, 0.0), dac))) --> decoration(Decorated(∅, trv))
    @fact atan2(Decorated(∅, trv), Decorated(Interval(-2.0, -0.0), def)) --> Decorated(∅, trv)
    @fact decoration(atan2(Decorated(∅, trv), Decorated(Interval(-2.0, -0.0), def))) --> decoration(Decorated(∅, trv))
    @fact atan2(Decorated(∅, trv), Decorated(Interval(-2.0, 1.0), trv)) --> Decorated(∅, trv)
    @fact decoration(atan2(Decorated(∅, trv), Decorated(Interval(-2.0, 1.0), trv))) --> decoration(Decorated(∅, trv))
    @fact atan2(Decorated(∅, trv), Decorated(Interval(0.0, 1.0), com)) --> Decorated(∅, trv)
    @fact decoration(atan2(Decorated(∅, trv), Decorated(Interval(0.0, 1.0), com))) --> decoration(Decorated(∅, trv))
    @fact atan2(Decorated(∅, trv), Decorated(Interval(-0.0, 1.0), dac)) --> Decorated(∅, trv)
    @fact decoration(atan2(Decorated(∅, trv), Decorated(Interval(-0.0, 1.0), dac))) --> decoration(Decorated(∅, trv))
    @fact atan2(Decorated(∅, trv), Decorated(Interval(0.1, 1.0), def)) --> Decorated(∅, trv)
    @fact decoration(atan2(Decorated(∅, trv), Decorated(Interval(0.1, 1.0), def))) --> decoration(Decorated(∅, trv))
    ...
    @fact atan2(Decorated(entireinterval(Float64), def), Decorated(entireinterval(Float64), def)) --> Decorated(Interval(-0x1.921fb54442d19p+1, 0x1.921fb54442d19p+1), trv)
    @fact decoration(atan2(Decorated(entireinterval(Float64), def), Decorated(entireinterval(Float64), def))) --> decoration(Decorated(Interval(-0x1.921fb54442d19p+1, 0x1.921fb54442d19p+1), trv))
    @fact atan2(Decorated(entireinterval(Float64), def), Decorated(Interval(0.0, 0.0), com)) --> Decorated(Interval(-0x1.921fb54442d19p+0, 0x1.921fb54442d19p+0), trv)
    @fact decoration(atan2(Decorated(entireinterval(Float64), def), Decorated(Interval(0.0, 0.0), com))) --> decoration(Decorated(Interval(-0x1.921fb54442d19p+0, 0x1.921fb54442d19p+0), trv))
    @fact atan2(Decorated(entireinterval(Float64), def), Decorated(Interval(0.0, -0.0), def)) --> Decorated(Interval(-0x1.921fb54442d19p+0, 0x1.921fb54442d19p+0), trv)
    @fact decoration(atan2(Decorated(entireinterval(Float64), def), Decorated(Interval(0.0, -0.0), def))) --> decoration(Decorated(Interval(-0x1.921fb54442d19p+0, 0x1.921fb54442d19p+0), trv))
    @fact atan2(Decorated(entireinterval(Float64), def), Decorated(Interval(-0.0, 0.0), dac)) --> Decorated(Interval(-0x1.921fb54442d19p+0, 0x1.921fb54442d19p+0), trv)
    @fact decoration(atan2(Decorated(entireinterval(Float64), def), Decorated(Interval(-0.0, 0.0), dac))) --> decoration(Decorated(Interval(-0x1.921fb54442d19p+0, 0x1.921fb54442d19p+0), trv))
    @fact atan2(Decorated(entireinterval(Float64), def), Decorated(Interval(-0.0, -0.0), trv)) --> Decorated(Interval(-0x1.921fb54442d19p+0, 0x1.921fb54442d19p+0), trv)
    @fact decoration(atan2(Decorated(entireinterval(Float64), def), Decorated(Interval(-0.0, -0.0), trv))) --> decoration(Decorated(Interval(-0x1.921fb54442d19p+0, 0x1.921fb54442d19p+0), trv))
    @fact atan2(Decorated(entireinterval(Float64), def), Decorated(Interval(-2.0, -0.1), com)) --> Decorated(Interval(-0x1.921fb54442d19p+1, 0x1.921fb54442d19p+1), def)
    @fact decoration(atan2(Decorated(entireinterval(Float64), def), Decorated(Interval(-2.0, -0.1), com))) --> decoration(Decorated(Interval(-0x1.921fb54442d19p+1, 0x1.921fb54442d19p+1), def))
    @fact atan2(Decorated(entireinterval(Float64), def), Decorated(Interval(-2.0, 0.0), dac)) --> Decorated(Interval(-0x1.921fb54442d19p+1, 0x1.921fb54442d19p+1), trv)
    @fact decoration(atan2(Decorated(entireinterval(Float64), def), Decorated(Interval(-2.0, 0.0), dac))) --> decoration(Decorated(Interval(-0x1.921fb54442d19p+1, 0x1.921fb54442d19p+1), trv))
    @fact atan2(Decorated(entireinterval(Float64), def), Decorated(Interval(-2.0, -0.0), def)) --> Decorated(Interval(-0x1.921fb54442d19p+1, 0x1.921fb54442d19p+1), trv)
    @fact decoration(atan2(Decorated(entireinterval(Float64), def), Decorated(Interval(-2.0, -0.0), def))) --> decoration(Decorated(Interval(-0x1.921fb54442d19p+1, 0x1.921fb54442d19p+1), trv))
    @fact atan2(Decorated(entireinterval(Float64), def), Decorated(Interval(-2.0, 1.0), trv)) --> Decorated(Interval(-0x1.921fb54442d19p+1, 0x1.921fb54442d19p+1), trv)
    @fact decoration(atan2(Decorated(entireinterval(Float64), def), Decorated(Interval(-2.0, 1.0), trv))) --> decoration(Decorated(Interval(-0x1.921fb54442d19p+1, 0x1.921fb54442d19p+1), trv))
    @fact atan2(Decorated(entireinterval(Float64), def), Decorated(Interval(0.0, 1.0), dac)) --> Decorated(Interval(-0x1.921fb54442d19p+0, 0x1.921fb54442d19p+0), trv)
    @fact decoration(atan2(Decorated(entireinterval(Float64), def), Decorated(Interval(0.0, 1.0), dac))) --> decoration(Decorated(Interval(-0x1.921fb54442d19p+0, 0x1.921fb54442d19p+0), trv))
    @fact atan2(Decorated(entireinterval(Float64), def), Decorated(Interval(-0.0, 1.0), def)) --> Decorated(Interval(-0x1.921fb54442d19p+0, 0x1.921fb54442d19p+0), trv)
    @fact decoration(atan2(Decorated(entireinterval(Float64), def), Decorated(Interval(-0.0, 1.0), def))) --> decoration(Decorated(Interval(-0x1.921fb54442d19p+0, 0x1.921fb54442d19p+0), trv))
    @fact atan2(Decorated(entireinterval(Float64), def), Decorated(Interval(0.1, 1.0), com)) --> Decorated(Interval(-0x1.921fb54442d19p+0, 0x1.921fb54442d19p+0), def)
    @fact decoration(atan2(Decorated(entireinterval(Float64), def), Decorated(Interval(0.1, 1.0), com))) --> decoration(Decorated(Interval(-0x1.921fb54442d19p+0, 0x1.921fb54442d19p+0), def))
    @fact atan2(Decorated(Interval(0.0, 0.0), com), Decorated(∅, trv)) --> Decorated(∅, trv)
    @fact decoration(atan2(Decorated(Interval(0.0, 0.0), com), Decorated(∅, trv))) --> decoration(Decorated(∅, trv))
    @fact atan2(Decorated(Interval(0.0, 0.0), dac), Decorated(entireinterval(Float64), def)) --> Decorated(Interval(0.0, 0x1.921fb54442d19p+1), trv)
    @fact decoration(atan2(Decorated(Interval(0.0, 0.0), dac), Decorated(entireinterval(Float64), def))) --> decoration(Decorated(Interval(0.0, 0x1.921fb54442d19p+1), trv))
    @fact atan2(Decorated(Interval(0.0, 0.0), def), Decorated(Interval(0.0, 0.0), trv)) --> Decorated(∅, trv)
    @fact decoration(atan2(Decorated(Interval(0.0, 0.0), def), Decorated(Interval(0.0, 0.0), trv))) --> decoration(Decorated(∅, trv))
    @fact atan2(Decorated(Interval(0.0, 0.0), trv), Decorated(Interval(-0.0, 0.0), dac)) --> Decorated(∅, trv)
    @fact decoration(atan2(Decorated(Interval(0.0, 0.0), trv), Decorated(Interval(-0.0, 0.0), dac))) --> decoration(Decorated(∅, trv))
    @fact atan2(Decorated(Interval(0.0, 0.0), com), Decorated(Interval(0.0, -0.0), def)) --> Decorated(∅, trv)
    @fact decoration(atan2(Decorated(Interval(0.0, 0.0), com), Decorated(Interval(0.0, -0.0), def))) --> decoration(Decorated(∅, trv))
    @fact atan2(Decorated(Interval(0.0, 0.0), dac), Decorated(Interval(-0.0, -0.0), com)) --> Decorated(∅, trv)
    @fact decoration(atan2(Decorated(Interval(0.0, 0.0), dac), Decorated(Interval(-0.0, -0.0), com))) --> decoration(Decorated(∅, trv))
    @fact atan2(Decorated(Interval(0.0, 0.0), com), Decorated(Interval(-2.0, -0.1), dac)) --> Decorated(Interval(0x1.921fb54442d18p+1, 0x1.921fb54442d19p+1), dac)
    @fact decoration(atan2(Decorated(Interval(0.0, 0.0), com), Decorated(Interval(-2.0, -0.1), dac))) --> decoration(Decorated(Interval(0x1.921fb54442d18p+1, 0x1.921fb54442d19p+1), dac))
    @fact atan2(Decorated(Interval(0.0, 0.0), trv), Decorated(Interval(-2.0, 0.0), com)) --> Decorated(Interval(0x1.921fb54442d18p+1, 0x1.921fb54442d19p+1), trv)
    @fact decoration(atan2(Decorated(Interval(0.0, 0.0), trv), Decorated(Interval(-2.0, 0.0), com))) --> decoration(Decorated(Interval(0x1.921fb54442d18p+1, 0x1.921fb54442d19p+1), trv))
    @fact atan2(Decorated(Interval(0.0, 0.0), com), Decorated(Interval(-2.0, -0.0), trv)) --> Decorated(Interval(0x1.921fb54442d18p+1, 0x1.921fb54442d19p+1), trv)
    @fact decoration(atan2(Decorated(Interval(0.0, 0.0), com), Decorated(Interval(-2.0, -0.0), trv))) --> decoration(Decorated(Interval(0x1.921fb54442d18p+1, 0x1.921fb54442d19p+1), trv))
    @fact atan2(Decorated(Interval(0.0, 0.0), dac), Decorated(Interval(-2.0, 1.0), def)) --> Decorated(Interval(0.0, 0x1.921fb54442d19p+1), trv)
    @fact decoration(atan2(Decorated(Interval(0.0, 0.0), dac), Decorated(Interval(-2.0, 1.0), def))) --> decoration(Decorated(Interval(0.0, 0x1.921fb54442d19p+1), trv))
    @fact atan2(Decorated(Interval(0.0, 0.0), def), Decorated(Interval(0.0, 1.0), com)) --> Decorated(Interval(0.0, 0.0), trv)
    @fact decoration(atan2(Decorated(Interval(0.0, 0.0), def), Decorated(Interval(0.0, 1.0), com))) --> decoration(Decorated(Interval(0.0, 0.0), trv))
    @fact atan2(Decorated(Interval(0.0, 0.0), trv), Decorated(Interval(-0.0, 1.0), dac)) --> Decorated(Interval(0.0, 0.0), trv)
    @fact decoration(atan2(Decorated(Interval(0.0, 0.0), trv), Decorated(Interval(-0.0, 1.0), dac))) --> decoration(Decorated(Interval(0.0, 0.0), trv))
    @fact atan2(Decorated(Interval(0.0, 0.0), com), Decorated(Interval(0.1, 1.0), com)) --> Decorated(Interval(0.0, 0.0), com)
    @fact decoration(atan2(Decorated(Interval(0.0, 0.0), com), Decorated(Interval(0.1, 1.0), com))) --> decoration(Decorated(Interval(0.0, 0.0), com))
    @fact atan2(Decorated(Interval(-0.0, 0.0), com), Decorated(∅, trv)) --> Decorated(∅, trv)
    @fact decoration(atan2(Decorated(Interval(-0.0, 0.0), com), Decorated(∅, trv))) --> decoration(Decorated(∅, trv))
    @fact atan2(Decorated(Interval(-0.0, 0.0), dac), Decorated(entireinterval(Float64), def)) --> Decorated(Interval(0.0, 0x1.921fb54442d19p+1), trv)
    @fact decoration(atan2(Decorated(Interval(-0.0, 0.0), dac), Decorated(entireinterval(Float64), def))) --> decoration(Decorated(Interval(0.0, 0x1.921fb54442d19p+1), trv))
    @fact atan2(Decorated(Interval(-0.0, 0.0), def), Decorated(Interval(0.0, 0.0), com)) --> Decorated(∅, trv)
    @fact decoration(atan2(Decorated(Interval(-0.0, 0.0), def), Decorated(Interval(0.0, 0.0), com))) --> decoration(Decorated(∅, trv))
    @fact atan2(Decorated(Interval(-0.0, 0.0), trv), Decorated(Interval(-0.0, 0.0), trv)) --> Decorated(∅, trv)
    @fact decoration(atan2(Decorated(Interval(-0.0, 0.0), trv), Decorated(Interval(-0.0, 0.0), trv))) --> decoration(Decorated(∅, trv))
    @fact atan2(Decorated(Interval(-0.0, 0.0), com), Decorated(Interval(0.0, -0.0), def)) --> Decorated(∅, trv)
    @fact decoration(atan2(Decorated(Interval(-0.0, 0.0), com), Decorated(Interval(0.0, -0.0), def))) --> decoration(Decorated(∅, trv))
    @fact atan2(Decorated(Interval(-0.0, 0.0), dac), Decorated(Interval(-0.0, -0.0), com)) --> Decorated(∅, trv)
    @fact decoration(atan2(Decorated(Interval(-0.0, 0.0), dac), Decorated(Interval(-0.0, -0.0), com))) --> decoration(Decorated(∅, trv))
    @fact atan2(Decorated(Interval(-0.0, 0.0), dac), Decorated(Interval(-2.0, -0.1), dac)) --> Decorated(Interval(0x1.921fb54442d18p+1, 0x1.921fb54442d19p+1), dac)
    @fact decoration(atan2(Decorated(Interval(-0.0, 0.0), dac), Decorated(Interval(-2.0, -0.1), dac))) --> decoration(Decorated(Interval(0x1.921fb54442d18p+1, 0x1.921fb54442d19p+1), dac))
    @fact atan2(Decorated(Interval(-0.0, 0.0), trv), Decorated(Interval(-2.0, 0.0), com)) --> Decorated(Interval(0x1.921fb54442d18p+1, 0x1.921fb54442d19p+1), trv)
    @fact decoration(atan2(Decorated(Interval(-0.0, 0.0), trv), Decorated(Interval(-2.0, 0.0), com))) --> decoration(Decorated(Interval(0x1.921fb54442d18p+1, 0x1.921fb54442d19p+1), trv))
    @fact atan2(Decorated(Interval(-0.0, 0.0), com), Decorated(Interval(-2.0, -0.0), trv)) --> Decorated(Interval(0x1.921fb54442d18p+1, 0x1.921fb54442d19p+1), trv)
    @fact decoration(atan2(Decorated(Interval(-0.0, 0.0), com), Decorated(Interval(-2.0, -0.0), trv))) --> decoration(Decorated(Interval(0x1.921fb54442d18p+1, 0x1.921fb54442d19p+1), trv))
    @fact atan2(Decorated(Interval(-0.0, 0.0), dac), Decorated(Interval(-2.0, 1.0), def)) --> Decorated(Interval(0.0, 0x1.921fb54442d19p+1), trv)
    @fact decoration(atan2(Decorated(Interval(-0.0, 0.0), dac), Decorated(Interval(-2.0, 1.0), def))) --> decoration(Decorated(Interval(0.0, 0x1.921fb54442d19p+1), trv))
    @fact atan2(Decorated(Interval(-0.0, 0.0), com), Decorated(Interval(0.0, 1.0), com)) --> Decorated(Interval(0.0, 0.0), trv)
    @fact decoration(atan2(Decorated(Interval(-0.0, 0.0), com), Decorated(Interval(0.0, 1.0), com))) --> decoration(Decorated(Interval(0.0, 0.0), trv))
    @fact atan2(Decorated(Interval(-0.0, 0.0), def), Decorated(Interval(-0.0, 1.0), dac)) --> Decorated(Interval(0.0, 0.0), trv)
    @fact decoration(atan2(Decorated(Interval(-0.0, 0.0), def), Decorated(Interval(-0.0, 1.0), dac))) --> decoration(Decorated(Interval(0.0, 0.0), trv))
    @fact atan2(Decorated(Interval(-0.0, 0.0), com), Decorated(Interval(0.1, 1.0), com)) --> Decorated(Interval(0.0, 0.0), com)
    @fact decoration(atan2(Decorated(Interval(-0.0, 0.0), com), Decorated(Interval(0.1, 1.0), com))) --> decoration(Decorated(Interval(0.0, 0.0), com))
    @fact atan2(Decorated(Interval(0.0, -0.0), com), Decorated(∅, trv)) --> Decorated(∅, trv)
    @fact decoration(atan2(Decorated(Interval(0.0, -0.0), com), Decorated(∅, trv))) --> decoration(Decorated(∅, trv))
    @fact atan2(Decorated(Interval(0.0, -0.0), dac), Decorated(entireinterval(Float64), def)) --> Decorated(Interval(0.0, 0x1.921fb54442d19p+1), trv)
    @fact decoration(atan2(Decorated(Interval(0.0, -0.0), dac), Decorated(entireinterval(Float64), def))) --> decoration(Decorated(Interval(0.0, 0x1.921fb54442d19p+1), trv))
    @fact atan2(Decorated(Interval(0.0, -0.0), def), Decorated(Interval(0.0, 0.0), dac)) --> Decorated(∅, trv)
    @fact decoration(atan2(Decorated(Interval(0.0, -0.0), def), Decorated(Interval(0.0, 0.0), dac))) --> decoration(Decorated(∅, trv))
    @fact atan2(Decorated(Interval(0.0, -0.0), trv), Decorated(Interval(-0.0, 0.0), com)) --> Decorated(∅, trv)
    @fact decoration(atan2(Decorated(Interval(0.0, -0.0), trv), Decorated(Interval(-0.0, 0.0), com))) --> decoration(Decorated(∅, trv))
    @fact atan2(Decorated(Interval(0.0, -0.0), dac), Decorated(Interval(0.0, -0.0), def)) --> Decorated(∅, trv)
    @fact decoration(atan2(Decorated(Interval(0.0, -0.0), dac), Decorated(Interval(0.0, -0.0), def))) --> decoration(Decorated(∅, trv))
    @fact atan2(Decorated(Interval(0.0, -0.0), com), Decorated(Interval(-0.0, -0.0), trv)) --> Decorated(∅, trv)
    @fact decoration(atan2(Decorated(Interval(0.0, -0.0), com), Decorated(Interval(-0.0, -0.0), trv))) --> decoration(Decorated(∅, trv))
    @fact atan2(Decorated(Interval(0.0, -0.0), com), Decorated(Interval(-2.0, -0.1), dac)) --> Decorated(Interval(0x1.921fb54442d18p+1, 0x1.921fb54442d19p+1), dac)
    @fact decoration(atan2(Decorated(Interval(0.0, -0.0), com), Decorated(Interval(-2.0, -0.1), dac))) --> decoration(Decorated(Interval(0x1.921fb54442d18p+1, 0x1.921fb54442d19p+1), dac))
    @fact atan2(Decorated(Interval(0.0, -0.0), def), Decorated(Interval(-2.0, 0.0), com)) --> Decorated(Interval(0x1.921fb54442d18p+1, 0x1.921fb54442d19p+1), trv)
    @fact decoration(atan2(Decorated(Interval(0.0, -0.0), def), Decorated(Interval(-2.0, 0.0), com))) --> decoration(Decorated(Interval(0x1.921fb54442d18p+1, 0x1.921fb54442d19p+1), trv))
    @fact atan2(Decorated(Interval(0.0, -0.0), com), Decorated(Interval(-2.0, -0.0), dac)) --> Decorated(Interval(0x1.921fb54442d18p+1, 0x1.921fb54442d19p+1), trv)
    @fact decoration(atan2(Decorated(Interval(0.0, -0.0), com), Decorated(Interval(-2.0, -0.0), dac))) --> decoration(Decorated(Interval(0x1.921fb54442d18p+1, 0x1.921fb54442d19p+1), trv))
    @fact atan2(Decorated(Interval(0.0, -0.0), dac), Decorated(Interval(-2.0, 1.0), com)) --> Decorated(Interval(0.0, 0x1.921fb54442d19p+1), trv)
    @fact decoration(atan2(Decorated(Interval(0.0, -0.0), dac), Decorated(Interval(-2.0, 1.0), com))) --> decoration(Decorated(Interval(0.0, 0x1.921fb54442d19p+1), trv))
    @fact atan2(Decorated(Interval(0.0, -0.0), com), Decorated(Interval(0.0, 1.0), trv)) --> Decorated(Interval(0.0, 0.0), trv)
    @fact decoration(atan2(Decorated(Interval(0.0, -0.0), com), Decorated(Interval(0.0, 1.0), trv))) --> decoration(Decorated(Interval(0.0, 0.0), trv))
    @fact atan2(Decorated(Interval(0.0, -0.0), def), Decorated(Interval(-0.0, 1.0), com)) --> Decorated(Interval(0.0, 0.0), trv)
    @fact decoration(atan2(Decorated(Interval(0.0, -0.0), def), Decorated(Interval(-0.0, 1.0), com))) --> decoration(Decorated(Interval(0.0, 0.0), trv))
    @fact atan2(Decorated(Interval(0.0, -0.0), com), Decorated(Interval(0.1, 1.0), def)) --> Decorated(Interval(0.0, 0.0), def)
    @fact decoration(atan2(Decorated(Interval(0.0, -0.0), com), Decorated(Interval(0.1, 1.0), def))) --> decoration(Decorated(Interval(0.0, 0.0), def))
    @fact atan2(Decorated(Interval(-0.0, -0.0), com), Decorated(∅, trv)) --> Decorated(∅, trv)
    @fact decoration(atan2(Decorated(Interval(-0.0, -0.0), com), Decorated(∅, trv))) --> decoration(Decorated(∅, trv))
    @fact atan2(Decorated(Interval(-0.0, -0.0), def), Decorated(entireinterval(Float64), def)) --> Decorated(Interval(0.0, 0x1.921fb54442d19p+1), trv)
    @fact decoration(atan2(Decorated(Interval(-0.0, -0.0), def), Decorated(entireinterval(Float64), def))) --> decoration(Decorated(Interval(0.0, 0x1.921fb54442d19p+1), trv))
    @fact atan2(Decorated(Interval(-0.0, -0.0), dac), Decorated(Interval(0.0, 0.0), com)) --> Decorated(∅, trv)
    @fact decoration(atan2(Decorated(Interval(-0.0, -0.0), dac), Decorated(Interval(0.0, 0.0), com))) --> decoration(Decorated(∅, trv))
    @fact atan2(Decorated(Interval(-0.0, -0.0), trv), Decorated(Interval(-0.0, 0.0), def)) --> Decorated(∅, trv)
    @fact decoration(atan2(Decorated(Interval(-0.0, -0.0), trv), Decorated(Interval(-0.0, 0.0), def))) --> decoration(Decorated(∅, trv))
    @fact atan2(Decorated(Interval(-0.0, -0.0), com), Decorated(Interval(0.0, -0.0), trv)) --> Decorated(∅, trv)
    @fact decoration(atan2(Decorated(Interval(-0.0, -0.0), com), Decorated(Interval(0.0, -0.0), trv))) --> decoration(Decorated(∅, trv))
    @fact atan2(Decorated(Interval(-0.0, -0.0), dac), Decorated(Interval(-0.0, -0.0), com)) --> Decorated(∅, trv)
    @fact decoration(atan2(Decorated(Interval(-0.0, -0.0), dac), Decorated(Interval(-0.0, -0.0), com))) --> decoration(Decorated(∅, trv))
    @fact atan2(Decorated(Interval(-0.0, -0.0), def), Decorated(Interval(-2.0, -0.1), dac)) --> Decorated(Interval(0x1.921fb54442d18p+1, 0x1.921fb54442d19p+1), def)
    @fact decoration(atan2(Decorated(Interval(-0.0, -0.0), def), Decorated(Interval(-2.0, -0.1), dac))) --> decoration(Decorated(Interval(0x1.921fb54442d18p+1, 0x1.921fb54442d19p+1), def))
    @fact atan2(Decorated(Interval(-0.0, -0.0), trv), Decorated(Interval(-2.0, 0.0), def)) --> Decorated(Interval(0x1.921fb54442d18p+1, 0x1.921fb54442d19p+1), trv)
    @fact decoration(atan2(Decorated(Interval(-0.0, -0.0), trv), Decorated(Interval(-2.0, 0.0), def))) --> decoration(Decorated(Interval(0x1.921fb54442d18p+1, 0x1.921fb54442d19p+1), trv))
    @fact atan2(Decorated(Interval(-0.0, -0.0), dac), Decorated(Interval(-2.0, -0.0), trv)) --> Decorated(Interval(0x1.921fb54442d18p+1, 0x1.921fb54442d19p+1), trv)
    @fact decoration(atan2(Decorated(Interval(-0.0, -0.0), dac), Decorated(Interval(-2.0, -0.0), trv))) --> decoration(Decorated(Interval(0x1.921fb54442d18p+1, 0x1.921fb54442d19p+1), trv))
    @fact atan2(Decorated(Interval(-0.0, -0.0), def), Decorated(Interval(-2.0, 1.0), com)) --> Decorated(Interval(0.0, 0x1.921fb54442d19p+1), trv)
    @fact decoration(atan2(Decorated(Interval(-0.0, -0.0), def), Decorated(Interval(-2.0, 1.0), com))) --> decoration(Decorated(Interval(0.0, 0x1.921fb54442d19p+1), trv))
    @fact atan2(Decorated(Interval(-0.0, -0.0), com), Decorated(Interval(0.0, 1.0), com)) --> Decorated(Interval(0.0, 0.0), trv)
    @fact decoration(atan2(Decorated(Interval(-0.0, -0.0), com), Decorated(Interval(0.0, 1.0), com))) --> decoration(Decorated(Interval(0.0, 0.0), trv))
    @fact atan2(Decorated(Interval(-0.0, -0.0), trv), Decorated(Interval(-0.0, 1.0), dac)) --> Decorated(Interval(0.0, 0.0), trv)
    @fact decoration(atan2(Decorated(Interval(-0.0, -0.0), trv), Decorated(Interval(-0.0, 1.0), dac))) --> decoration(Decorated(Interval(0.0, 0.0), trv))
    @fact atan2(Decorated(Interval(-0.0, -0.0), com), Decorated(Interval(0.1, 1.0), com)) --> Decorated(Interval(0.0, 0.0), com)
    @fact decoration(atan2(Decorated(Interval(-0.0, -0.0), com), Decorated(Interval(0.1, 1.0), com))) --> decoration(Decorated(Interval(0.0, 0.0), com))
    @fact atan2(Decorated(Interval(-2.0, -0.1), dac), Decorated(∅, trv)) --> Decorated(∅, trv)
    @fact decoration(atan2(Decorated(Interval(-2.0, -0.1), dac), Decorated(∅, trv))) --> decoration(Decorated(∅, trv))
    @fact atan2(Decorated(Interval(-2.0, -0.1), def), Decorated(entireinterval(Float64), def)) --> Decorated(Interval(-0x1.921fb54442d19p+1, 0.0), def)
    @fact decoration(atan2(Decorated(Interval(-2.0, -0.1), def), Decorated(entireinterval(Float64), def))) --> decoration(Decorated(Interval(-0x1.921fb54442d19p+1, 0.0), def))
    @fact atan2(Decorated(Interval(-2.0, -0.1), trv), Decorated(Interval(0.0, 0.0), com)) --> Decorated(Interval(-0x1.921fb54442d19p+0, -0x1.921fb54442d18p+0), trv)
    @fact decoration(atan2(Decorated(Interval(-2.0, -0.1), trv), Decorated(Interval(0.0, 0.0), com))) --> decoration(Decorated(Interval(-0x1.921fb54442d19p+0, -0x1.921fb54442d18p+0), trv))
    @fact atan2(Decorated(Interval(-2.0, -0.1), com), Decorated(Interval(0.0, -0.0), dac)) --> Decorated(Interval(-0x1.921fb54442d19p+0, -0x1.921fb54442d18p+0), dac)
    @fact decoration(atan2(Decorated(Interval(-2.0, -0.1), com), Decorated(Interval(0.0, -0.0), dac))) --> decoration(Decorated(Interval(-0x1.921fb54442d19p+0, -0x1.921fb54442d18p+0), dac))
    @fact atan2(Decorated(Interval(-2.0, -0.1), dac), Decorated(Interval(-0.0, 0.0), def)) --> Decorated(Interval(-0x1.921fb54442d19p+0, -0x1.921fb54442d18p+0), def)
    @fact decoration(atan2(Decorated(Interval(-2.0, -0.1), dac), Decorated(Interval(-0.0, 0.0), def))) --> decoration(Decorated(Interval(-0x1.921fb54442d19p+0, -0x1.921fb54442d18p+0), def))
    @fact atan2(Decorated(Interval(-2.0, -0.1), com), Decorated(Interval(0.0, -0.0), trv)) --> Decorated(Interval(-0x1.921fb54442d19p+0, -0x1.921fb54442d18p+0), trv)
    @fact decoration(atan2(Decorated(Interval(-2.0, -0.1), com), Decorated(Interval(0.0, -0.0), trv))) --> decoration(Decorated(Interval(-0x1.921fb54442d19p+0, -0x1.921fb54442d18p+0), trv))
    @fact atan2(Decorated(Interval(-2.0, -0.1), def), Decorated(Interval(-2.0, -0.1), com)) --> Decorated(Interval(-0x1.8bbaabde5e29cp+1, -0x1.9ee9c8100c211p+0), def)
    @fact decoration(atan2(Decorated(Interval(-2.0, -0.1), def), Decorated(Interval(-2.0, -0.1), com))) --> decoration(Decorated(Interval(-0x1.8bbaabde5e29cp+1, -0x1.9ee9c8100c211p+0), def))
    @fact atan2(Decorated(Interval(-2.0, -0.1), com), Decorated(Interval(-2.0, 0.0), def)) --> Decorated(Interval(-0x1.8bbaabde5e29cp+1, -0x1.921fb54442d18p+0), def)
    @fact decoration(atan2(Decorated(Interval(-2.0, -0.1), com), Decorated(Interval(-2.0, 0.0), def))) --> decoration(Decorated(Interval(-0x1.8bbaabde5e29cp+1, -0x1.921fb54442d18p+0), def))
    @fact atan2(Decorated(Interval(-2.0, -0.1), trv), Decorated(Interval(-2.0, -0.0), dac)) --> Decorated(Interval(-0x1.8bbaabde5e29cp+1, -0x1.921fb54442d18p+0), trv)
    @fact decoration(atan2(Decorated(Interval(-2.0, -0.1), trv), Decorated(Interval(-2.0, -0.0), dac))) --> decoration(Decorated(Interval(-0x1.8bbaabde5e29cp+1, -0x1.921fb54442d18p+0), trv))
    @fact atan2(Decorated(Interval(-2.0, -0.1), def), Decorated(Interval(-2.0, 1.0), trv)) --> Decorated(Interval(-0x1.8bbaabde5e29cp+1, -0x1.983e282e2cc4cp-4), trv)
    @fact decoration(atan2(Decorated(Interval(-2.0, -0.1), def), Decorated(Interval(-2.0, 1.0), trv))) --> decoration(Decorated(Interval(-0x1.8bbaabde5e29cp+1, -0x1.983e282e2cc4cp-4), trv))
    @fact atan2(Decorated(Interval(-2.0, -0.1), com), Decorated(Interval(0.0, 1.0), def)) --> Decorated(Interval(-0x1.921fb54442d19p+0, -0x1.983e282e2cc4cp-4), def)
    @fact decoration(atan2(Decorated(Interval(-2.0, -0.1), com), Decorated(Interval(0.0, 1.0), def))) --> decoration(Decorated(Interval(-0x1.921fb54442d19p+0, -0x1.983e282e2cc4cp-4), def))
    @fact atan2(Decorated(Interval(-2.0, -0.1), dac), Decorated(Interval(-0.0, 1.0), com)) --> Decorated(Interval(-0x1.921fb54442d19p+0, -0x1.983e282e2cc4cp-4), dac)
    @fact decoration(atan2(Decorated(Interval(-2.0, -0.1), dac), Decorated(Interval(-0.0, 1.0), com))) --> decoration(Decorated(Interval(-0x1.921fb54442d19p+0, -0x1.983e282e2cc4cp-4), dac))
    @fact atan2(Decorated(Interval(-2.0, -0.1), com), Decorated(Interval(0.1, 1.0), com)) --> Decorated(Interval(-0x1.8555a2787982p+0, -0x1.983e282e2cc4cp-4), com)
    @fact decoration(atan2(Decorated(Interval(-2.0, -0.1), com), Decorated(Interval(0.1, 1.0), com))) --> decoration(Decorated(Interval(-0x1.8555a2787982p+0, -0x1.983e282e2cc4cp-4), com))
    @fact atan2(Decorated(Interval(-2.0, 0.0), def), Decorated(∅, trv)) --> Decorated(∅, trv)
    @fact decoration(atan2(Decorated(Interval(-2.0, 0.0), def), Decorated(∅, trv))) --> decoration(Decorated(∅, trv))
    @fact atan2(Decorated(Interval(-2.0, 0.0), def), Decorated(entireinterval(Float64), def)) --> Decorated(Interval(-0x1.921fb54442d19p+1, 0x1.921fb54442d19p+1), trv)
    @fact decoration(atan2(Decorated(Interval(-2.0, 0.0), def), Decorated(entireinterval(Float64), def))) --> decoration(Decorated(Interval(-0x1.921fb54442d19p+1, 0x1.921fb54442d19p+1), trv))
    @fact atan2(Decorated(Interval(-2.0, 0.0), dac), Decorated(Interval(0.0, 0.0), dac)) --> Decorated(Interval(-0x1.921fb54442d19p+0, -0x1.921fb54442d18p+0), trv)
    @fact decoration(atan2(Decorated(Interval(-2.0, 0.0), dac), Decorated(Interval(0.0, 0.0), dac))) --> decoration(Decorated(Interval(-0x1.921fb54442d19p+0, -0x1.921fb54442d18p+0), trv))
    @fact atan2(Decorated(Interval(-2.0, 0.0), trv), Decorated(Interval(-0.0, 0.0), com)) --> Decorated(Interval(-0x1.921fb54442d19p+0, -0x1.921fb54442d18p+0), trv)
    @fact decoration(atan2(Decorated(Interval(-2.0, 0.0), trv), Decorated(Interval(-0.0, 0.0), com))) --> decoration(Decorated(Interval(-0x1.921fb54442d19p+0, -0x1.921fb54442d18p+0), trv))
    @fact atan2(Decorated(Interval(-2.0, 0.0), com), Decorated(Interval(0.0, -0.0), trv)) --> Decorated(Interval(-0x1.921fb54442d19p+0, -0x1.921fb54442d18p+0), trv)
    @fact decoration(atan2(Decorated(Interval(-2.0, 0.0), com), Decorated(Interval(0.0, -0.0), trv))) --> decoration(Decorated(Interval(-0x1.921fb54442d19p+0, -0x1.921fb54442d18p+0), trv))
    @fact atan2(Decorated(Interval(-2.0, 0.0), def), Decorated(Interval(-0.0, -0.0), def)) --> Decorated(Interval(-0x1.921fb54442d19p+0, -0x1.921fb54442d18p+0), trv)
    @fact decoration(atan2(Decorated(Interval(-2.0, 0.0), def), Decorated(Interval(-0.0, -0.0), def))) --> decoration(Decorated(Interval(-0x1.921fb54442d19p+0, -0x1.921fb54442d18p+0), trv))
    @fact atan2(Decorated(Interval(-2.0, 0.0), com), Decorated(Interval(-2.0, -0.1), dac)) --> Decorated(Interval(-0x1.921fb54442d19p+1, 0x1.921fb54442d19p+1), def)
    @fact decoration(atan2(Decorated(Interval(-2.0, 0.0), com), Decorated(Interval(-2.0, -0.1), dac))) --> decoration(Decorated(Interval(-0x1.921fb54442d19p+1, 0x1.921fb54442d19p+1), def))
    @fact atan2(Decorated(Interval(-2.0, 0.0), dac), Decorated(Interval(-2.0, 0.0), com)) --> Decorated(Interval(-0x1.921fb54442d19p+1, 0x1.921fb54442d19p+1), trv)
    @fact decoration(atan2(Decorated(Interval(-2.0, 0.0), dac), Decorated(Interval(-2.0, 0.0), com))) --> decoration(Decorated(Interval(-0x1.921fb54442d19p+1, 0x1.921fb54442d19p+1), trv))
    @fact atan2(Decorated(Interval(-2.0, 0.0), com), Decorated(Interval(-2.0, -0.0), dac)) --> Decorated(Interval(-0x1.921fb54442d19p+1, 0x1.921fb54442d19p+1), trv)
    @fact decoration(atan2(Decorated(Interval(-2.0, 0.0), com), Decorated(Interval(-2.0, -0.0), dac))) --> decoration(Decorated(Interval(-0x1.921fb54442d19p+1, 0x1.921fb54442d19p+1), trv))
    @fact atan2(Decorated(Interval(-2.0, 0.0), trv), Decorated(Interval(-2.0, 1.0), com)) --> Decorated(Interval(-0x1.921fb54442d19p+1, 0x1.921fb54442d19p+1), trv)
    @fact decoration(atan2(Decorated(Interval(-2.0, 0.0), trv), Decorated(Interval(-2.0, 1.0), com))) --> decoration(Decorated(Interval(-0x1.921fb54442d19p+1, 0x1.921fb54442d19p+1), trv))
    @fact atan2(Decorated(Interval(-2.0, 0.0), def), Decorated(Interval(0.0, 1.0), def)) --> Decorated(Interval(-0x1.921fb54442d19p+0, 0.0), trv)
    @fact decoration(atan2(Decorated(Interval(-2.0, 0.0), def), Decorated(Interval(0.0, 1.0), def))) --> decoration(Decorated(Interval(-0x1.921fb54442d19p+0, 0.0), trv))
    @fact atan2(Decorated(Interval(-2.0, 0.0), com), Decorated(Interval(-0.0, 1.0), dac)) --> Decorated(Interval(-0x1.921fb54442d19p+0, 0.0), trv)
    @fact decoration(atan2(Decorated(Interval(-2.0, 0.0), com), Decorated(Interval(-0.0, 1.0), dac))) --> decoration(Decorated(Interval(-0x1.921fb54442d19p+0, 0.0), trv))
    @fact atan2(Decorated(Interval(-2.0, 0.0), com), Decorated(Interval(0.1, 1.0), com)) --> Decorated(Interval(-0x1.8555a2787982p+0, 0.0), com)
    @fact decoration(atan2(Decorated(Interval(-2.0, 0.0), com), Decorated(Interval(0.1, 1.0), com))) --> decoration(Decorated(Interval(-0x1.8555a2787982p+0, 0.0), com))
    @fact atan2(Decorated(Interval(-2.0, -0.0), trv), Decorated(∅, trv)) --> Decorated(∅, trv)
    @fact decoration(atan2(Decorated(Interval(-2.0, -0.0), trv), Decorated(∅, trv))) --> decoration(Decorated(∅, trv))
    @fact atan2(Decorated(Interval(-2.0, -0.0), dac), Decorated(entireinterval(Float64), def)) --> Decorated(Interval(-0x1.921fb54442d19p+1, 0x1.921fb54442d19p+1), trv)
    @fact decoration(atan2(Decorated(Interval(-2.0, -0.0), dac), Decorated(entireinterval(Float64), def))) --> decoration(Decorated(Interval(-0x1.921fb54442d19p+1, 0x1.921fb54442d19p+1), trv))
    @fact atan2(Decorated(Interval(-2.0, -0.0), com), Decorated(Interval(0.0, 0.0), com)) --> Decorated(Interval(-0x1.921fb54442d19p+0, -0x1.921fb54442d18p+0), trv)
    @fact decoration(atan2(Decorated(Interval(-2.0, -0.0), com), Decorated(Interval(0.0, 0.0), com))) --> decoration(Decorated(Interval(-0x1.921fb54442d19p+0, -0x1.921fb54442d18p+0), trv))
    @fact atan2(Decorated(Interval(-2.0, -0.0), def), Decorated(Interval(-0.0, 0.0), dac)) --> Decorated(Interval(-0x1.921fb54442d19p+0, -0x1.921fb54442d18p+0), trv)
    @fact decoration(atan2(Decorated(Interval(-2.0, -0.0), def), Decorated(Interval(-0.0, 0.0), dac))) --> decoration(Decorated(Interval(-0x1.921fb54442d19p+0, -0x1.921fb54442d18p+0), trv))
    @fact atan2(Decorated(Interval(-2.0, -0.0), dac), Decorated(Interval(0.0, -0.0), def)) --> Decorated(Interval(-0x1.921fb54442d19p+0, -0x1.921fb54442d18p+0), trv)
    @fact decoration(atan2(Decorated(Interval(-2.0, -0.0), dac), Decorated(Interval(0.0, -0.0), def))) --> decoration(Decorated(Interval(-0x1.921fb54442d19p+0, -0x1.921fb54442d18p+0), trv))
    @fact atan2(Decorated(Interval(-2.0, -0.0), com), Decorated(Interval(-0.0, -0.0), trv)) --> Decorated(Interval(-0x1.921fb54442d19p+0, -0x1.921fb54442d18p+0), trv)
    @fact decoration(atan2(Decorated(Interval(-2.0, -0.0), com), Decorated(Interval(-0.0, -0.0), trv))) --> decoration(Decorated(Interval(-0x1.921fb54442d19p+0, -0x1.921fb54442d18p+0), trv))
    @fact atan2(Decorated(Interval(-2.0, -0.0), def), Decorated(Interval(-2.0, -0.1), com)) --> Decorated(Interval(-0x1.921fb54442d19p+1, 0x1.921fb54442d19p+1), def)
    @fact decoration(atan2(Decorated(Interval(-2.0, -0.0), def), Decorated(Interval(-2.0, -0.1), com))) --> decoration(Decorated(Interval(-0x1.921fb54442d19p+1, 0x1.921fb54442d19p+1), def))
    @fact atan2(Decorated(Interval(-2.0, -0.0), com), Decorated(Interval(-2.0, 0.0), dac)) --> Decorated(Interval(-0x1.921fb54442d19p+1, 0x1.921fb54442d19p+1), trv)
    @fact decoration(atan2(Decorated(Interval(-2.0, -0.0), com), Decorated(Interval(-2.0, 0.0), dac))) --> decoration(Decorated(Interval(-0x1.921fb54442d19p+1, 0x1.921fb54442d19p+1), trv))
    @fact atan2(Decorated(Interval(-2.0, -0.0), dac), Decorated(Interval(-2.0, -0.0), def)) --> Decorated(Interval(-0x1.921fb54442d19p+1, 0x1.921fb54442d19p+1), trv)
    @fact decoration(atan2(Decorated(Interval(-2.0, -0.0), dac), Decorated(Interval(-2.0, -0.0), def))) --> decoration(Decorated(Interval(-0x1.921fb54442d19p+1, 0x1.921fb54442d19p+1), trv))
    @fact atan2(Decorated(Interval(-2.0, -0.0), def), Decorated(Interval(-2.0, 1.0), trv)) --> Decorated(Interval(-0x1.921fb54442d19p+1, 0x1.921fb54442d19p+1), trv)
    @fact decoration(atan2(Decorated(Interval(-2.0, -0.0), def), Decorated(Interval(-2.0, 1.0), trv))) --> decoration(Decorated(Interval(-0x1.921fb54442d19p+1, 0x1.921fb54442d19p+1), trv))
    @fact atan2(Decorated(Interval(-2.0, -0.0), trv), Decorated(Interval(0.0, 1.0), dac)) --> Decorated(Interval(-0x1.921fb54442d19p+0, 0.0), trv)
    @fact decoration(atan2(Decorated(Interval(-2.0, -0.0), trv), Decorated(Interval(0.0, 1.0), dac))) --> decoration(Decorated(Interval(-0x1.921fb54442d19p+0, 0.0), trv))
    @fact atan2(Decorated(Interval(-2.0, -0.0), com), Decorated(Interval(-0.0, 1.0), com)) --> Decorated(Interval(-0x1.921fb54442d19p+0, 0.0), trv)
    @fact decoration(atan2(Decorated(Interval(-2.0, -0.0), com), Decorated(Interval(-0.0, 1.0), com))) --> decoration(Decorated(Interval(-0x1.921fb54442d19p+0, 0.0), trv))
    @fact atan2(Decorated(Interval(-2.0, -0.0), com), Decorated(Interval(0.1, 1.0), com)) --> Decorated(Interval(-0x1.8555a2787982p+0, 0.0), com)
    @fact decoration(atan2(Decorated(Interval(-2.0, -0.0), com), Decorated(Interval(0.1, 1.0), com))) --> decoration(Decorated(Interval(-0x1.8555a2787982p+0, 0.0), com))
    @fact atan2(Decorated(Interval(-2.0, 1.0), def), Decorated(∅, trv)) --> Decorated(∅, trv)
    @fact decoration(atan2(Decorated(Interval(-2.0, 1.0), def), Decorated(∅, trv))) --> decoration(Decorated(∅, trv))
    @fact atan2(Decorated(Interval(-2.0, 1.0), dac), Decorated(entireinterval(Float64), def)) --> Decorated(Interval(-0x1.921fb54442d19p+1, 0x1.921fb54442d19p+1), trv)
    @fact decoration(atan2(Decorated(Interval(-2.0, 1.0), dac), Decorated(entireinterval(Float64), def))) --> decoration(Decorated(Interval(-0x1.921fb54442d19p+1, 0x1.921fb54442d19p+1), trv))
    @fact atan2(Decorated(Interval(-2.0, 1.0), def), Decorated(Interval(0.0, 0.0), def)) --> Decorated(Interval(-0x1.921fb54442d19p+0, 0x1.921fb54442d19p+0), trv)
    @fact decoration(atan2(Decorated(Interval(-2.0, 1.0), def), Decorated(Interval(0.0, 0.0), def))) --> decoration(Decorated(Interval(-0x1.921fb54442d19p+0, 0x1.921fb54442d19p+0), trv))
    @fact atan2(Decorated(Interval(-2.0, 1.0), com), Decorated(Interval(-0.0, 0.0), dac)) --> Decorated(Interval(-0x1.921fb54442d19p+0, 0x1.921fb54442d19p+0), trv)
    @fact decoration(atan2(Decorated(Interval(-2.0, 1.0), com), Decorated(Interval(-0.0, 0.0), dac))) --> decoration(Decorated(Interval(-0x1.921fb54442d19p+0, 0x1.921fb54442d19p+0), trv))
    @fact atan2(Decorated(Interval(-2.0, 1.0), trv), Decorated(Interval(0.0, -0.0), trv)) --> Decorated(Interval(-0x1.921fb54442d19p+0, 0x1.921fb54442d19p+0), trv)
    @fact decoration(atan2(Decorated(Interval(-2.0, 1.0), trv), Decorated(Interval(0.0, -0.0), trv))) --> decoration(Decorated(Interval(-0x1.921fb54442d19p+0, 0x1.921fb54442d19p+0), trv))
    @fact atan2(Decorated(Interval(-2.0, 1.0), com), Decorated(Interval(-0.0, -0.0), com)) --> Decorated(Interval(-0x1.921fb54442d19p+0, 0x1.921fb54442d19p+0), trv)
    @fact decoration(atan2(Decorated(Interval(-2.0, 1.0), com), Decorated(Interval(-0.0, -0.0), com))) --> decoration(Decorated(Interval(-0x1.921fb54442d19p+0, 0x1.921fb54442d19p+0), trv))
    @fact atan2(Decorated(Interval(-2.0, 1.0), dac), Decorated(Interval(-2.0, -0.1), dac)) --> Decorated(Interval(-0x1.921fb54442d19p+1, 0x1.921fb54442d19p+1), def)
    @fact decoration(atan2(Decorated(Interval(-2.0, 1.0), dac), Decorated(Interval(-2.0, -0.1), dac))) --> decoration(Decorated(Interval(-0x1.921fb54442d19p+1, 0x1.921fb54442d19p+1), def))
    @fact atan2(Decorated(Interval(-2.0, 1.0), def), Decorated(Interval(-2.0, 0.0), def)) --> Decorated(Interval(-0x1.921fb54442d19p+1, 0x1.921fb54442d19p+1), trv)
    @fact decoration(atan2(Decorated(Interval(-2.0, 1.0), def), Decorated(Interval(-2.0, 0.0), def))) --> decoration(Decorated(Interval(-0x1.921fb54442d19p+1, 0x1.921fb54442d19p+1), trv))
    @fact atan2(Decorated(Interval(-2.0, 1.0), trv), Decorated(Interval(-2.0, -0.0), trv)) --> Decorated(Interval(-0x1.921fb54442d19p+1, 0x1.921fb54442d19p+1), trv)
    @fact decoration(atan2(Decorated(Interval(-2.0, 1.0), trv), Decorated(Interval(-2.0, -0.0), trv))) --> decoration(Decorated(Interval(-0x1.921fb54442d19p+1, 0x1.921fb54442d19p+1), trv))
    @fact atan2(Decorated(Interval(-2.0, 1.0), dac), Decorated(Interval(-2.0, 1.0), com)) --> Decorated(Interval(-0x1.921fb54442d19p+1, 0x1.921fb54442d19p+1), trv)
    @fact decoration(atan2(Decorated(Interval(-2.0, 1.0), dac), Decorated(Interval(-2.0, 1.0), com))) --> decoration(Decorated(Interval(-0x1.921fb54442d19p+1, 0x1.921fb54442d19p+1), trv))
    @fact atan2(Decorated(Interval(-2.0, 1.0), com), Decorated(Interval(0.0, 1.0), dac)) --> Decorated(Interval(-0x1.921fb54442d19p+0, 0x1.921fb54442d19p+0), trv)
    @fact decoration(atan2(Decorated(Interval(-2.0, 1.0), com), Decorated(Interval(0.0, 1.0), dac))) --> decoration(Decorated(Interval(-0x1.921fb54442d19p+0, 0x1.921fb54442d19p+0), trv))
    @fact atan2(Decorated(Interval(-2.0, 1.0), trv), Decorated(Interval(-0.0, 1.0), dac)) --> Decorated(Interval(-0x1.921fb54442d19p+0, 0x1.921fb54442d19p+0), trv)
    @fact decoration(atan2(Decorated(Interval(-2.0, 1.0), trv), Decorated(Interval(-0.0, 1.0), dac))) --> decoration(Decorated(Interval(-0x1.921fb54442d19p+0, 0x1.921fb54442d19p+0), trv))
    @fact atan2(Decorated(Interval(-2.0, 1.0), com), Decorated(Interval(0.1, 1.0), com)) --> Decorated(Interval(-0x1.8555a2787982p+0, 0x1.789bd2c160054p+0), com)
    @fact decoration(atan2(Decorated(Interval(-2.0, 1.0), com), Decorated(Interval(0.1, 1.0), com))) --> decoration(Decorated(Interval(-0x1.8555a2787982p+0, 0x1.789bd2c160054p+0), com))
    @fact atan2(Decorated(Interval(-0.0, 1.0), com), Decorated(∅, trv)) --> Decorated(∅, trv)
    @fact decoration(atan2(Decorated(Interval(-0.0, 1.0), com), Decorated(∅, trv))) --> decoration(Decorated(∅, trv))
    @fact atan2(Decorated(Interval(-0.0, 1.0), dac), Decorated(entireinterval(Float64), def)) --> Decorated(Interval(0.0, 0x1.921fb54442d19p+1), trv)
    @fact decoration(atan2(Decorated(Interval(-0.0, 1.0), dac), Decorated(entireinterval(Float64), def))) --> decoration(Decorated(Interval(0.0, 0x1.921fb54442d19p+1), trv))
    @fact atan2(Decorated(Interval(-0.0, 1.0), def), Decorated(Interval(0.0, 0.0), def)) --> Decorated(Interval(0x1.921fb54442d18p+0, 0x1.921fb54442d19p+0), trv)
    @fact decoration(atan2(Decorated(Interval(-0.0, 1.0), def), Decorated(Interval(0.0, 0.0), def))) --> decoration(Decorated(Interval(0x1.921fb54442d18p+0, 0x1.921fb54442d19p+0), trv))
    @fact atan2(Decorated(Interval(-0.0, 1.0), trv), Decorated(Interval(-0.0, 0.0), trv)) --> Decorated(Interval(0x1.921fb54442d18p+0, 0x1.921fb54442d19p+0), trv)
    @fact decoration(atan2(Decorated(Interval(-0.0, 1.0), trv), Decorated(Interval(-0.0, 0.0), trv))) --> decoration(Decorated(Interval(0x1.921fb54442d18p+0, 0x1.921fb54442d19p+0), trv))
    @fact atan2(Decorated(Interval(-0.0, 1.0), dac), Decorated(Interval(0.0, -0.0), dac)) --> Decorated(Interval(0x1.921fb54442d18p+0, 0x1.921fb54442d19p+0), trv)
    @fact decoration(atan2(Decorated(Interval(-0.0, 1.0), dac), Decorated(Interval(0.0, -0.0), dac))) --> decoration(Decorated(Interval(0x1.921fb54442d18p+0, 0x1.921fb54442d19p+0), trv))
    @fact atan2(Decorated(Interval(-0.0, 1.0), com), Decorated(Interval(-0.0, -0.0), def)) --> Decorated(Interval(0x1.921fb54442d18p+0, 0x1.921fb54442d19p+0), trv)
    @fact decoration(atan2(Decorated(Interval(-0.0, 1.0), com), Decorated(Interval(-0.0, -0.0), def))) --> decoration(Decorated(Interval(0x1.921fb54442d18p+0, 0x1.921fb54442d19p+0), trv))
    @fact atan2(Decorated(Interval(-0.0, 1.0), com), Decorated(Interval(-2.0, -0.1), com)) --> Decorated(Interval(0x1.aba397c7259ddp+0, 0x1.921fb54442d19p+1), dac)
    @fact decoration(atan2(Decorated(Interval(-0.0, 1.0), com), Decorated(Interval(-2.0, -0.1), com))) --> decoration(Decorated(Interval(0x1.aba397c7259ddp+0, 0x1.921fb54442d19p+1), dac))
    @fact atan2(Decorated(Interval(-0.0, 1.0), def), Decorated(Interval(-2.0, 0.0), com)) --> Decorated(Interval(0x1.921fb54442d18p+0, 0x1.921fb54442d19p+1), trv)
    @fact decoration(atan2(Decorated(Interval(-0.0, 1.0), def), Decorated(Interval(-2.0, 0.0), com))) --> decoration(Decorated(Interval(0x1.921fb54442d18p+0, 0x1.921fb54442d19p+1), trv))
    @fact atan2(Decorated(Interval(-0.0, 1.0), def), Decorated(Interval(-2.0, -0.0), def)) --> Decorated(Interval(0x1.921fb54442d18p+0, 0x1.921fb54442d19p+1), trv)
    @fact decoration(atan2(Decorated(Interval(-0.0, 1.0), def), Decorated(Interval(-2.0, -0.0), def))) --> decoration(Decorated(Interval(0x1.921fb54442d18p+0, 0x1.921fb54442d19p+1), trv))
    @fact atan2(Decorated(Interval(-0.0, 1.0), dac), Decorated(Interval(-2.0, 1.0), dac)) --> Decorated(Interval(0.0, 0x1.921fb54442d19p+1), trv)
    @fact decoration(atan2(Decorated(Interval(-0.0, 1.0), dac), Decorated(Interval(-2.0, 1.0), dac))) --> decoration(Decorated(Interval(0.0, 0x1.921fb54442d19p+1), trv))
    @fact atan2(Decorated(Interval(-0.0, 1.0), dac), Decorated(Interval(0.0, 1.0), dac)) --> Decorated(Interval(0.0, 0x1.921fb54442d19p+0), trv)
    @fact decoration(atan2(Decorated(Interval(-0.0, 1.0), dac), Decorated(Interval(0.0, 1.0), dac))) --> decoration(Decorated(Interval(0.0, 0x1.921fb54442d19p+0), trv))
    @fact atan2(Decorated(Interval(-0.0, 1.0), trv), Decorated(Interval(-0.0, 1.0), com)) --> Decorated(Interval(0.0, 0x1.921fb54442d19p+0), trv)
    @fact decoration(atan2(Decorated(Interval(-0.0, 1.0), trv), Decorated(Interval(-0.0, 1.0), com))) --> decoration(Decorated(Interval(0.0, 0x1.921fb54442d19p+0), trv))
    @fact atan2(Decorated(Interval(-0.0, 1.0), trv), Decorated(Interval(0.1, 1.0), com)) --> Decorated(Interval(0.0, 0x1.789bd2c160054p+0), trv)
    @fact decoration(atan2(Decorated(Interval(-0.0, 1.0), trv), Decorated(Interval(0.1, 1.0), com))) --> decoration(Decorated(Interval(0.0, 0x1.789bd2c160054p+0), trv))
    @fact atan2(Decorated(Interval(0.0, 1.0), def), Decorated(∅, trv)) --> Decorated(∅, trv)
    @fact decoration(atan2(Decorated(Interval(0.0, 1.0), def), Decorated(∅, trv))) --> decoration(Decorated(∅, trv))
    @fact atan2(Decorated(Interval(0.0, 1.0), dac), Decorated(entireinterval(Float64), def)) --> Decorated(Interval(0.0, 0x1.921fb54442d19p+1), trv)
    @fact decoration(atan2(Decorated(Interval(0.0, 1.0), dac), Decorated(entireinterval(Float64), def))) --> decoration(Decorated(Interval(0.0, 0x1.921fb54442d19p+1), trv))
    @fact atan2(Decorated(Interval(0.0, 1.0), dac), Decorated(Interval(0.0, 0.0), def)) --> Decorated(Interval(0x1.921fb54442d18p+0, 0x1.921fb54442d19p+0), trv)
    @fact decoration(atan2(Decorated(Interval(0.0, 1.0), dac), Decorated(Interval(0.0, 0.0), def))) --> decoration(Decorated(Interval(0x1.921fb54442d18p+0, 0x1.921fb54442d19p+0), trv))
    @fact atan2(Decorated(Interval(0.0, 1.0), trv), Decorated(Interval(-0.0, 0.0), trv)) --> Decorated(Interval(0x1.921fb54442d18p+0, 0x1.921fb54442d19p+0), trv)
    @fact decoration(atan2(Decorated(Interval(0.0, 1.0), trv), Decorated(Interval(-0.0, 0.0), trv))) --> decoration(Decorated(Interval(0x1.921fb54442d18p+0, 0x1.921fb54442d19p+0), trv))
    @fact atan2(Decorated(Interval(0.0, 1.0), trv), Decorated(Interval(0.0, -0.0), dac)) --> Decorated(Interval(0x1.921fb54442d18p+0, 0x1.921fb54442d19p+0), trv)
    @fact decoration(atan2(Decorated(Interval(0.0, 1.0), trv), Decorated(Interval(0.0, -0.0), dac))) --> decoration(Decorated(Interval(0x1.921fb54442d18p+0, 0x1.921fb54442d19p+0), trv))
    @fact atan2(Decorated(Interval(0.0, 1.0), def), Decorated(Interval(-0.0, -0.0), com)) --> Decorated(Interval(0x1.921fb54442d18p+0, 0x1.921fb54442d19p+0), trv)
    @fact decoration(atan2(Decorated(Interval(0.0, 1.0), def), Decorated(Interval(-0.0, -0.0), com))) --> decoration(Decorated(Interval(0x1.921fb54442d18p+0, 0x1.921fb54442d19p+0), trv))
    @fact atan2(Decorated(Interval(0.0, 1.0), dac), Decorated(Interval(-2.0, -0.1), dac)) --> Decorated(Interval(0x1.aba397c7259ddp+0, 0x1.921fb54442d19p+1), dac)
    @fact decoration(atan2(Decorated(Interval(0.0, 1.0), dac), Decorated(Interval(-2.0, -0.1), dac))) --> decoration(Decorated(Interval(0x1.aba397c7259ddp+0, 0x1.921fb54442d19p+1), dac))
    @fact atan2(Decorated(Interval(0.0, 1.0), def), Decorated(Interval(-2.0, 0.0), trv)) --> Decorated(Interval(0x1.921fb54442d18p+0, 0x1.921fb54442d19p+1), trv)
    @fact decoration(atan2(Decorated(Interval(0.0, 1.0), def), Decorated(Interval(-2.0, 0.0), trv))) --> decoration(Decorated(Interval(0x1.921fb54442d18p+0, 0x1.921fb54442d19p+1), trv))
    @fact atan2(Decorated(Interval(0.0, 1.0), dac), Decorated(Interval(-2.0, -0.0), dac)) --> Decorated(Interval(0x1.921fb54442d18p+0, 0x1.921fb54442d19p+1), trv)
    @fact decoration(atan2(Decorated(Interval(0.0, 1.0), dac), Decorated(Interval(-2.0, -0.0), dac))) --> decoration(Decorated(Interval(0x1.921fb54442d18p+0, 0x1.921fb54442d19p+1), trv))
    @fact atan2(Decorated(Interval(0.0, 1.0), dac), Decorated(Interval(-2.0, 1.0), def)) --> Decorated(Interval(0.0, 0x1.921fb54442d19p+1), trv)
    @fact decoration(atan2(Decorated(Interval(0.0, 1.0), dac), Decorated(Interval(-2.0, 1.0), def))) --> decoration(Decorated(Interval(0.0, 0x1.921fb54442d19p+1), trv))
    @fact atan2(Decorated(Interval(0.0, 1.0), dac), Decorated(Interval(0.0, 1.0), trv)) --> Decorated(Interval(0.0, 0x1.921fb54442d19p+0), trv)
    @fact decoration(atan2(Decorated(Interval(0.0, 1.0), dac), Decorated(Interval(0.0, 1.0), trv))) --> decoration(Decorated(Interval(0.0, 0x1.921fb54442d19p+0), trv))
    @fact atan2(Decorated(Interval(0.0, 1.0), dac), Decorated(Interval(-0.0, 1.0), def)) --> Decorated(Interval(0.0, 0x1.921fb54442d19p+0), trv)
    @fact decoration(atan2(Decorated(Interval(0.0, 1.0), dac), Decorated(Interval(-0.0, 1.0), def))) --> decoration(Decorated(Interval(0.0, 0x1.921fb54442d19p+0), trv))
    @fact atan2(Decorated(Interval(0.0, 1.0), com), Decorated(Interval(0.1, 1.0), com)) --> Decorated(Interval(0.0, 0x1.789bd2c160054p+0), com)
    @fact decoration(atan2(Decorated(Interval(0.0, 1.0), com), Decorated(Interval(0.1, 1.0), com))) --> decoration(Decorated(Interval(0.0, 0x1.789bd2c160054p+0), com))
    @fact atan2(Decorated(Interval(0.1, 1.0), dac), Decorated(∅, trv)) --> Decorated(∅, trv)
    @fact decoration(atan2(Decorated(Interval(0.1, 1.0), dac), Decorated(∅, trv))) --> decoration(Decorated(∅, trv))
    @fact atan2(Decorated(Interval(0.1, 1.0), dac), Decorated(entireinterval(Float64), def)) --> Decorated(Interval(0.0, 0x1.921fb54442d19p+1), def)
    @fact decoration(atan2(Decorated(Interval(0.1, 1.0), dac), Decorated(entireinterval(Float64), def))) --> decoration(Decorated(Interval(0.0, 0x1.921fb54442d19p+1), def))
    @fact atan2(Decorated(Interval(0.1, 1.0), def), Decorated(Interval(0.0, 0.0), com)) --> Decorated(Interval(0x1.921fb54442d18p+0, 0x1.921fb54442d19p+0), def)
    @fact decoration(atan2(Decorated(Interval(0.1, 1.0), def), Decorated(Interval(0.0, 0.0), com))) --> decoration(Decorated(Interval(0x1.921fb54442d18p+0, 0x1.921fb54442d19p+0), def))
    @fact atan2(Decorated(Interval(0.1, 1.0), trv), Decorated(Interval(-0.0, 0.0), def)) --> Decorated(Interval(0x1.921fb54442d18p+0, 0x1.921fb54442d19p+0), trv)
    @fact decoration(atan2(Decorated(Interval(0.1, 1.0), trv), Decorated(Interval(-0.0, 0.0), def))) --> decoration(Decorated(Interval(0x1.921fb54442d18p+0, 0x1.921fb54442d19p+0), trv))
    @fact atan2(Decorated(Interval(0.1, 1.0), trv), Decorated(Interval(0.0, -0.0), def)) --> Decorated(Interval(0x1.921fb54442d18p+0, 0x1.921fb54442d19p+0), trv)
    @fact decoration(atan2(Decorated(Interval(0.1, 1.0), trv), Decorated(Interval(0.0, -0.0), def))) --> decoration(Decorated(Interval(0x1.921fb54442d18p+0, 0x1.921fb54442d19p+0), trv))
    @fact atan2(Decorated(Interval(0.1, 1.0), dac), Decorated(Interval(-0.0, -0.0), def)) --> Decorated(Interval(0x1.921fb54442d18p+0, 0x1.921fb54442d19p+0), def)
    @fact decoration(atan2(Decorated(Interval(0.1, 1.0), dac), Decorated(Interval(-0.0, -0.0), def))) --> decoration(Decorated(Interval(0x1.921fb54442d18p+0, 0x1.921fb54442d19p+0), def))
    @fact atan2(Decorated(Interval(0.1, 1.0), com), Decorated(Interval(-2.0, -0.1), trv)) --> Decorated(Interval(0x1.aba397c7259ddp+0, 0x1.8bbaabde5e29cp+1), trv)
    @fact decoration(atan2(Decorated(Interval(0.1, 1.0), com), Decorated(Interval(-2.0, -0.1), trv))) --> decoration(Decorated(Interval(0x1.aba397c7259ddp+0, 0x1.8bbaabde5e29cp+1), trv))
    @fact atan2(Decorated(Interval(0.1, 1.0), com), Decorated(Interval(-2.0, 0.0), dac)) --> Decorated(Interval(0x1.921fb54442d18p+0, 0x1.8bbaabde5e29cp+1), dac)
    @fact decoration(atan2(Decorated(Interval(0.1, 1.0), com), Decorated(Interval(-2.0, 0.0), dac))) --> decoration(Decorated(Interval(0x1.921fb54442d18p+0, 0x1.8bbaabde5e29cp+1), dac))
    @fact atan2(Decorated(Interval(0.1, 1.0), com), Decorated(Interval(-2.0, -0.0), dac)) --> Decorated(Interval(0x1.921fb54442d18p+0, 0x1.8bbaabde5e29cp+1), dac)
    @fact decoration(atan2(Decorated(Interval(0.1, 1.0), com), Decorated(Interval(-2.0, -0.0), dac))) --> decoration(Decorated(Interval(0x1.921fb54442d18p+0, 0x1.8bbaabde5e29cp+1), dac))
    @fact atan2(Decorated(Interval(0.1, 1.0), def), Decorated(Interval(-2.0, 1.0), dac)) --> Decorated(Interval(0x1.983e282e2cc4cp-4, 0x1.8bbaabde5e29cp+1), def)
    @fact decoration(atan2(Decorated(Interval(0.1, 1.0), def), Decorated(Interval(-2.0, 1.0), dac))) --> decoration(Decorated(Interval(0x1.983e282e2cc4cp-4, 0x1.8bbaabde5e29cp+1), def))
    @fact atan2(Decorated(Interval(0.1, 1.0), def), Decorated(Interval(0.0, 1.0), def)) --> Decorated(Interval(0x1.983e282e2cc4cp-4, 0x1.921fb54442d19p+0), def)
    @fact decoration(atan2(Decorated(Interval(0.1, 1.0), def), Decorated(Interval(0.0, 1.0), def))) --> decoration(Decorated(Interval(0x1.983e282e2cc4cp-4, 0x1.921fb54442d19p+0), def))
    @fact atan2(Decorated(Interval(0.1, 1.0), dac), Decorated(Interval(-0.0, 1.0), def)) --> Decorated(Interval(0x1.983e282e2cc4cp-4, 0x1.921fb54442d19p+0), def)
    @fact decoration(atan2(Decorated(Interval(0.1, 1.0), dac), Decorated(Interval(-0.0, 1.0), def))) --> decoration(Decorated(Interval(0x1.983e282e2cc4cp-4, 0x1.921fb54442d19p+0), def))
    @fact atan2(Decorated(Interval(0.1, 1.0), dac), Decorated(Interval(0.1, 1.0), def)) --> Decorated(Interval(0x1.983e282e2cc4cp-4, 0x1.789bd2c160054p+0), def)
    @fact decoration(atan2(Decorated(Interval(0.1, 1.0), dac), Decorated(Interval(0.1, 1.0), def))) --> decoration(Decorated(Interval(0x1.983e282e2cc4cp-4, 0x1.789bd2c160054p+0), def))
end
...
facts("minimal_sinh_dec_test") do
    ...
    @fact sinh(Decorated(Interval(0.0, Inf), dac)) --> Decorated(Interval(0.0, Inf), dac)
    @fact decoration(sinh(Decorated(Interval(0.0, Inf), dac))) --> decoration(Decorated(Interval(0.0, Inf), dac))
    @fact sinh(Decorated(Interval(-Inf, 0.0), def)) --> Decorated(Interval(-Inf, 0.0), def)
    @fact decoration(sinh(Decorated(Interval(-Inf, 0.0), def))) --> decoration(Decorated(Interval(-Inf, 0.0), def))
    @fact sinh(Decorated(Interval(1.0, 0x1.2c903022dd7aap+8), com)) --> Decorated(Interval(0x1.2cd9fc44eb982p+0, 0x1.89bca168970c6p+432), com)
    @fact decoration(sinh(Decorated(Interval(1.0, 0x1.2c903022dd7aap+8), com))) --> decoration(Decorated(Interval(0x1.2cd9fc44eb982p+0, 0x1.89bca168970c6p+432), com))
    @fact sinh(Decorated(Interval(-0x1.fd219490eaac1p+38, -0x1.1af1c9d74f06dp+9), com)) --> Decorated(Interval(-Inf, -0x1.53045b4f849dep+815), dac)
    @fact decoration(sinh(Decorated(Interval(-0x1.fd219490eaac1p+38, -0x1.1af1c9d74f06dp+9), com))) --> decoration(Decorated(Interval(-Inf, -0x1.53045b4f849dep+815), dac))
end
...
facts("minimal_cosh_dec_test") do
    @fact cosh(Decorated(Interval(0.0, Inf), dac)) --> Decorated(Interval(1.0, Inf), dac)
    @fact decoration(cosh(Decorated(Interval(0.0, Inf), dac))) --> decoration(Decorated(Interval(1.0, Inf), dac))
    @fact cosh(Decorated(Interval(-Inf, 0.0), def)) --> Decorated(Interval(1.0, Inf), def)
    @fact decoration(cosh(Decorated(Interval(-Inf, 0.0), def))) --> decoration(Decorated(Interval(1.0, Inf), def))
    @fact cosh(Decorated(entireinterval(Float64), def)) --> Decorated(Interval(1.0, Inf), def)
    @fact decoration(cosh(Decorated(entireinterval(Float64), def))) --> decoration(Decorated(Interval(1.0, Inf), def))
    @fact cosh(Decorated(Interval(1.0, 0x1.2c903022dd7aap+8), def)) --> Decorated(Interval(0x1.8b07551d9f55p+0, 0x1.89bca168970c6p+432), def)
    @fact decoration(cosh(Decorated(Interval(1.0, 0x1.2c903022dd7aap+8), def))) --> decoration(Decorated(Interval(0x1.8b07551d9f55p+0, 0x1.89bca168970c6p+432), def))
    @fact cosh(Decorated(Interval(-0x1.fd219490eaac1p+38, -0x1.1af1c9d74f06dp+9), com)) --> Decorated(Interval(0x1.53045b4f849dep+815, Inf), dac)
    @fact decoration(cosh(Decorated(Interval(-0x1.fd219490eaac1p+38, -0x1.1af1c9d74f06dp+9), com))) --> decoration(Decorated(Interval(0x1.53045b4f849dep+815, Inf), dac))
end
...
facts("minimal_tanh_dec_test") do
    @fact tanh(Decorated(Interval(0.0, Inf), dac)) --> Decorated(Interval(0.0, 1.0), dac)
    @fact decoration(tanh(Decorated(Interval(0.0, Inf), dac))) --> decoration(Decorated(Interval(0.0, 1.0), dac))
    @fact tanh(Decorated(Interval(-Inf, 0.0), def)) --> Decorated(Interval(-1.0, 0.0), def)
    @fact decoration(tanh(Decorated(Interval(-Inf, 0.0), def))) --> decoration(Decorated(Interval(-1.0, 0.0), def))
    @fact tanh(Decorated(entireinterval(Float64), def)) --> Decorated(Interval(-1.0, 1.0), def)
    @fact decoration(tanh(Decorated(entireinterval(Float64), def))) --> decoration(Decorated(Interval(-1.0, 1.0), def))
    @fact tanh(Decorated(Interval(1.0, 0x1.2c903022dd7aap+8), com)) --> Decorated(Interval(0x1.85efab514f394p-1, 0x1p+0), com)
    @fact decoration(tanh(Decorated(Interval(1.0, 0x1.2c903022dd7aap+8), com))) --> decoration(Decorated(Interval(0x1.85efab514f394p-1, 0x1p+0), com))
    @fact tanh(Decorated(Interval(-0x1.fd219490eaac1p+38, -0x1.1af1c9d74f06dp+9), trv)) --> Decorated(Interval(-0x1p+0, -0x1.fffffffffffffp-1), trv)
    @fact decoration(tanh(Decorated(Interval(-0x1.fd219490eaac1p+38, -0x1.1af1c9d74f06dp+9), trv))) --> decoration(Decorated(Interval(-0x1p+0, -0x1.fffffffffffffp-1), trv))
end
...
facts("minimal_asinh_dec_test") do
    @fact asinh(Decorated(Interval(0.0, Inf), dac)) --> Decorated(Interval(0.0, Inf), dac)
    @fact decoration(asinh(Decorated(Interval(0.0, Inf), dac))) --> decoration(Decorated(Interval(0.0, Inf), dac))
    @fact asinh(Decorated(Interval(-Inf, 0.0), trv)) --> Decorated(Interval(-Inf, 0.0), trv)
    @fact decoration(asinh(Decorated(Interval(-Inf, 0.0), trv))) --> decoration(Decorated(Interval(-Inf, 0.0), trv))
    ...
    @fact asinh(Decorated(Interval(1.0, 0x1.2c903022dd7aap+8), com)) --> Decorated(Interval(0x1.c34366179d426p-1, 0x1.9986127438a87p+2), com)
    @fact decoration(asinh(Decorated(Interval(1.0, 0x1.2c903022dd7aap+8), com))) --> decoration(Decorated(Interval(0x1.c34366179d426p-1, 0x1.9986127438a87p+2), com))
    @fact asinh(Decorated(Interval(-0x1.fd219490eaac1p+38, -0x1.1af1c9d74f06dp+9), def)) --> Decorated(Interval(-0x1.bb86380a6cc45p+4, -0x1.c204d8eb20827p+2), def)
    @fact decoration(asinh(Decorated(Interval(-0x1.fd219490eaac1p+38, -0x1.1af1c9d74f06dp+9), def))) --> decoration(Decorated(Interval(-0x1.bb86380a6cc45p+4, -0x1.c204d8eb20827p+2), def))
end
...
facts("minimal_acosh_dec_test") do
    @fact acosh(Decorated(Interval(0.0, Inf), dac)) --> Decorated(Interval(0.0, Inf), trv)
    @fact decoration(acosh(Decorated(Interval(0.0, Inf), dac))) --> decoration(Decorated(Interval(0.0, Inf), trv))
    @fact acosh(Decorated(Interval(1.0, Inf), dac)) --> Decorated(Interval(0.0, Inf), dac)
    @fact decoration(acosh(Decorated(Interval(1.0, Inf), dac))) --> decoration(Decorated(Interval(0.0, Inf), dac))
    @fact acosh(Decorated(entireinterval(Float64), def)) --> Decorated(Interval(0.0, Inf), trv)
    @fact decoration(acosh(Decorated(entireinterval(Float64), def))) --> decoration(Decorated(Interval(0.0, Inf), trv))
    @fact acosh(Decorated(Interval(1.0, 1.0), com)) --> Decorated(Interval(0.0, 0.0), com)
    @fact decoration(acosh(Decorated(Interval(1.0, 1.0), com))) --> decoration(Decorated(Interval(0.0, 0.0), com))
    @fact acosh(Decorated(Interval(0.9, 1.0), com)) --> Decorated(Interval(0.0, 0.0), trv)
    @fact decoration(acosh(Decorated(Interval(0.9, 1.0), com))) --> decoration(Decorated(Interval(0.0, 0.0), trv))
    @fact acosh(Decorated(Interval(1.0, 0x1.2c903022dd7aap+8), dac)) --> Decorated(Interval(0.0, 0x1.9985fb3d532afp+2), dac)
    @fact decoration(acosh(Decorated(Interval(1.0, 0x1.2c903022dd7aap+8), dac))) --> decoration(Decorated(Interval(0.0, 0x1.9985fb3d532afp+2), dac))
    @fact acosh(Decorated(Interval(0.9, 0x1.2c903022dd7aap+8), com)) --> Decorated(Interval(0.0, 0x1.9985fb3d532afp+2), trv)
    @fact decoration(acosh(Decorated(Interval(0.9, 0x1.2c903022dd7aap+8), com))) --> decoration(Decorated(Interval(0.0, 0x1.9985fb3d532afp+2), trv))
    @fact acosh(Decorated(Interval(0x1.14d4e82b2b26fp+15, 0x1.72dbe91c837b5p+29), def)) --> Decorated(Interval(0x1.656510b4baec3p+3, 0x1.52a415ee8455ap+4), def)
    @fact decoration(acosh(Decorated(Interval(0x1.14d4e82b2b26fp+15, 0x1.72dbe91c837b5p+29), def))) --> decoration(Decorated(Interval(0x1.656510b4baec3p+3, 0x1.52a415ee8455ap+4), def))
end
...
facts("minimal_atanh_dec_test") do
    @fact atanh(Decorated(Interval(0.0, Inf), dac)) --> Decorated(Interval(0.0, Inf), trv)
    @fact decoration(atanh(Decorated(Interval(0.0, Inf), dac))) --> decoration(Decorated(Interval(0.0, Inf), trv))
    @fact atanh(Decorated(Interval(-Inf, 0.0), def)) --> Decorated(Interval(-Inf, 0.0), trv)
    @fact decoration(atanh(Decorated(Interval(-Inf, 0.0), def))) --> decoration(Decorated(Interval(-Inf, 0.0), trv))
    @fact atanh(Decorated(Interval(-1.0, 1.0), com)) --> Decorated(entireinterval(Float64), trv)
    @fact decoration(atanh(Decorated(Interval(-1.0, 1.0), com))) --> decoration(Decorated(entireinterval(Float64), trv))
    @fact atanh(Decorated(Interval(0.0, 0.0), com)) --> Decorated(Interval(0.0, 0.0), com)
    @fact decoration(atanh(Decorated(Interval(0.0, 0.0), com))) --> decoration(Decorated(Interval(0.0, 0.0), com))
    @fact atanh(Decorated(Interval(1.0, 1.0), def)) --> Decorated(∅, trv)
    @fact decoration(atanh(Decorated(Interval(1.0, 1.0), def))) --> decoration(Decorated(∅, trv))
    @fact atanh(Decorated(Interval(0x1.4c0420f6f08ccp-2, 0x1.fffffffffffffp-1), com)) --> Decorated(Interval(0x1.5871dd2df9102p-2, 0x1.2b708872320e2p+4), com)
    @fact decoration(atanh(Decorated(Interval(0x1.4c0420f6f08ccp-2, 0x1.fffffffffffffp-1), com))) --> decoration(Decorated(Interval(0x1.5871dd2df9102p-2, 0x1.2b708872320e2p+4), com))
    @fact atanh(Decorated(Interval(-1.0, 0x1.fffffffffffffp-1), com)) --> Decorated(Interval(-Inf, 0x1.2b708872320e2p+4), trv)
    @fact decoration(atanh(Decorated(Interval(-1.0, 0x1.fffffffffffffp-1), com))) --> decoration(Decorated(Interval(-Inf, 0x1.2b708872320e2p+4), trv))
    @fact atanh(Decorated(Interval(-0x1.ffb88e9eb6307p-1, 0x1.999999999999ap-4), def)) --> Decorated(Interval(-0x1.06a3a97d7979cp+2, 0x1.9af93cd234413p-4), def)
    @fact decoration(atanh(Decorated(Interval(-0x1.ffb88e9eb6307p-1, 0x1.999999999999ap-4), def))) --> decoration(Decorated(Interval(-0x1.06a3a97d7979cp+2, 0x1.9af93cd234413p-4), def))
    @fact atanh(Decorated(Interval(-0x1.ffb88e9eb6307p-1, 1.0), com)) --> Decorated(Interval(-0x1.06a3a97d7979cp+2, Inf), trv)
    @fact decoration(atanh(Decorated(Interval(-0x1.ffb88e9eb6307p-1, 1.0), com))) --> decoration(Decorated(Interval(-0x1.06a3a97d7979cp+2, Inf), trv))
end
...
facts("minimal_sign_dec_test") do
    @fact sign(Decorated(Interval(1.0, 2.0), com)) --> Decorated(Interval(1.0, 1.0), com)
    @fact decoration(sign(Decorated(Interval(1.0, 2.0), com))) --> decoration(Decorated(Interval(1.0, 1.0), com))
    @fact sign(Decorated(Interval(-1.0, 2.0), com)) --> Decorated(Interval(-1.0, 1.0), def)
    @fact decoration(sign(Decorated(Interval(-1.0, 2.0), com))) --> decoration(Decorated(Interval(-1.0, 1.0), def))
    @fact sign(Decorated(Interval(-1.0, 0.0), com)) --> Decorated(Interval(-1.0, 0.0), def)
    @fact decoration(sign(Decorated(Interval(-1.0, 0.0), com))) --> decoration(Decorated(Interval(-1.0, 0.0), def))
    @fact sign(Decorated(Interval(0.0, 2.0), com)) --> Decorated(Interval(0.0, 1.0), def)
    @fact decoration(sign(Decorated(Interval(0.0, 2.0), com))) --> decoration(Decorated(Interval(0.0, 1.0), def))
    @fact sign(Decorated(Interval(-0.0, 2.0), def)) --> Decorated(Interval(0.0, 1.0), def)
    @fact decoration(sign(Decorated(Interval(-0.0, 2.0), def))) --> decoration(Decorated(Interval(0.0, 1.0), def))
    @fact sign(Decorated(Interval(-5.0, -2.0), trv)) --> Decorated(Interval(-1.0, -1.0), trv)
    @fact decoration(sign(Decorated(Interval(-5.0, -2.0), trv))) --> decoration(Decorated(Interval(-1.0, -1.0), trv))
    @fact sign(Decorated(Interval(0.0, 0.0), dac)) --> Decorated(Interval(0.0, 0.0), dac)
    @fact decoration(sign(Decorated(Interval(0.0, 0.0), dac))) --> decoration(Decorated(Interval(0.0, 0.0), dac))
end
...
facts("minimal_ceil_dec_test") do
    @fact ceil(Decorated(Interval(1.1, 2.0), com)) --> Decorated(Interval(2.0, 2.0), dac)
    @fact decoration(ceil(Decorated(Interval(1.1, 2.0), com))) --> decoration(Decorated(Interval(2.0, 2.0), dac))
    @fact round(Decorated(Interval(1.1, 2.0), com), RoundUp) --> Decorated(Interval(2.0, 2.0), dac)
    @fact decoration(round(Decorated(Interval(1.1, 2.0), com), RoundUp)) --> decoration(Decorated(Interval(2.0, 2.0), dac))
    @fact ceil(Decorated(Interval(-1.1, 2.0), com)) --> Decorated(Interval(-1.0, 2.0), def)
    @fact decoration(ceil(Decorated(Interval(-1.1, 2.0), com))) --> decoration(Decorated(Interval(-1.0, 2.0), def))
    @fact round(Decorated(Interval(-1.1, 2.0), com), RoundUp) --> Decorated(Interval(-1.0, 2.0), def)
    @fact decoration(round(Decorated(Interval(-1.1, 2.0), com), RoundUp)) --> decoration(Decorated(Interval(-1.0, 2.0), def))
    @fact ceil(Decorated(Interval(-1.1, 0.0), dac)) --> Decorated(Interval(-1.0, 0.0), def)
    @fact decoration(ceil(Decorated(Interval(-1.1, 0.0), dac))) --> decoration(Decorated(Interval(-1.0, 0.0), def))
    @fact round(Decorated(Interval(-1.1, 0.0), dac), RoundUp) --> Decorated(Interval(-1.0, 0.0), def)
    @fact decoration(round(Decorated(Interval(-1.1, 0.0), dac), RoundUp)) --> decoration(Decorated(Interval(-1.0, 0.0), def))
    @fact ceil(Decorated(Interval(-1.1, -0.0), trv)) --> Decorated(Interval(-1.0, 0.0), trv)
    @fact decoration(ceil(Decorated(Interval(-1.1, -0.0), trv))) --> decoration(Decorated(Interval(-1.0, 0.0), trv))
    @fact round(Decorated(Interval(-1.1, -0.0), trv), RoundUp) --> Decorated(Interval(-1.0, 0.0), trv)
    @fact decoration(round(Decorated(Interval(-1.1, -0.0), trv), RoundUp)) --> decoration(Decorated(Interval(-1.0, 0.0), trv))
    @fact ceil(Decorated(Interval(-1.1, -0.4), dac)) --> Decorated(Interval(-1.0, 0.0), def)
    @fact decoration(ceil(Decorated(Interval(-1.1, -0.4), dac))) --> decoration(Decorated(Interval(-1.0, 0.0), def))
    @fact round(Decorated(Interval(-1.1, -0.4), dac), RoundUp) --> Decorated(Interval(-1.0, 0.0), def)
    @fact decoration(round(Decorated(Interval(-1.1, -0.4), dac), RoundUp)) --> decoration(Decorated(Interval(-1.0, 0.0), def))
    @fact ceil(Decorated(Interval(-1.9, 2.2), com)) --> Decorated(Interval(-1.0, 3.0), def)
    @fact decoration(ceil(Decorated(Interval(-1.9, 2.2), com))) --> decoration(Decorated(Interval(-1.0, 3.0), def))
    @fact round(Decorated(Interval(-1.9, 2.2), com), RoundUp) --> Decorated(Interval(-1.0, 3.0), def)
    @fact decoration(round(Decorated(Interval(-1.9, 2.2), com), RoundUp)) --> decoration(Decorated(Interval(-1.0, 3.0), def))
    @fact ceil(Decorated(Interval(-1.0, 2.2), dac)) --> Decorated(Interval(-1.0, 3.0), def)
    @fact decoration(ceil(Decorated(Interval(-1.0, 2.2), dac))) --> decoration(Decorated(Interval(-1.0, 3.0), def))
    @fact round(Decorated(Interval(-1.0, 2.2), dac), RoundUp) --> Decorated(Interval(-1.0, 3.0), def)
    @fact decoration(round(Decorated(Interval(-1.0, 2.2), dac), RoundUp)) --> decoration(Decorated(Interval(-1.0, 3.0), def))
    @fact ceil(Decorated(Interval(0.0, 2.2), trv)) --> Decorated(Interval(0.0, 3.0), trv)
    @fact decoration(ceil(Decorated(Interval(0.0, 2.2), trv))) --> decoration(Decorated(Interval(0.0, 3.0), trv))
    @fact round(Decorated(Interval(0.0, 2.2), trv), RoundUp) --> Decorated(Interval(0.0, 3.0), trv)
    @fact decoration(round(Decorated(Interval(0.0, 2.2), trv), RoundUp)) --> decoration(Decorated(Interval(0.0, 3.0), trv))
    @fact ceil(Decorated(Interval(-0.0, 2.2), def)) --> Decorated(Interval(0.0, 3.0), def)
    @fact decoration(ceil(Decorated(Interval(-0.0, 2.2), def))) --> decoration(Decorated(Interval(0.0, 3.0), def))
    @fact round(Decorated(Interval(-0.0, 2.2), def), RoundUp) --> Decorated(Interval(0.0, 3.0), def)
    @fact decoration(round(Decorated(Interval(-0.0, 2.2), def), RoundUp)) --> decoration(Decorated(Interval(0.0, 3.0), def))
    @fact ceil(Decorated(Interval(-1.5, Inf), trv)) --> Decorated(Interval(-1.0, Inf), trv)
    @fact decoration(ceil(Decorated(Interval(-1.5, Inf), trv))) --> decoration(Decorated(Interval(-1.0, Inf), trv))
    @fact round(Decorated(Interval(-1.5, Inf), trv), RoundUp) --> Decorated(Interval(-1.0, Inf), trv)
    @fact decoration(round(Decorated(Interval(-1.5, Inf), trv), RoundUp)) --> decoration(Decorated(Interval(-1.0, Inf), trv))
    @fact ceil(Decorated(Interval(0x1.fffffffffffffp1023, Inf), dac)) --> Decorated(Interval(0x1.fffffffffffffp1023, Inf), def)
    @fact decoration(ceil(Decorated(Interval(0x1.fffffffffffffp1023, Inf), dac))) --> decoration(Decorated(Interval(0x1.fffffffffffffp1023, Inf), def))
    @fact round(Decorated(Interval(0x1.fffffffffffffp1023, Inf), dac), RoundUp) --> Decorated(Interval(0x1.fffffffffffffp1023, Inf), def)
    @fact decoration(round(Decorated(Interval(0x1.fffffffffffffp1023, Inf), dac), RoundUp)) --> decoration(Decorated(Interval(0x1.fffffffffffffp1023, Inf), def))
    @fact ceil(Decorated(Interval(0x1.fffffffffffffp1023, 0x1.fffffffffffffp1023), com)) --> Decorated(Interval(0x1.fffffffffffffp1023, 0x1.fffffffffffffp1023), dac)
    @fact decoration(ceil(Decorated(Interval(0x1.fffffffffffffp1023, 0x1.fffffffffffffp1023), com))) --> decoration(Decorated(Interval(0x1.fffffffffffffp1023, 0x1.fffffffffffffp1023), dac))
    @fact round(Decorated(Interval(0x1.fffffffffffffp1023, 0x1.fffffffffffffp1023), com), RoundUp) --> Decorated(Interval(0x1.fffffffffffffp1023, 0x1.fffffffffffffp1023), dac)
    @fact decoration(round(Decorated(Interval(0x1.fffffffffffffp1023, 0x1.fffffffffffffp1023), com), RoundUp)) --> decoration(Decorated(Interval(0x1.fffffffffffffp1023, 0x1.fffffffffffffp1023), dac))
    @fact ceil(Decorated(Interval(-Inf, 2.2), trv)) --> Decorated(Interval(-Inf, 3.0), trv)
    @fact decoration(ceil(Decorated(Interval(-Inf, 2.2), trv))) --> decoration(Decorated(Interval(-Inf, 3.0), trv))
    @fact round(Decorated(Interval(-Inf, 2.2), trv), RoundUp) --> Decorated(Interval(-Inf, 3.0), trv)
    @fact decoration(round(Decorated(Interval(-Inf, 2.2), trv), RoundUp)) --> decoration(Decorated(Interval(-Inf, 3.0), trv))
    @fact ceil(Decorated(Interval(-Inf, -0x1.fffffffffffffp1023), dac)) --> Decorated(Interval(-Inf, -0x1.fffffffffffffp1023), def)
    @fact decoration(ceil(Decorated(Interval(-Inf, -0x1.fffffffffffffp1023), dac))) --> decoration(Decorated(Interval(-Inf, -0x1.fffffffffffffp1023), def))
    @fact round(Decorated(Interval(-Inf, -0x1.fffffffffffffp1023), dac), RoundUp) --> Decorated(Interval(-Inf, -0x1.fffffffffffffp1023), def)
    @fact decoration(round(Decorated(Interval(-Inf, -0x1.fffffffffffffp1023), dac), RoundUp)) --> decoration(Decorated(Interval(-Inf, -0x1.fffffffffffffp1023), def))
end
...
facts("minimal_floor_dec_test") do
    @fact floor(Decorated(Interval(1.1, 2.0), com)) --> Decorated(Interval(1.0, 2.0), def)
    @fact decoration(floor(Decorated(Interval(1.1, 2.0), com))) --> decoration(Decorated(Interval(1.0, 2.0), def))
    @fact round(Decorated(Interval(1.1, 2.0), com), RoundDown) --> Decorated(Interval(1.0, 2.0), def)
    @fact decoration(round(Decorated(Interval(1.1, 2.0), com), RoundDown)) --> decoration(Decorated(Interval(1.0, 2.0), def))
    @fact floor(Decorated(Interval(-1.1, 2.0), def)) --> Decorated(Interval(-2.0, 2.0), def)
    @fact decoration(floor(Decorated(Interval(-1.1, 2.0), def))) --> decoration(Decorated(Interval(-2.0, 2.0), def))
    @fact round(Decorated(Interval(-1.1, 2.0), def), RoundDown) --> Decorated(Interval(-2.0, 2.0), def)
    @fact decoration(round(Decorated(Interval(-1.1, 2.0), def), RoundDown)) --> decoration(Decorated(Interval(-2.0, 2.0), def))
    @fact floor(Decorated(Interval(-1.1, 0.0), dac)) --> Decorated(Interval(-2.0, 0.0), def)
    @fact decoration(floor(Decorated(Interval(-1.1, 0.0), dac))) --> decoration(Decorated(Interval(-2.0, 0.0), def))
    @fact round(Decorated(Interval(-1.1, 0.0), dac), RoundDown) --> Decorated(Interval(-2.0, 0.0), def)
    @fact decoration(round(Decorated(Interval(-1.1, 0.0), dac), RoundDown)) --> decoration(Decorated(Interval(-2.0, 0.0), def))
    @fact floor(Decorated(Interval(-1.2, -1.1), com)) --> Decorated(Interval(-2.0, -2.0), com)
    @fact decoration(floor(Decorated(Interval(-1.2, -1.1), com))) --> decoration(Decorated(Interval(-2.0, -2.0), com))
    @fact round(Decorated(Interval(-1.2, -1.1), com), RoundDown) --> Decorated(Interval(-2.0, -2.0), com)
    @fact decoration(round(Decorated(Interval(-1.2, -1.1), com), RoundDown)) --> decoration(Decorated(Interval(-2.0, -2.0), com))
    @fact floor(Decorated(Interval(-1.1, -0.4), def)) --> Decorated(Interval(-2.0, -1.0), def)
    @fact decoration(floor(Decorated(Interval(-1.1, -0.4), def))) --> decoration(Decorated(Interval(-2.0, -1.0), def))
    @fact round(Decorated(Interval(-1.1, -0.4), def), RoundDown) --> Decorated(Interval(-2.0, -1.0), def)
    @fact decoration(round(Decorated(Interval(-1.1, -0.4), def), RoundDown)) --> decoration(Decorated(Interval(-2.0, -1.0), def))
    @fact floor(Decorated(Interval(-1.9, 2.2), com)) --> Decorated(Interval(-2.0, 2.0), def)
    @fact decoration(floor(Decorated(Interval(-1.9, 2.2), com))) --> decoration(Decorated(Interval(-2.0, 2.0), def))
    @fact round(Decorated(Interval(-1.9, 2.2), com), RoundDown) --> Decorated(Interval(-2.0, 2.0), def)
    @fact decoration(round(Decorated(Interval(-1.9, 2.2), com), RoundDown)) --> decoration(Decorated(Interval(-2.0, 2.0), def))
    @fact floor(Decorated(Interval(-1.0, 2.2), trv)) --> Decorated(Interval(-1.0, 2.0), trv)
    @fact decoration(floor(Decorated(Interval(-1.0, 2.2), trv))) --> decoration(Decorated(Interval(-1.0, 2.0), trv))
    @fact round(Decorated(Interval(-1.0, 2.2), trv), RoundDown) --> Decorated(Interval(-1.0, 2.0), trv)
    @fact decoration(round(Decorated(Interval(-1.0, 2.2), trv), RoundDown)) --> decoration(Decorated(Interval(-1.0, 2.0), trv))
    @fact floor(Decorated(Interval(0.0, 2.2), trv)) --> Decorated(Interval(0.0, 2.0), trv)
    @fact decoration(floor(Decorated(Interval(0.0, 2.2), trv))) --> decoration(Decorated(Interval(0.0, 2.0), trv))
    @fact round(Decorated(Interval(0.0, 2.2), trv), RoundDown) --> Decorated(Interval(0.0, 2.0), trv)
    @fact decoration(round(Decorated(Interval(0.0, 2.2), trv), RoundDown)) --> decoration(Decorated(Interval(0.0, 2.0), trv))
    @fact floor(Decorated(Interval(-0.0, 2.2), com)) --> Decorated(Interval(0.0, 2.0), def)
    @fact decoration(floor(Decorated(Interval(-0.0, 2.2), com))) --> decoration(Decorated(Interval(0.0, 2.0), def))
    @fact round(Decorated(Interval(-0.0, 2.2), com), RoundDown) --> Decorated(Interval(0.0, 2.0), def)
    @fact decoration(round(Decorated(Interval(-0.0, 2.2), com), RoundDown)) --> decoration(Decorated(Interval(0.0, 2.0), def))
    @fact floor(Decorated(Interval(-1.5, Inf), dac)) --> Decorated(Interval(-2.0, Inf), def)
    @fact decoration(floor(Decorated(Interval(-1.5, Inf), dac))) --> decoration(Decorated(Interval(-2.0, Inf), def))
    @fact round(Decorated(Interval(-1.5, Inf), dac), RoundDown) --> Decorated(Interval(-2.0, Inf), def)
    @fact decoration(round(Decorated(Interval(-1.5, Inf), dac), RoundDown)) --> decoration(Decorated(Interval(-2.0, Inf), def))
    @fact floor(Decorated(Interval(-Inf, 2.2), trv)) --> Decorated(Interval(-Inf, 2.0), trv)
    @fact decoration(floor(Decorated(Interval(-Inf, 2.2), trv))) --> decoration(Decorated(Interval(-Inf, 2.0), trv))
    @fact round(Decorated(Interval(-Inf, 2.2), trv), RoundDown) --> Decorated(Interval(-Inf, 2.0), trv)
    @fact decoration(round(Decorated(Interval(-Inf, 2.2), trv), RoundDown)) --> decoration(Decorated(Interval(-Inf, 2.0), trv))
end
...
facts("minimal_trunc_dec_test") do
    @fact trunc(Decorated(Interval(1.1, 2.1), com)) --> Decorated(Interval(1.0, 2.0), def)
    @fact decoration(trunc(Decorated(Interval(1.1, 2.1), com))) --> decoration(Decorated(Interval(1.0, 2.0), def))
    @fact round(Decorated(Interval(1.1, 2.1), com), RoundToZero) --> Decorated(Interval(1.0, 2.0), def)
    @fact decoration(round(Decorated(Interval(1.1, 2.1), com), RoundToZero)) --> decoration(Decorated(Interval(1.0, 2.0), def))
    @fact trunc(Decorated(Interval(1.1, 1.9), com)) --> Decorated(Interval(1.0, 1.0), com)
    @fact decoration(trunc(Decorated(Interval(1.1, 1.9), com))) --> decoration(Decorated(Interval(1.0, 1.0), com))
    @fact round(Decorated(Interval(1.1, 1.9), com), RoundToZero) --> Decorated(Interval(1.0, 1.0), com)
    @fact decoration(round(Decorated(Interval(1.1, 1.9), com), RoundToZero)) --> decoration(Decorated(Interval(1.0, 1.0), com))
    @fact trunc(Decorated(Interval(-1.1, 2.0), dac)) --> Decorated(Interval(-1.0, 2.0), def)
    @fact decoration(trunc(Decorated(Interval(-1.1, 2.0), dac))) --> decoration(Decorated(Interval(-1.0, 2.0), def))
    @fact round(Decorated(Interval(-1.1, 2.0), dac), RoundToZero) --> Decorated(Interval(-1.0, 2.0), def)
    @fact decoration(round(Decorated(Interval(-1.1, 2.0), dac), RoundToZero)) --> decoration(Decorated(Interval(-1.0, 2.0), def))
    @fact trunc(Decorated(Interval(-1.1, 0.0), trv)) --> Decorated(Interval(-1.0, 0.0), trv)
    @fact decoration(trunc(Decorated(Interval(-1.1, 0.0), trv))) --> decoration(Decorated(Interval(-1.0, 0.0), trv))
    @fact round(Decorated(Interval(-1.1, 0.0), trv), RoundToZero) --> Decorated(Interval(-1.0, 0.0), trv)
    @fact decoration(round(Decorated(Interval(-1.1, 0.0), trv), RoundToZero)) --> decoration(Decorated(Interval(-1.0, 0.0), trv))
    @fact trunc(Decorated(Interval(-1.1, -0.0), def)) --> Decorated(Interval(-1.0, 0.0), def)
    @fact decoration(trunc(Decorated(Interval(-1.1, -0.0), def))) --> decoration(Decorated(Interval(-1.0, 0.0), def))
    @fact round(Decorated(Interval(-1.1, -0.0), def), RoundToZero) --> Decorated(Interval(-1.0, 0.0), def)
    @fact decoration(round(Decorated(Interval(-1.1, -0.0), def), RoundToZero)) --> decoration(Decorated(Interval(-1.0, 0.0), def))
    @fact trunc(Decorated(Interval(-1.1, -0.4), com)) --> Decorated(Interval(-1.0, 0.0), def)
    @fact decoration(trunc(Decorated(Interval(-1.1, -0.4), com))) --> decoration(Decorated(Interval(-1.0, 0.0), def))
    @fact round(Decorated(Interval(-1.1, -0.4), com), RoundToZero) --> Decorated(Interval(-1.0, 0.0), def)
    @fact decoration(round(Decorated(Interval(-1.1, -0.4), com), RoundToZero)) --> decoration(Decorated(Interval(-1.0, 0.0), def))
    @fact trunc(Decorated(Interval(-1.9, 2.2), def)) --> Decorated(Interval(-1.0, 2.0), def)
    @fact decoration(trunc(Decorated(Interval(-1.9, 2.2), def))) --> decoration(Decorated(Interval(-1.0, 2.0), def))
    @fact round(Decorated(Interval(-1.9, 2.2), def), RoundToZero) --> Decorated(Interval(-1.0, 2.0), def)
    @fact decoration(round(Decorated(Interval(-1.9, 2.2), def), RoundToZero)) --> decoration(Decorated(Interval(-1.0, 2.0), def))
    @fact trunc(Decorated(Interval(-1.0, 2.2), dac)) --> Decorated(Interval(-1.0, 2.0), def)
    @fact decoration(trunc(Decorated(Interval(-1.0, 2.2), dac))) --> decoration(Decorated(Interval(-1.0, 2.0), def))
    @fact round(Decorated(Interval(-1.0, 2.2), dac), RoundToZero) --> Decorated(Interval(-1.0, 2.0), def)
    @fact decoration(round(Decorated(Interval(-1.0, 2.2), dac), RoundToZero)) --> decoration(Decorated(Interval(-1.0, 2.0), def))
    @fact trunc(Decorated(Interval(-1.5, Inf), dac)) --> Decorated(Interval(-1.0, Inf), def)
    @fact decoration(trunc(Decorated(Interval(-1.5, Inf), dac))) --> decoration(Decorated(Interval(-1.0, Inf), def))
    @fact round(Decorated(Interval(-1.5, Inf), dac), RoundToZero) --> Decorated(Interval(-1.0, Inf), def)
    @fact decoration(round(Decorated(Interval(-1.5, Inf), dac), RoundToZero)) --> decoration(Decorated(Interval(-1.0, Inf), def))
    @fact trunc(Decorated(Interval(-Inf, 2.2), trv)) --> Decorated(Interval(-Inf, 2.0), trv)
    @fact decoration(trunc(Decorated(Interval(-Inf, 2.2), trv))) --> decoration(Decorated(Interval(-Inf, 2.0), trv))
    @fact round(Decorated(Interval(-Inf, 2.2), trv), RoundToZero) --> Decorated(Interval(-Inf, 2.0), trv)
    @fact decoration(round(Decorated(Interval(-Inf, 2.2), trv), RoundToZero)) --> decoration(Decorated(Interval(-Inf, 2.0), trv))
end
...
facts("minimal_roundTiesToEven_dec_test") do
    @fact round(Decorated(Interval(1.1, 2.1), com)) --> Decorated(Interval(1.0, 2.0), def)
    @fact decoration(round(Decorated(Interval(1.1, 2.1), com))) --> decoration(Decorated(Interval(1.0, 2.0), def))
    @fact round(Decorated(Interval(1.1, 2.1), com), RoundNearest) --> Decorated(Interval(1.0, 2.0), def)
    @fact decoration(round(Decorated(Interval(1.1, 2.1), com), RoundNearest)) --> decoration(Decorated(Interval(1.0, 2.0), def))
    @fact round(Decorated(Interval(1.1, 2.1), com), RoundTiesToEven) --> Decorated(Interval(1.0, 2.0), def)
    @fact decoration(round(Decorated(Interval(1.1, 2.1), com), RoundTiesToEven)) --> decoration(Decorated(Interval(1.0, 2.0), def))
    @fact round(Decorated(Interval(-1.1, 2.0), trv)) --> Decorated(Interval(-1.0, 2.0), trv)
    @fact decoration(round(Decorated(Interval(-1.1, 2.0), trv))) --> decoration(Decorated(Interval(-1.0, 2.0), trv))
    @fact round(Decorated(Interval(-1.1, 2.0), trv), RoundNearest) --> Decorated(Interval(-1.0, 2.0), trv)
    @fact decoration(round(Decorated(Interval(-1.1, 2.0), trv), RoundNearest)) --> decoration(Decorated(Interval(-1.0, 2.0), trv))
    @fact round(Decorated(Interval(-1.1, 2.0), trv), RoundTiesToEven) --> Decorated(Interval(-1.0, 2.0), trv)
    @fact decoration(round(Decorated(Interval(-1.1, 2.0), trv), RoundTiesToEven)) --> decoration(Decorated(Interval(-1.0, 2.0), trv))
    @fact round(Decorated(Interval(-1.6, -1.5), com)) --> Decorated(Interval(-2.0, -2.0), dac)
    @fact decoration(round(Decorated(Interval(-1.6, -1.5), com))) --> decoration(Decorated(Interval(-2.0, -2.0), dac))
    @fact round(Decorated(Interval(-1.6, -1.5), com), RoundNearest) --> Decorated(Interval(-2.0, -2.0), dac)
    @fact decoration(round(Decorated(Interval(-1.6, -1.5), com), RoundNearest)) --> decoration(Decorated(Interval(-2.0, -2.0), dac))
    @fact round(Decorated(Interval(-1.6, -1.5), com), RoundTiesToEven) --> Decorated(Interval(-2.0, -2.0), dac)
    @fact decoration(round(Decorated(Interval(-1.6, -1.5), com), RoundTiesToEven)) --> decoration(Decorated(Interval(-2.0, -2.0), dac))
    @fact round(Decorated(Interval(-1.6, -1.4), com)) --> Decorated(Interval(-2.0, -1.0), def)
    @fact decoration(round(Decorated(Interval(-1.6, -1.4), com))) --> decoration(Decorated(Interval(-2.0, -1.0), def))
    @fact round(Decorated(Interval(-1.6, -1.4), com), RoundNearest) --> Decorated(Interval(-2.0, -1.0), def)
    @fact decoration(round(Decorated(Interval(-1.6, -1.4), com), RoundNearest)) --> decoration(Decorated(Interval(-2.0, -1.0), def))
    @fact round(Decorated(Interval(-1.6, -1.4), com), RoundTiesToEven) --> Decorated(Interval(-2.0, -1.0), def)
    @fact decoration(round(Decorated(Interval(-1.6, -1.4), com), RoundTiesToEven)) --> decoration(Decorated(Interval(-2.0, -1.0), def))
    @fact round(Decorated(Interval(-1.5, Inf), dac)) --> Decorated(Interval(-2.0, Inf), def)
    @fact decoration(round(Decorated(Interval(-1.5, Inf), dac))) --> decoration(Decorated(Interval(-2.0, Inf), def))
    @fact round(Decorated(Interval(-1.5, Inf), dac), RoundNearest) --> Decorated(Interval(-2.0, Inf), def)
    @fact decoration(round(Decorated(Interval(-1.5, Inf), dac), RoundNearest)) --> decoration(Decorated(Interval(-2.0, Inf), def))
    @fact round(Decorated(Interval(-1.5, Inf), dac), RoundTiesToEven) --> Decorated(Interval(-2.0, Inf), def)
    @fact decoration(round(Decorated(Interval(-1.5, Inf), dac), RoundTiesToEven)) --> decoration(Decorated(Interval(-2.0, Inf), def))
    @fact round(Decorated(Interval(-Inf, 2.2), trv)) --> Decorated(Interval(-Inf, 2.0), trv)
    @fact decoration(round(Decorated(Interval(-Inf, 2.2), trv))) --> decoration(Decorated(Interval(-Inf, 2.0), trv))
    @fact round(Decorated(Interval(-Inf, 2.2), trv), RoundNearest) --> Decorated(Interval(-Inf, 2.0), trv)
    @fact decoration(round(Decorated(Interval(-Inf, 2.2), trv), RoundNearest)) --> decoration(Decorated(Interval(-Inf, 2.0), trv))
    @fact round(Decorated(Interval(-Inf, 2.2), trv), RoundTiesToEven) --> Decorated(Interval(-Inf, 2.0), trv)
    @fact decoration(round(Decorated(Interval(-Inf, 2.2), trv), RoundTiesToEven)) --> decoration(Decorated(Interval(-Inf, 2.0), trv))
end
...
facts("minimal_roundTiesToAway_dec_test") do
    @fact round(Decorated(Interval(1.1, 2.1), com), RoundNearestTiesAway) --> Decorated(Interval(1.0, 2.0), def)
    @fact decoration(round(Decorated(Interval(1.1, 2.1), com), RoundNearestTiesAway)) --> decoration(Decorated(Interval(1.0, 2.0), def))
    @fact round(Decorated(Interval(1.1, 2.1), com), RoundTiesToAway) --> Decorated(Interval(1.0, 2.0), def)
    @fact decoration(round(Decorated(Interval(1.1, 2.1), com), RoundTiesToAway)) --> decoration(Decorated(Interval(1.0, 2.0), def))
    @fact round(Decorated(Interval(-1.9, 2.2), com), RoundNearestTiesAway) --> Decorated(Interval(-2.0, 2.0), def)
    @fact decoration(round(Decorated(Interval(-1.9, 2.2), com), RoundNearestTiesAway)) --> decoration(Decorated(Interval(-2.0, 2.0), def))
    @fact round(Decorated(Interval(-1.9, 2.2), com), RoundTiesToAway) --> Decorated(Interval(-2.0, 2.0), def)
    @fact decoration(round(Decorated(Interval(-1.9, 2.2), com), RoundTiesToAway)) --> decoration(Decorated(Interval(-2.0, 2.0), def))
    @fact round(Decorated(Interval(1.9, 2.2), com), RoundNearestTiesAway) --> Decorated(Interval(2.0, 2.0), com)
    @fact decoration(round(Decorated(Interval(1.9, 2.2), com), RoundNearestTiesAway)) --> decoration(Decorated(Interval(2.0, 2.0), com))
    @fact round(Decorated(Interval(1.9, 2.2), com), RoundTiesToAway) --> Decorated(Interval(2.0, 2.0), com)
    @fact decoration(round(Decorated(Interval(1.9, 2.2), com), RoundTiesToAway)) --> decoration(Decorated(Interval(2.0, 2.0), com))
    @fact round(Decorated(Interval(-1.0, 2.2), trv), RoundNearestTiesAway) --> Decorated(Interval(-1.0, 2.0), trv)
    @fact decoration(round(Decorated(Interval(-1.0, 2.2), trv), RoundNearestTiesAway)) --> decoration(Decorated(Interval(-1.0, 2.0), trv))
    @fact round(Decorated(Interval(-1.0, 2.2), trv), RoundTiesToAway) --> Decorated(Interval(-1.0, 2.0), trv)
    @fact decoration(round(Decorated(Interval(-1.0, 2.2), trv), RoundTiesToAway)) --> decoration(Decorated(Interval(-1.0, 2.0), trv))
    @fact round(Decorated(Interval(2.5, 2.6), com), RoundNearestTiesAway) --> Decorated(Interval(3.0, 3.0), dac)
    @fact decoration(round(Decorated(Interval(2.5, 2.6), com), RoundNearestTiesAway)) --> decoration(Decorated(Interval(3.0, 3.0), dac))
    @fact round(Decorated(Interval(2.5, 2.6), com), RoundTiesToAway) --> Decorated(Interval(3.0, 3.0), dac)
    @fact decoration(round(Decorated(Interval(2.5, 2.6), com), RoundTiesToAway)) --> decoration(Decorated(Interval(3.0, 3.0), dac))
    @fact round(Decorated(Interval(-1.5, Inf), dac), RoundNearestTiesAway) --> Decorated(Interval(-2.0, Inf), def)
    @fact decoration(round(Decorated(Interval(-1.5, Inf), dac), RoundNearestTiesAway)) --> decoration(Decorated(Interval(-2.0, Inf), def))
    @fact round(Decorated(Interval(-1.5, Inf), dac), RoundTiesToAway) --> Decorated(Interval(-2.0, Inf), def)
    @fact decoration(round(Decorated(Interval(-1.5, Inf), dac), RoundTiesToAway)) --> decoration(Decorated(Interval(-2.0, Inf), def))
    @fact round(Decorated(Interval(-Inf, 2.2), def), RoundNearestTiesAway) --> Decorated(Interval(-Inf, 2.0), def)
    @fact decoration(round(Decorated(Interval(-Inf, 2.2), def), RoundNearestTiesAway)) --> decoration(Decorated(Interval(-Inf, 2.0), def))
    @fact round(Decorated(Interval(-Inf, 2.2), def), RoundTiesToAway) --> Decorated(Interval(-Inf, 2.0), def)
    @fact decoration(round(Decorated(Interval(-Inf, 2.2), def), RoundTiesToAway)) --> decoration(Decorated(Interval(-Inf, 2.0), def))
end
...
facts("minimal_abs_dec_test") do
    @fact abs(Decorated(Interval(-1.1, 2.0), com)) --> Decorated(Interval(0.0, 2.0), com)
    @fact decoration(abs(Decorated(Interval(-1.1, 2.0), com))) --> decoration(Decorated(Interval(0.0, 2.0), com))
    @fact abs(Decorated(Interval(-1.1, 0.0), dac)) --> Decorated(Interval(0.0, 1.1), dac)
    @fact decoration(abs(Decorated(Interval(-1.1, 0.0), dac))) --> decoration(Decorated(Interval(0.0, 1.1), dac))
    @fact abs(Decorated(Interval(-1.1, -0.0), def)) --> Decorated(Interval(0.0, 1.1), def)
    @fact decoration(abs(Decorated(Interval(-1.1, -0.0), def))) --> decoration(Decorated(Interval(0.0, 1.1), def))
    @fact abs(Decorated(Interval(-1.1, -0.4), trv)) --> Decorated(Interval(0.4, 1.1), trv)
    @fact decoration(abs(Decorated(Interval(-1.1, -0.4), trv))) --> decoration(Decorated(Interval(0.4, 1.1), trv))
    @fact abs(Decorated(Interval(-1.9, 0.2), dac)) --> Decorated(Interval(0.0, 1.9), dac)
    @fact decoration(abs(Decorated(Interval(-1.9, 0.2), dac))) --> decoration(Decorated(Interval(0.0, 1.9), dac))
    @fact abs(Decorated(Interval(0.0, 0.2), def)) --> Decorated(Interval(0.0, 0.2), def)
    @fact decoration(abs(Decorated(Interval(0.0, 0.2), def))) --> decoration(Decorated(Interval(0.0, 0.2), def))
    @fact abs(Decorated(Interval(-0.0, 0.2), com)) --> Decorated(Interval(0.0, 0.2), com)
    @fact decoration(abs(Decorated(Interval(-0.0, 0.2), com))) --> decoration(Decorated(Interval(0.0, 0.2), com))
    @fact abs(Decorated(Interval(-1.5, Inf), dac)) --> Decorated(Interval(0.0, Inf), dac)
    @fact decoration(abs(Decorated(Interval(-1.5, Inf), dac))) --> decoration(Decorated(Interval(0.0, Inf), dac))
end
...
facts("minimal_min_dec_test") do
    @fact min(Decorated(entireinterval(Float64), def), Decorated(Interval(1.0, 2.0), com)) --> Decorated(Interval(-Inf, 2.0), def)
    @fact decoration(min(Decorated(entireinterval(Float64), def), Decorated(Interval(1.0, 2.0), com))) --> decoration(Decorated(Interval(-Inf, 2.0), def))
    @fact min(Decorated(Interval(-7.0, -5.0), trv), Decorated(Interval(2.0, 4.0), def)) --> Decorated(Interval(-7.0, -5.0), trv)
    @fact decoration(min(Decorated(Interval(-7.0, -5.0), trv), Decorated(Interval(2.0, 4.0), def))) --> decoration(Decorated(Interval(-7.0, -5.0), trv))
    @fact min(Decorated(Interval(-7.0, 0.0), dac), Decorated(Interval(2.0, 4.0), def)) --> Decorated(Interval(-7.0, 0.0), def)
    @fact decoration(min(Decorated(Interval(-7.0, 0.0), dac), Decorated(Interval(2.0, 4.0), def))) --> decoration(Decorated(Interval(-7.0, 0.0), def))
    @fact min(Decorated(Interval(-7.0, -0.0), com), Decorated(Interval(2.0, 4.0), com)) --> Decorated(Interval(-7.0, 0.0), com)
    @fact decoration(min(Decorated(Interval(-7.0, -0.0), com), Decorated(Interval(2.0, 4.0), com))) --> decoration(Decorated(Interval(-7.0, 0.0), com))
end
...
facts("minimal_max_dec_test") do
    @fact max(Decorated(entireinterval(Float64), def), Decorated(Interval(1.0, 2.0), com)) --> Decorated(Interval(1.0, Inf), def)
    @fact decoration(max(Decorated(entireinterval(Float64), def), Decorated(Interval(1.0, 2.0), com))) --> decoration(Decorated(Interval(1.0, Inf), def))
    @fact max(Decorated(Interval(-7.0, -5.0), trv), Decorated(Interval(2.0, 4.0), def)) --> Decorated(Interval(2.0, 4.0), trv)
    @fact decoration(max(Decorated(Interval(-7.0, -5.0), trv), Decorated(Interval(2.0, 4.0), def))) --> decoration(Decorated(Interval(2.0, 4.0), trv))
    @fact max(Decorated(Interval(-7.0, 5.0), dac), Decorated(Interval(2.0, 4.0), def)) --> Decorated(Interval(2.0, 5.0), def)
    @fact decoration(max(Decorated(Interval(-7.0, 5.0), dac), Decorated(Interval(2.0, 4.0), def))) --> decoration(Decorated(Interval(2.0, 5.0), def))
    @fact max(Decorated(Interval(3.0, 3.5), com), Decorated(Interval(2.0, 4.0), com)) --> Decorated(Interval(3.0, 4.0), com)
    @fact decoration(max(Decorated(Interval(3.0, 3.5), com), Decorated(Interval(2.0, 4.0), com))) --> decoration(Decorated(Interval(3.0, 4.0), com))
end
