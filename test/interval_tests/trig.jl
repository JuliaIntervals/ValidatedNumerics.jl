...
facts("Trig tests") do
    @fact sin(@interval(0.5)) --> BareInterval(0.47942553860420295, 0.47942553860420301)
    @fact sin(@interval(0.5, 1.67)) --> BareInterval(4.7942553860420295e-01, 1.0)
    @fact sin(@interval(1.67, 3.2)) --> BareInterval(-5.8374143427580093e-02, 9.9508334981018021e-01)
    @fact sin(@interval(2.1, 5.6)) --> BareInterval(-1.0, 0.863209366648874)
    @fact sin(@interval(0.5, 8.5)) --> BareInterval(-1.0, 1.0)
    @fact sin(@floatinterval(-4.5, 0.1)) --> BareInterval(-1.0, 0.9775301176650971)
    @fact sin(@floatinterval(1.3, 6.3)) --> BareInterval(-1.0, 1.0)
    ...
    @fact cos(@interval(0.5)) --> BareInterval(0.87758256189037265, 0.87758256189037276)
    @fact cos(@interval(0.5, 1.67)) --> BareInterval(-0.09904103659872825, 0.8775825618903728)
    @fact cos(@interval(2.1, 5.6)) --> BareInterval(-1.0, 0.77556587851025016)
    @fact cos(@interval(0.5, 8.5)) --> BareInterval(-1.0, 1.0)
    @fact cos(@interval(1.67, 3.2)) --> BareInterval(-1.0, -0.09904103659872801)
    ...
    @fact tan(@interval(0.5)) --> BareInterval(0.54630248984379048, 0.5463024898437906)
    @fact tan(@interval(0.5, 1.67)) --> entireinterval()
    @fact tan(@interval(1.67, 3.2)) --> BareInterval(-10.047182299210307, 0.05847385445957865)
    ...
    @fact acos(@interval(1)) --> BareInterval(0., 0.)
    ...
    @fact atan(@interval(-1,1)) -->
        BareInterval(-pi_interval(Float64).hi/4, pi_interval(Float64).hi/4)
    @fact atan(@interval(0)) --> BareInterval(0.0, 0.0)
    ...
    @fact atan2(@interval(0.0, 0.1), @interval(0.1, 1.0)) -->
        BareInterval(0.0, 0.7853981633974484)
    ...
    @fact atan2(@interval(-0.1, 0.0), @interval(0.1, 1.0)) -->
        BareInterval(-0.7853981633974484, 0.0)
    ...
    @fact atan2(@interval(0.0, 0.1), @interval(-2.0, -0.1)) -->
        BareInterval(2.356194490192345, 3.1415926535897936)
    ...
    @fact atan2(@interval(-0.0, 0.0), @interval(-2.0, 0.0)) -->
        BareInterval(3.141592653589793, 3.1415926535897936)
    ...
    @fact atan2(@interval(-0.0, 0.1), @interval(-0.1, 0.0)) -->
        BareInterval(1.5707963267948966, 3.1415926535897936)
    ...
    @fact atan2(@interval(-0.1, -0.1), @interval(-0.1, 0.0)) -->
        BareInterval(-2.3561944901923453, -1.5707963267948966)
    ...
    @fact atan2(@biginterval(0.0, 0.1), @biginterval(-2.0, 0.1)) ⊆
        atan2(@interval(0.0, 0.1), @interval(-2.0, 0.1)) --> true
    @fact atan2(@interval(-0.0, 0.1), @interval(-2.0, 0.1)) -->
        BareInterval(0.0, 3.1415926535897936)
    ...
    @fact atan2(@interval(-0.1, -0.1), @interval(-0.1, 0.1)) -->
        BareInterval(-2.3561944901923453, -0.7853981633974482)
